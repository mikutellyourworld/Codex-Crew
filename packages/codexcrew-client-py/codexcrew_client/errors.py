"""Structured error types for codexcrew-client."""
...
class CodexCrewError(Exception):
...
def http_error(status: int, body: Any = None) -> CodexCrewError:
    ...
    return CodexCrewError(code, message, status=status, body=body)
