// Demo CodexCrew App — proves the federated loading pipeline works end-to-end.
// This file is loaded dynamically by AppHost via import('/apps/demo-app/ui/index.mjs').
// It uses the import map to resolve 'react' and '@codexcrew/app-sdk' from the host.

const React = window.__codexcrew_modules.react
const { useAppApi, useAppEvents } = window.__codexcrew_modules['@codexcrew/app-sdk']
const { Sparkles, Bot, Zap, RefreshCw } = window.__codexcrew_modules['lucide-react']
...
function DemoApp() {
  ...
  return h('div', { className: 'px-6 pt-4 pb-8' },
    ...
    h('div', { className: 'mt-6 text-[12px] text-muted/60 text-center' },
      'This app was loaded dynamically from /apps/demo-app/ui/index.mjs via the Codex Crew App Platform.'
    ),
  )
}
