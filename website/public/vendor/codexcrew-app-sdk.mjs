// Vendor stub: re-exports @codexcrew/app-sdk from the host.
const m = window.__codexcrew_modules?.['@codexcrew/app-sdk']
if (!m) throw new Error('[vendor/codexcrew-app-sdk] Host modules not initialized.')
export const {
