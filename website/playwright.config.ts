...
export default defineConfig({
  ...
  use: {
    baseURL: process.env.PLAYWRIGHT_BASE_URL || 'http://localhost:5486',
  ...
  // Note: Make sure codexcrew gateway is running on port 5486 before running tests
  // Run: codexcrew gateway
  webServer: undefined,
})
