 ...
 *     `src/codex_crew/apps/builtins/<name>/app.json`
 *   - "after"  = what the live catalog publishes for the same app
 *     (the public repository catalog/official-registry.json)
 ...
 * CodexCrewApps PR #21 restored the four person-authored built-ins: the org
...
const ROWS: {
  ...
  { name: 'projects', displayName: 'Projects', iconUrl: '/app-assets/projects/icon.svg', localAuthor: 'codexcrew', catalogAuthor: 'Codex Crew' },
