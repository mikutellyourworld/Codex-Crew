...
const REFINED_TITLE = 'Running: sleep 40; ls src/codex_crew | wc -l'
...
const REFINEMENT = {
  ...
  data: {
    ...
    tool: REFINED_TITLE,
    kind: 'execute',
    input_preview: '{"command":"sleep 40; ls src/codex_crew | wc -l"}',
    tool_call_id: 'tc-1',
    is_update: true,
  ...
  return (
    <div className="flex h-screen bg-bg" data-capture-ready={ready ? '' : undefined}>
      <ChatSidebar
        ...
        installedAgents={[{ name: 'codexcrew', description: 'Codex Crew' }]}
      />
    </div>
  )
}
