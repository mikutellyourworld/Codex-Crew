...
const AGENTS = [
  {
    name: 'code-reviewer', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default',
...
const CONTEXTS = [
  {
    ...
    context_summary:
      'Reviewing PR #123 (fix: dedupe check-runs) in worktree codexcrew-wt-check-dedupe. '
