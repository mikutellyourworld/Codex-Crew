...
const JOBS = [
  {
    ...
    schedule: 'every 15m', agent: 'codexcrew-autofix',
    ...
    <QueryClientProvider client={qc}>
      <MemoryRouter>
        <div className="flex flex-col items-start gap-5 bg-bg p-6 text-text">
          <Frame label="codexcrew-autofix — two clock triggers" crew="codexcrew-autofix" isDefaultCrew={false} />
          ...
          <Frame label="codexcrew-lite — nothing wakes it" crew="codexcrew-lite" isDefaultCrew={false} />
        </div>
      </MemoryRouter>
    </QueryClientProvider>
  )
