...
const META: Record<string, { title: string; icon: string; icon_dark: string }> = {
  'https://github.com/mikutellyourworld/Codex-Crew/pull/843': {
...
const CHIPS = [
  'Opened [feat(agents): add Agent Template creation](https://github.com/mikutellyourworld/Codex-Crew/pull/843) is the one from the report.',
  '',
...
const CARD = 'https://github.com/mikutellyourworld/Codex-Crew/pull/843'
