...
store.dispatch(sseSubagentSpawn({ slot: SLOT, id: 'sa-1', task: 'Audit the settings pages for hand-written error surfaces', agent: 'codexcrew-lite' }))
store.dispatch(sseSubagentSpawn({ slot: SLOT, id: 'sa-2', task: 'Summarize the CI log for run 8704', agent: 'codexcrew-lite' }))
