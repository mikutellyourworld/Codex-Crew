...
const SPEC_DIR = '/proj/CodexCrew/.kiro/specs/' + NAME

const REQUIREMENTS = `# Requirements — pluggable ACP backend

## Glossary

- **ACP**: Agent Client Protocol — the JSON-RPC 2.0 over stdio protocol Codex Crew
  speaks to an agent subprocess.
- **Gateway**: the long-running Codex Crew process that owns sessions, config,
