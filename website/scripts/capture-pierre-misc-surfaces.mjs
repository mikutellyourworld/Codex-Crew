...
const USER_LINKS = [
  ...
  '',
  '- [PR #843 — Replace Monaco with Pierre](https://github.com/mikutellyourworld/Codex-Crew/pull/843)',
  '- [MR !12 — Pierre worker pool sizing](https://gitlab.com/kiro/dashboard/-/merge_requests/12)',
  '- [Issue #2418 — Monaco worker 404s on file open](https://github.com/mikutellyourworld/Codex-Crew/issues/2418)',
...
const AGENT_LINKS = [
  ...
  '- [Architecture overview](https://github.com/mikutellyourworld/Codex-Crew/blob/main/docs/architecture/overview.md)',
  '- [dashboard-iframe-hosts.md](https://github.com/mikutellyourworld/Codex-Crew/blob/main/docs/architecture/dashboard-iframe-hosts.md)',
].join('\n')
...
const PR_URL = 'https://github.com/mikutellyourworld/Codex-Crew/pull/861'
