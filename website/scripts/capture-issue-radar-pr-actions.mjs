...
const REPO = { owner: 'kirodotdev', repo: 'CodexCrew' }
...
const PULLS = [
  {
    ...
    url: 'https://github.com/mikutellyourworld/Codex-Crew/pull/1111', state: 'open', draft: false,
  ...
  },
  {
    ...
    url: 'https://github.com/mikutellyourworld/Codex-Crew/pull/1102', state: 'open', draft: false,
    ...
    if (path === `${IR}/repos`) {
      return json(route, {
        repos: [{
          ...
          slug: 'mikutellyourworld/Codex-Crew',
  ...
  async function load(theme) {
    ...
    await page.addInitScript((t) => {
      ...
      localStorage.setItem('kc:issue-radar:active-repo', JSON.stringify({
        owner: 'kirodotdev', repo: 'CodexCrew', provider: 'github', host: 'github.com',
      }))
