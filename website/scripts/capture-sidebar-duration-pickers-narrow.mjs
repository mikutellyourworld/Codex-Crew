...
const slots = [
  {
    ...
    agent: 'codexcrew', modified: now, last_ts: new Date().toISOString(), folder_id: '',
    last_message: 'Grouped the entries by area.',
  },
  {
    key: 'chat-b', title: 'Sweep the option pickers', running: false, messages: 6,
    agent: 'codexcrew', modified: now - 900, last_ts: new Date(Date.now() - 9e5).toISOString(), folder_id: '',
