...
const PROJECT = '/home/user/workspace/CodexCrew'
...
const PREFILL_SPACED =
  'https://github.com/mikutellyourworld/Codex-Crew/issues/new?title=Bug: dashboard chat fails&labels=bug, area: dashboard&assignees=someone'
const LONG_ENCODED =
  'https://github.com/mikutellyourworld/Codex-Crew/issues/new?title=Bug%3A+dashboard+chat+fails&body=%23%23+What%0A%0AURLs+are+not+clickable%0A%0A%23%23+Why%0A%0AThe+agent+generated+a+link&labels=bug%2Carea%3A+dashboard&assignees=someone&template=bug_report.md&milestone=v2.0'
...
const CONTENT = [
  ...
  '',
  'The renderer lives at /home/user/workspace/CodexCrew/website/src/components/MarkdownRenderer.tsx — a path, not a link.',
].join('\n')
