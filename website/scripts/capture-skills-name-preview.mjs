 ...
 * `vite` harness proxies /api to whatever CODEXCREW_PORT names.
 *
...
const SKILLS = [
  {
    ...
    source: 'codexcrew', loaded_by_agents: [], always: false,
  },
  {
...
const SKILL_TREE = {
  name: 'release-notes', root: '~/.codex-crew/skills/release-notes', entries: [],
}
