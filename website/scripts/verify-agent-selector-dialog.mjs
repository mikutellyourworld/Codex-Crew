...
const AGENTS = [
  { name: 'codexcrew', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default', description: 'Default crew', source: 'builtin' },
  { name: 'oncall', kiro_agent: 'oncall-agent', workspace: 'oncall', memory_store: 'oncall-kb', description: 'Oncall crew', source: 'codexcrew' },
  { name: 'research', kiro_agent: 'codexcrew', workspace: 'research', memory_store: 'research-mem', description: 'Research crew', source: 'codexcrew' },
...
try {
  ...
  await stubDashboardApi(page, {
    extra: async (path, route) => {
      if (path === '/api/agents') {
        await json(route, { agents: AGENTS, default_agent: 'codexcrew' })
        return true
      }
      return false
    },
