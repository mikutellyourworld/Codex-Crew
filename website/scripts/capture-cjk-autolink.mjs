...
const CONTENT = [
  '**#2137 — review-ready**（https://github.com/mikutellyourworld/Codex-Crew/pull/2137，`96ed647b`）：`readiness: passed`',
  '',
  '（详见 https://github.com/mikutellyourworld/Codex-Crew/pull/2137）后面还有正文。',
  '',
