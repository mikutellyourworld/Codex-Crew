...
const SKILLS = [
  { key: 'babysit', name: 'babysit', description: 'Same-session monitoring loop for PRs and CI runs', path: '/home/user/.codex-crew/skills/babysit/SKILL.md', source: 'codexcrew' },
  { key: 'prepare-pr', name: 'prepare-pr', description: 'Drive working-tree changes to a review-ready pull request', path: '/home/user/.codex-crew/skills/prepare-pr/SKILL.md', source: 'codexcrew' },
  { key: 'rubber-duck', name: 'rubber-duck', description: 'Adversarial review that turns explaining out loud into a hallucination check', path: '/home/user/.codex-crew/skills/rubber-duck/SKILL.md', source: 'codexcrew' },
  { key: 'widgets', name: 'widgets', description: 'Render rich HTML inline via mcwidget tags', path: '/home/user/.codex-crew/skills/widgets/SKILL.md', source: 'codexcrew' },
...
const AGENTS = [
  { name: 'codexcrew', description: 'Autonomous personal AI agent', source: 'codexcrew', model: 'claude-opus-4.8', mcp_servers: ['codexcrew-core', 'codexcrew-cron'], filename: 'codexcrew.json' },
...
const DETAIL = {
  codexcrew: {
    ...
    mcpServers: { 'codexcrew-core': {}, 'codexcrew-cron': {} },
  },
  'code-reviewer': {
    name: 'code-reviewer',
...
const extra = async (path, route) => {
  ...
  if (path === '/api/config/default-agent') { await json(route, { default_agent: 'codexcrew' }); return true }
