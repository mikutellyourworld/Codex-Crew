...
const CREWS = [
  ...
  { name: 'devops', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default', session_color: '#6366f1' },
  { name: 'makerworks', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default', session_color: '#0a7d55' },
]
...
const fixtures = crewsApi({ crews: CREWS, defaultAgent: 'codexcrew' })
