...
const CREWS = [
  { name: 'codexcrew', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default' },
  { name: 'oncall', kiro_agent: 'oncall', workspace: 'oncall', memory_store: 'default' },
  { name: 'research', kiro_agent: 'codexcrew', workspace: 'research', memory_store: 'research' },
]
...
async function main() {
  ...
  await stubDashboardApi(page, { extra: crewsApi({ crews: CREWS, defaultAgent: 'codexcrew' }) })
  ...
  await stubDashboardApi(stock, {
    extra: crewsApi({
      crews: [{ name: 'codexcrew', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default' }],
