 ...
 *
 *   stock    CODEXCREW_EDITION_DIR unset  -> `virtual:codexcrew-edition` is inert
 *   edition  CODEXCREW_EDITION_DIR=<tmp>  -> a throwaway composition root whose
...
build('stock', stockDist, { CODEXCREW_EDITION_DIR: '', CODEXCREW_ALLOW_EDITION: '' })
build('edition', editionDist, {
  CODEXCREW_EDITION_DIR: editionDir,
  CODEXCREW_ALLOW_EDITION: '1',
})
...
const tailnetPinned = {
  ...
  qr_ttl_secs: 3600, serve_port: 443, dashboard_port: 5486,
}
