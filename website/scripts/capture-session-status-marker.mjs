...
const slots = [
  ...
  },
  {
    ...
    messages: 7, agent: 'codexcrew', modified: now - 18 * 60, last_ts: ago(18), last_turn_ts: ago(18),
  ...
  },
  {
    ...
    agent: 'codexcrew', modified: now - 26 * 60, last_ts: ago(26), last_turn_ts: ago(26),
...
async function main() {
  ...
  async function load(theme) {
    ...
    await stubDashboardApi(page, {
      ...
      // through the shared codexcrewConfig query — so it has to be answered here
