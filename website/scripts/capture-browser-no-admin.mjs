...
let install = {
  ...
  standalone_install:
    '_pwcli_dir=$(mktemp -d) && curl -fsSL https://raw.githubusercontent.com/mikutellyourworld/Codex-Crew/main/playwright-cli.sh -o "$_pwcli_dir/playwright-cli.sh" && sh "$_pwcli_dir/playwright-cli.sh"',
}
