...
const ANSWER = [
  ...
  '- #4881 opened [PR #7202](https://github.com/mikutellyourworld/Codex-Crew/pull/7202) — CI all green, awaiting review',
  ...
  const extra = async (path, route) => {
    ...
    if (path === '/logo.png') {
      await route.fulfill({
        ...
        body: readFileSync(new URL('../../src/codex_crew/static/codexcrew-logo.png', import.meta.url)),
      })
      return true
    }
    return false
