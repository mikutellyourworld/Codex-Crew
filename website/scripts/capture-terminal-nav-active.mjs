...
const slots = [
  { key: 's1', title: 'Docked panel rail state', messages: 4, running: false, agent: 'codexcrew', mode: '', created: '2026-08-05T01:00:00Z', last_ts: '2026-08-05T04:00:00Z', folder_id: '' },
]
