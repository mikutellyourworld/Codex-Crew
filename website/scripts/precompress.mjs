 ...
 * Codex Crew's own SSH-tunnel code documents as the reason `ssh -C` exists
 * (`src/codex_crew/instances/constants.py`, `ssh_tunnel_manager.py`). A cold
