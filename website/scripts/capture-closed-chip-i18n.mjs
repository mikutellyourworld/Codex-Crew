...
const ACTIVE = 'chat-a'
const pr = n => `https://github.com/mikutellyourworld/Codex-Crew/pull/${n}`
...
const SLOTS = [
  {
    ...
    agent: 'codexcrew', modified: now, last_ts: '2026-09-04T00:10:00Z', folder_id: '',
  ...
  },
  {
    ...
    agent: 'codexcrew', modified: now - 600, last_ts: '2026-09-04T00:00:00Z', folder_id: '',
  ...
  },
  {
    ...
    agent: 'codexcrew', modified: now - 1800, last_ts: '2026-09-03T23:30:00Z', folder_id: '',
