...
const SKILLS = [
  { key: 'codexcrew/oncall-handover', name: 'oncall-handover', description: 'Handover report', source: 'codexcrew' },
  { key: 'codexcrew/ticket-pull', name: 'ticket-pull', description: 'Pull tickets', source: 'codexcrew' },
]
