...
const PR_URL = 'https://github.com/mikutellyourworld/Codex-Crew/pull/5127'
const OTHER_URL = 'https://github.com/mikutellyourworld/Codex-Crew/pull/5126'
...
const source = partialSections => ({
  ...
  commits: [{
    ...
    author: 'codexcrew', committedAt: new Date().toISOString(), url: PR_URL,
  }],
