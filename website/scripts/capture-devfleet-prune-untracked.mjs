 ...
 *   node scripts/capture-devfleet-prune-untracked.mjs http://127.0.0.1:6813 "$CODEXCREW_SCRATCH/shots"
 */
import { chromium } from 'playwright'
import { mkdirSync } from 'node:fs'

const BASE = process.argv[2] || 'http://127.0.0.1:6813'
const OUT = process.argv[3] || `${process.env.CODEXCREW_SCRATCH || '/tmp'}/shots`
