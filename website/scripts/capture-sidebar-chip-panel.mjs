...
const OTHER = 'chat-b'
const BUSY = 'chat-c'
const REPO = 'https://github.com/mikutellyourworld/Codex-Crew'
const PR_URL = 'https://github.com/mikutellyourworld/Codex-Crew/pull/634'
const ISSUE_URL = 'https://github.com/mikutellyourworld/Codex-Crew/issues/701'
...
const slots = [
  {
    ...
    agent: 'codexcrew', modified: now, last_ts: '2026-08-07T00:10:00Z', folder_id: '',
  ...
  },
  {
    ...
    agent: 'codexcrew', modified: now - 900, last_ts: '2026-08-07T00:00:00Z', folder_id: '',
  ...
  },
  {
    ...
    agent: 'codexcrew', modified: now - 1800, last_ts: '2026-08-06T23:30:00Z', folder_id: '',
