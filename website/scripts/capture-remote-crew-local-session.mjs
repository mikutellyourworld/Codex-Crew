...
const slot = (key, title, extra = {}) => ({
  key, title, messages: 8, running: false, agent: 'codexcrew', mode: '',
...
const capabilities = (id) => ({
  ...
  version_match: true,
  agents: [
    { name: 'codexcrew', description: "The crew's default agent", scope: 'global', model: 'auto' },
  ...
  workspaces: [{ name: 'codexcrew', path: '/home/crew/codexcrew' }],
  default_workspace: '/home/crew/codexcrew',
  unavailable: {},
})
