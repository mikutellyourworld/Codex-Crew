...
await shoot('setup', 'dark', ['No Codex Crew checkout found', 'CODEXCREW_DEVFLEET_REPO='],
  '01-needs-setup-dark.png')
await shoot('setup', 'light', ['No Codex Crew checkout found'], '02-needs-setup-light.png')
...
await shoot('error', 'dark', ['Discovery Error', 'checkouts/codexcrew'],
