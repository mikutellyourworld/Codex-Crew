 ...
 * at run time) and one pinned to `codexcrew`, which happens to BE the current
...
const PAIR_HISTORY = [
  ...
  { key: 'dashboard_chat-old-pinned', title: 'Archived, pinned to codexcrew', messages: 31, agent: DEFAULT_AGENT, modified: NOW_EPOCH, created: NOW_ISO },
]
