...
const failed = [
  '[Subagent completion event]',
  'Agent `7654e2b3` (codexcrew) failed ❌',
...
const chunk = [
  ...
  '  → /home/user/.codex-crew/subagents/53e3e5eb/result.txt',
  '— `b8185d65` ✅ Add TWO short UI labels to the SPANISH (es) catalog',
  '  → /home/user/.codex-crew/subagents/b8185d65/result.txt',
].join('\n')
...
const wave = [
  ...
  '  → /home/user/.codex-crew/subagents/a0417f21/result.txt',
  '— `d5c3b210` ✅ Add TWO short UI labels to the PORTUGUESE (pt) catalog',
  '  → /home/user/.codex-crew/subagents/d5c3b210/result.txt',
].join('\n')
