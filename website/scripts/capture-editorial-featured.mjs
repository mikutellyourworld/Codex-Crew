 ...
 */
const CATALOG = 'https://raw.githubusercontent.com/mikutellyourworld/Codex-Crew/main/catalog'
...
const A = (name, displayName, description, tags, extra = {}) => ({
  ...
  author: 'Codex Crew', version: '1.0.0', installed: false, updateAvailable: false,
