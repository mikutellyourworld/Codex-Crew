...
const slots = [
  { key: 's1', title: 'Rail footer divider', messages: 4, running: false, agent: 'codexcrew', mode: '', created: '2026-08-11T01:00:00Z', last_ts: '2026-08-11T04:00:00Z', folder_id: '' },
]
...
async function main() {
  ...
  try {
    for (const s of SCENES) {
      ...
      const row = page.locator('a[href="https://github.com/mikutellyourworld/Codex-Crew"]')
