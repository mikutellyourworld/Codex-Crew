...
const STATUS = {
  ...
  update_check_status: 'succeeded', update_command: 'codexcrew update',
  update_latest_version: VERSION, update_channel: 'stable',
  update_managed_by: 'codexcrew', update_commits_ahead: 0,
...
const UPDATE_CHECK_NONE = {
  ...
  latest_version: VERSION, channel: 'stable', managed_by: 'codexcrew',
  can_apply: false, update_command: 'codexcrew update', current_version: VERSION,
...
await scene('A2', async () => {
  const INST = {
    ...
    local_port: 0, ttl: '2h', remote_bin: 'codexcrew', connection_method: 'ssh', ssm_target: '',
