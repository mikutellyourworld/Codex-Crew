...
const JOBS = [
  {
    ...
    enabled: true, folder_id: 'fld-prod', agent: 'codexcrew', model: 'claude-opus-5',
  ...
  },
  {
    ...
    script: '~/.codex-crew/crons/feed.py:check', message: '',
...
async function main() {
  ...
  await stubDashboardApi(page, {
    ...
    extra: async (path, route) => {
      ...
      if (path === '/api/agents') { await json(route, { agents: [{ name: 'codexcrew' }], default_agent: 'codexcrew' }); return true }
