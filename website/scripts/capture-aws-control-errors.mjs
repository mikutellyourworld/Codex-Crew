...
const GiB = 1024 ** 3
const DRIVE = {
  exists: true, bucket: `codexcrew-drive-${ACC}-usw2`, region: 'us-west-2',
  usage: {
...
const DENIED = { error: 'AccessDenied: User is not authorized to perform s3:ListBucket on codexcrew-drive-111122223333-usw2', code: 'aws_call_failed' }
