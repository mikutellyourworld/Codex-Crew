...
const SLOTS = [
  {
    ...
    last_message: 'Judging the tab restyle.', messages: 2, agent: 'codexcrew',
  ...
  },
  {
    ...
    last_message: 'Running the Playwright repro…', messages: 14, agent: 'codexcrew',
  ...
  },
  {
    ...
    last_message: 'Display panel mockups saved.', messages: 31, agent: 'codexcrew',
  ...
  },
  {
    ...
    last_message: 'Draft ready for review.', messages: 6, agent: 'codexcrew',
