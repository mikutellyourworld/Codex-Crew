...
const FLEET_MAIN_LIVE = {
  ...
  staged_target: '/w/codexcrew-wt-widgets',
  ...
  worktrees: [
    ...
    { name: 'codexcrew-wt-widgets', is_main: false, running: false, has_dist: true, behind: 2, branch: 'feat/widgets', is_live: false, is_staged: true, path: '/w/codexcrew-wt-widgets', last_updated_at: now - 3600 },
  ],
}
...
const FLEET_FEATURE_LIVE = {
  ...
  worktrees: [
    ...
    { name: 'codexcrew-wt-widgets', is_main: false, running: false, has_dist: true, behind: 2, branch: 'feat/widgets', is_live: true, is_staged: false, path: '/w/codexcrew-wt-widgets', last_updated_at: now - 3600 },
  ],
}
...
async function main() {
  ...
  await page.goto(base + '/dev-fleet', { waitUntil: 'domcontentloaded' })
  await page.getByText('codexcrew-wt-widgets').first().waitFor({ state: 'visible', timeout: 15000 })
