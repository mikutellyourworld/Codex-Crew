...
const PATH_APP = {
  ...
  manifest: {
    ...
    description: "Toggle Codex Crew's orchestrator between the Claude Code companion and stock kiro-cli, restart the gateway to apply the flip, and see what is actually configured vs live.",
    author: 'codexcrew-claude-companion', tags: ['developer-tools'],
