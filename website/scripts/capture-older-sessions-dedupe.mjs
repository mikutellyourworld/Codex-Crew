...
const slots = [
  {
    ...
    agent: 'codexcrew', modified: now, last_ts: '2026-08-17T22:05:00Z', folder_id: '',
  ...
  },
  {
    ...
    messages: 61, agent: 'codexcrew', modified: now - 3600, last_ts: '2026-08-17T21:05:00Z',
    folder_id: '', last_message: 'PR #4200 is review-ready.',
  },
  {
    key: 'chat-5-1755200000', title: 'Advisory review lanes need teeth', running: false,
    messages: 18, agent: 'codexcrew', modified: now - 7200, last_ts: '2026-08-17T20:05:00Z',
...
const closedSessions = [
  { key: 'dashboard_chat-4-1755100000', title: 'Credit pill error state', agent: 'codexcrew', modified: now - 86400 },
  { key: 'dashboard_chat-3-1755000000', title: 'Thinking bursts per segment', agent: 'codexcrew', modified: now - 172800 },
  { key: 'slack_1712793600.123456', title: 'Slack thread — release 0.1.4', agent: 'codexcrew', modified: now - 259200 },
]
