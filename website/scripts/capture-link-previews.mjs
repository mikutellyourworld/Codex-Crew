...
const PROJECT = '/Users/diwm/workspace/CodexCrew'
...
const META = {
  ...
  'https://github.com/mikutellyourworld/Codex-Crew': {
    url: 'https://github.com/mikutellyourworld/Codex-Crew',
    title: 'mikutellyourworld/Codex-Crew: an autonomous agent management layer',
...
async function main() {
  ...
  const wantUrls = ['https://www.amazon.com', 'https://www.google.com', 'https://github.com/mikutellyourworld/Codex-Crew']
