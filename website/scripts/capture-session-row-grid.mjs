...
const slots = [
  {
    ...
    agent: 'default', project_dir: '/home/z/CodexCrew-clone',
    modified: now, last_ts: '2026-08-17T00:10:00Z', folder_id: '',
    last_message: 'Reading the row anatomy.',
  },
  {
    key: 'chat-long', running: false, messages: 12, agent: 'codexcrew',
  ...
  },
  {
    ...
    key: 'chat-mode', running: false, messages: 5, agent: 'codexcrew', mode: 'orchestrator',
