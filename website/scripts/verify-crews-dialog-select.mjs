...
const CREWS = [
  { name: 'codexcrew', kiro_agent: 'codexcrew', workspace: 'core-ws', memory_store: 'core-mem' },
  { name: 'oncall', kiro_agent: 'codexcrew', workspace: 'oncall', memory_store: 'oncall-mem' },
]
...
async function main() {
  ...
  // Picking the store codexcrew already uses must surface the warning, by name.
  await dialog.getByText(/Also used by codexcrew/).waitFor({ timeout: 10000 })
