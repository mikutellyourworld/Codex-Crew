...
const PEER_TOO_OLD = {
  error: 'instance is running an older Codex Crew that cannot receive sessions — update it, then reconnect',
...
if (!reason.includes('older Codex Crew')) errors.push(`ASSERT: reason does not name the cause: ${reason}`)
