...
const WEBHOOKS_VIEW = {
  ...
  tokens: [
    { id: 'tok-a', label: 'ci-pipeline', agent: 'codexcrew', created: 1756600000, last_used: 1756680000 },
    { id: 'tok-b', label: 'release-bot', agent: 'codexcrew-autofix', created: 1756500000, last_used: null },
  ],
  contexts: [],
  runs: [
  ...
  sessions: [
    {
      ...
      untitled: false, agent: 'codexcrew', pid: 4001, owns_runtime: true, prompts: 12,
    ...
    },
    {
      ...
      untitled: false, agent: 'codexcrew-autofix', pid: 4002, owns_runtime: false, prompts: 3,
