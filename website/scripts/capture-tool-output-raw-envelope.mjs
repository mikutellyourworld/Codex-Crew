 ...
 *
 * From website/:
 *   CODEXCREW_PORT=1 npx vite --host 127.0.0.1 --port 6831 --strictPort &
 *   node scripts/capture-tool-output-raw-envelope.mjs http://127.0.0.1:6831 \
 *     ../temp-screenshots/tool-output-raw-envelope
 *
 * (CODEXCREW_PORT is pinned to an unused port on purpose: vite.config.ts proxies
 * /api to localhost:${CODEXCREW_PORT||5486}, and 5486 is a real gateway. This
