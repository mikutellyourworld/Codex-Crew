...
const JOBS = [
  ...
  },
  {
    ...
    message: 'Poll the release feed and flag regressions.', agent: 'codexcrew',
    session_key: null,
  ...
  },
  {
    ...
    message: 'Compile the weekly compliance digest.', agent: 'codexcrew', enabled: true,
...
async function main() {
  ...
  const ROUTES = new Map([
    ...
    ['/api/agents', { agents: [{ name: 'codexcrew' }], default_agent: 'codexcrew' }],
    ['/api/models', []],
  ])
