...
const SLOTS = [
  { key: 'crew-demo', title: 'Multi-topic afternoon', agent: 'codexcrew', mode: 'crew', surface: 'crew', running: false, unread: 0, pinned: false, memory_mode: 'persistent', messages: 15, last_ts: new Date().toISOString(), created: new Date(Date.now() - 3600e3).toISOString() },
  { key: 'plain-1', title: 'Fix stable feed', agent: 'codexcrew', mode: '', surface: '', running: false, unread: 0, pinned: false, memory_mode: 'persistent', messages: 0, last_ts: new Date(Date.now() - 600e3).toISOString(), created: new Date(Date.now() - 7200e3).toISOString() },
]
