  ...
  messages: [
    {
      role: 'user',
      ts: now() - 900,
      content: 'Can you look at https://github.com/mikutellyourworld/Codex-Crew/issues/2579 and the related '
        + 'https://gitlab.com/acme/widgets/-/issues/9 report?',
    },
    {
      role: 'assistant',
      ts: now() - 60,
      content: 'Opened https://github.com/mikutellyourworld/Codex-Crew/pull/2600 for it, mirroring the approach from '
        + 'https://gitlab.com/acme/widgets/-/merge_requests/7. Note that '
        + 'https://evil-github.com.attacker.test/mikutellyourworld/Codex-Crew/pull/1 stays a plain link — lookalike hosts never chip.',
    },
  ],
}
...
async function capture(browser, base, theme, name) {
  ...
  for (const label of ['mikutellyourworld/Codex-Crew#2579', 'acme/widgets#9', 'mikutellyourworld/Codex-Crew#2600', 'acme/widgets!7']) {
