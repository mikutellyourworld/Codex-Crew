...
const PR_URL = 'https://github.com/mikutellyourworld/Codex-Crew/pull/6420'
...
const source = {
  ...
  commits: [{
    ...
    author: 'codexcrew', committedAt: '2025-06-15T15:06:40.000Z', url: PR_URL,
  }],
  checks: [{ name: 'ci', bucket: 'success', status: 'completed', conclusion: 'success', url: '' }],
  comments: [],
  files: [
    { path: 'src/codex_crew/dashboard/handlers/source_providers.py', status: 'modified', additions: 20, deletions: 2, patch: '' },
  ],
  partialSections: [],
}
...
async function main() {
  ...
  await page.route('**/api/**', async route => {
    ...
    if (path === '/api/source/pull-request/auto-merge') {
      ...
      return json(route, {
        error: 'this action needs a configured owner, which Codex Crew identifies by Slack member ID',
