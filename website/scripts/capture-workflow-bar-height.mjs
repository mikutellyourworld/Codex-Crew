...
const slots = [{
  key: SLOT,
  title: 'Codex Crew performance investigation',
  running: true,
  last_message: 'Started workflow run wf_000025…',
  messages: 2,
  agent: 'codexcrew',
  memory_mode: 'persistent',
  project: '/home/user/workspace/CodexCrew',
  folder_id: '',
...
function buildEvents() {
  ...
  push('run_started', { name: 'codexcrew-perf-investigation' })
  ...
  for (const line of [
    ...
    'Script validated: codexcrew-perf-investigation',
    'Workflow authored — starting execution.',
    'Starting Codex Crew performance investigation',
...
const snapshot = {
  run_id: RUN_ID,
  name: 'codexcrew-perf-investigation',
  status: 'running',
  events: buildEvents(),
  source: SOURCE,
  error: null,
