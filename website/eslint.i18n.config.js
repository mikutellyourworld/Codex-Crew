...
export default [
        ...
        'warn',
        {
          ...
          words: {
            exclude: [
              ...
              // src/codex_crew/dashboard/state.py and the matched prefix is then
              ...
              // `src/codex_crew/dashboard/state.py`; the matched prefix is then SLICED
              ...
              '^[^A-Za-z]*$',
              // The product brand. The display name is `Codex Crew`; the unspaced
              // `CodexCrew` is the same name (and the glossary term that still guards the
          ...
          callees: {
            exclude: [
              ...
              // CodexCrew's own telemetry shim (`src/rum.ts`). Its first argument is
  ...
  // (category=CodexCrew, name=SessionFeedback, version=1.0.1) — ingestion  // brand-ok: registered category id
