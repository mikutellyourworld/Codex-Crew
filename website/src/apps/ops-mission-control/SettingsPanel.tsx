 ...
 *
 * Deliberately has NO token field. Codex Crew already holds a Slack bot token for
 ...
 * rather than a hidden one: when Codex Crew's Slack is not connected, this card says
 ...
 *
 * Deliberately has NO per-channel mute control. Codex Crew renders that centrally at
    ...
    <Card>
      ...
      <div className="flex items-center gap-2 text-[13px]">
        ...
        {/* Three states, not two, and `bus_available` is what separates the middle one.
            ...
            where the not-ready half genuinely IS the operator's (connect Codex Crew's Slack),
      ...
      {/* Mute lives centrally. Say where, rather than adding a control that would fight
          the one Codex Crew already stores. */}
      {enabled ? (
