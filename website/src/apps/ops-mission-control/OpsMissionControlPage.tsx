 ...
 *
 * Backend contract: codex_crew/apps/builtins/ops_mission_control/backend/routes.py
 ...
 * that it goes to somebody who does not run Codex Crew — a ticket, a review, a colleague — so
 ...
 * this app's only output for someone who does not run Codex Crew, and until now nothing in
