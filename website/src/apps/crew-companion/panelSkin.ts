/**
 * Panel palette — derived from the Codex Crew theme the user actually picked.
 *
 ...
 * variable names onto Codex Crew's — so every other window follows all ~36 themes,
...
/**
 * The live skin. Codex Crew's variable names first, this app's older aliases second,
