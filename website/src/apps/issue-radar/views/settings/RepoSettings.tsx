  ...
  return (
    <div className="w-full max-w-6xl px-4 py-8 md:px-8">
      ...
      >
        ...
        <StatLine>
          {i18nT('apps.issueRadar.views.settings.repoSettings.checks_about_once_a_minute_inside_codexcrew_no_cr')} <code>{terms.cli}</code> {i18nT('apps.issueRadar.views.settings.repoSettings.sign_in_no_extra_credentials_no_webhook', { provider: terms.providerName })}
        </StatLine>
      </Card>
