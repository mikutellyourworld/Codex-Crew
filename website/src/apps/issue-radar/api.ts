...
export interface RepoSettings {
  ...
  /** Watch this repo in the background and push a CodexCrew notification when a
...
// `src/codex_crew/apps/builtins/issue_radar/backend/crew_store.py` — that module is
