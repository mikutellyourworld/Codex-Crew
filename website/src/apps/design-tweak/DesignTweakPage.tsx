...
// Ported from the federated-ESM app (window.__codexcrew_modules) to a compiled
...
// Two-panel layout inside Codex Crew's content area: resizable left rail + preview.
        ...
        <div className="flex items-center gap-3 px-5 py-2">
          ...
          <div className="flex-1 min-w-0" style={{ position: 'relative' }}>
            ...
            {/* dropdown panel — drops DOWNWARD from the trigger's bottom edge.
                ...
                step and borrows the host's compiled Tailwind, so any class Codex Crew
