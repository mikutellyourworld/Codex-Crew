 ...
 * Mochi follows the CodexCrew theme instead. This module keeps the original's
...
export const BUBBLE_COLORS: Record<ThemeId, { bg: string; text: string; shadow: string }> = {
  codexcrew: { bg: 'rgba(33,29,37,0.95)', text: '#f2f1f4', shadow: 'rgba(0,0,0,0.45)' },
}
