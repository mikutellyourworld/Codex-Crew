...
CodexCrew builtin. This file is the map: where everything lives, why the layout
...
| `src/codex_crew/apps/builtins/mochi/` | Python backend: runtime (`hooks.py`), services, MCP server, routes, agents/skills |
...
## Backend shape (`src/codex_crew/apps/builtins/mochi/`)
...
`CODEXCREW_HOME` isolation that keeps tests from writing to the real data
