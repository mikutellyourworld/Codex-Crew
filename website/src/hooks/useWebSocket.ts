...
function invalidateRefreshQueries(qc: QueryClient): void {
  ...
  qc.invalidateQueries({ queryKey: ['codexcrew-agents'] })
        ...
        switch (type) {
          ...
          case 'artifact_update': {
            ...
            if (slug) {
              if ((data as { deleted?: boolean }).deleted) {
                ...
                // gone server-side.
                window.dispatchEvent(new CustomEvent('codexcrew:artifact-deleted', { detail: { slug } }))
          ...
          case 'approval': {
            ...
            if (typeof Notification !== 'undefined' && document.hidden && Notification.permission === 'granted') {
              ...
              try {
                new Notification(i18nT('hooks.useWebSocket.approval_required'), { body: data.tool || i18nT('hooks.useWebSocket.a_task_needs_your_decision'), tag: 'codexcrew-approval' })
              } catch {
          ...
          case 'tool_call':
            ...
            window.dispatchEvent(new CustomEvent('codexcrew-tool-call', { detail: data }))
          ...
          case 'channel_agent_left':
            window.dispatchEvent(new CustomEvent('codexcrew-channel', { detail: { type, data } }))
            break
          case 'cron_history':
          ...
          case 'computer_use_frame':
            ...
            window.dispatchEvent(
              new CustomEvent('codexcrew-computer-use-frame', { detail: data }),
            )
            break
        }
