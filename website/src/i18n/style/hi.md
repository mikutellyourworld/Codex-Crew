...
Write: `Codex Crewसे कनेक्ट करें` or `Codex Crew से कनेक्ट करें` — a single space after the
...
`CodexCrew` / `Codex Crew`, `MCP`, `Slack`, `GitHub` etc. must appear verbatim — do not transliterate
