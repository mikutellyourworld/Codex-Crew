/**
 * @codexcrew/app-sdk — lightweight SDK for CodexCrew apps.
 *
 * Provides React hooks backed by a context that AppHost sets up.
 * Apps import these hooks to access the CodexCrew API, real-time events,
 * theme, and navigation — all permission-scoped.
 *
 * This module lives inside the CodexCrew frontend for now. When we publish
 * it as a standalone package, apps will `import { useAppApi } from '@codexcrew/app-sdk'`
...
// ---------------------------------------------------------------------------
// WebSocket event scope map — MIRRORS codex_crew/dashboard/ws_event_scope.py.
...
/** Navigate to a CodexCrew route (host-controlled). */
