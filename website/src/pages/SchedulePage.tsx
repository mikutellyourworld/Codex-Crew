...
const RENDER_TZ_STORAGE_KEY = 'codexcrew.schedule.renderTz'
 ...
 * (`CodexCrewAgentsPage`): one modal surface, focus trap, Escape-to-dismiss and
...
function JobDetailDialog({ job, prefill, prefillWrites, agents, defaultAgent, rosterFailure, onClose, onSaved }: {
  job?: CronJob; prefill?: CronPrefill; prefillWrites?: boolean; agents: CodexCrewAgent[]; defaultAgent: string; rosterFailure?: { reloading: boolean; onReload: () => void }; onClose: () => void; onSaved: () => void
}) {
