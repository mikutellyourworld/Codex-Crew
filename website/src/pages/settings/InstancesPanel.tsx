/**
 * InstancesPanel — legacy control plane for remote Codex Crew instances
      ...
      <Card>
        ...
        {restartPending && (
          <div role="status" className="flex items-start gap-2 px-3 py-2 mb-3 text-[13px] rounded-md bg-warn/10 text-warn border border-warn/30">
            ...
            <span>
              {i18nT('pages.settings.instancesPanel.disabled_in_config_restart_the_gateway')}<code className="text-text">{i18nT('pages.settings.instancesPanel.codexcrew_restart')}</code>){' '}
        ...
        <p className="mt-2 text-[12px] text-muted">
          <Trans
            ...
            components={{
              ...
              restartCmd: <code className="text-text">codexcrew restart</code>,
            }}
          />
        </p>
      </Card>
    ...
    <div className="space-y-4">
      ...
      {!active && (
        <div role="status" className="flex items-start gap-2 px-3 py-2 text-[13px] rounded-md bg-warn/10 text-warn border border-warn/30">
          <AlertTriangle size={14} className="lucide-inline mt-0.5 shrink-0" />
          <span>
            {i18nT('pages.settings.instancesPanel.enabled_but_not_active_yet_restart_the_gateway')}<code className="text-text">{i18nT('pages.settings.instancesPanel.codexcrew_restart')}</code>){' '}
