...
/** Shape of the codexcrewConfig query payload this panel reads and patches. */
...
export function ChatPanel() {
  ...
  // (or `codexcrew config set`) changed after we cached it.
  //
          ...
          <SettingsSelect
            ...
            onChange={v =>
              api.patchConfig('session.autocompact_pct', Number(v))
                .then(() => qc.invalidateQueries({ queryKey: ['codexcrewConfig'] }))
