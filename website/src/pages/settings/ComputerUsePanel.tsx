...
export function ComputerUsePanel() {
  ...
  const cfgQ = useQuery<ComputerUseConfigData>({
    ...
    // elapses. Each tick spawns a `codexcrew computer doctor --json` child, so an
