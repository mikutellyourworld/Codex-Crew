...
const SETUP_GUIDE = 'https://github.com/mikutellyourworld/Codex-Crew/blob/main/src/codex_crew/docs/slack-integration.md'
      ...
      <SettingsSection title={i18nT('pages.settings.slackPanel.behavior')}>
        <SettingsCard index={3}>
          <SettingsInput
            ...
            placeholder={i18nT('pages.settings.slackPanel.codexcrew')}
            disabled={ro}
          />
          <SettingsToggle
