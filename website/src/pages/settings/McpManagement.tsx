 ...
 *
 * Per server (the table): interpose Codex Crew's stub. That alone is what lets the
...
const DOCS_URL =
  'https://github.com/mikutellyourworld/Codex-Crew/blob/main/docs/architecture/design-notes/mcp-stub-decoupling.md'
