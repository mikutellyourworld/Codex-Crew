 ...
 *
 * Rows come from {@link https://github.com/mikutellyourworld/Codex-Crew | CHANGELOG.md}'s
 ...
 * page is opened to answer. `codex_crew/changelog.py` owns that rule.
 *
...
/** Mirrors `codex_crew.changelog.Release`. */
interface Release {
  version: string
  date: string
  body: string
