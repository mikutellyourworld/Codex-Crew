 ...
 */
const REPORT_ISSUE_URL = 'https://github.com/mikutellyourworld/Codex-Crew/issues/new'
...
export function AboutPanel() {
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-col gap-0.5 min-w-0">
          <span className="text-[13px] font-medium text-text flex items-center gap-1.5">
            ...
            {botName || 'Codex Crew'} {updateState?.version || i18nT('pages.settings.aboutPanel.update_noun')}
          </span>
  ...
  const { data: mcCfg, isError: mcCfgError } = useQuery({ queryKey: ['mc-config-autoupdate'], queryFn: () => api.codexcrewConfig() })
  useEffect(() => {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2.5 flex-wrap">
              <span className="text-[19px] font-extrabold tracking-tight text-text-strong">{botName || 'Codex Crew'}</span>
        ...
        {isDesktop ? (
          isExternallyManaged ? (
            ...
            <div className="flex flex-col gap-2.5">
              <p className="text-sm text-muted">
                {botName || 'Codex Crew'} {i18nT('pages.settings.aboutPanel.checks_for_updates_automatically_you_can_also_ch')}
              </p>
              <div>
