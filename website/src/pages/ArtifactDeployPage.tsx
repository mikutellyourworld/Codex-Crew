      ...
      <Card>
        ...
        {showGuide && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, fontSize: 13 }}>
            <div>
              <b>{i18nT('pages.artifactDeployPage.1_authenticate_to_aws')}</b> {i18nT('pages.artifactDeployPage.in_your_terminal_codexcrew_never_sees_your_keys_p')}
            ...
            <div>
              <b>{i18nT('pages.artifactDeployPage.3_apply_the_iam_policy')}</b> {i18nT('pages.artifactDeployPage.click')} <b>{i18nT('pages.artifactDeployPage.get_iam_policy')}</b>{i18nT('pages.artifactDeployPage.then_apply_it_yourself_to_a_dedicated_role_ident')} <code>{i18nT('pages.artifactDeployPage.aws_iam')}</code> {i18nT('pages.artifactDeployPage.command_codexcrew_never_edits_your_iam_the_first')}
            </div>
      ...
      <Card>
        ...
        {showSecurity && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, fontSize: 12.5, lineHeight: 1.55 }}>
            <div>
              <b>{i18nT('pages.artifactDeployPage.your_credentials_never_touch_codexcrew')}</b> {i18nT('pages.artifactDeployPage.only_the')} <b>{i18nT('pages.artifactDeployPage.profile_name')}</b> {i18nT('pages.artifactDeployPage.is_stored_every_aws_call_runs_through_the')} <code>{i18nT('pages.artifactDeployPage.aws')}</code> {i18nT('pages.artifactDeployPage.cli_with')} <code>{i18nT('pages.artifactDeployPage.profile')}</code> {i18nT('pages.artifactDeployPage.never_boto3_so_credential_resolution_stays_in_yo')}
            </div>
            <div>
        ...
        {policy && (
          <div style={{ marginTop: 10 }}>
            <div style={{ fontSize: 11, color: 'var(--muted)', marginBottom: 4 }}>
              {i18nT('pages.artifactDeployPage.apply_this_policy_yourself_codexcrew_never_edits')}
