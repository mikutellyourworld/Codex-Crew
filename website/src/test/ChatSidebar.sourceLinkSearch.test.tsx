...
const CR_SLOT = {
  ...
  source_links: [{
    ...
    url: `https://github.com/mikutellyourworld/Codex-Crew/pull/${CR_NUMBER}`, kind: 'change',
  }],
...
const DECOY_SLOT = {
  ...
  source_links: [{
    ...
    url: 'https://github.com/mikutellyourworld/Codex-Crew/pull/55', kind: 'change',
  }],
  source_links_total: 1,
} as ChatSlot
...
const BARE_SLOT = {
  ...
  source_links: [{
    ...
    url: `https://github.com/mikutellyourworld/Codex-Crew/pull/${BARE_NUMBER}`, kind: 'change',
  }],
  source_links_total: 1,
} as ChatSlot
...
describe('ChatSidebar – session search matches source-link badge ids', () => {
  ...
  it.each(['pull', 'merge', 'github', 'browse', 'codexcrew', 'example-svc'])('does NOT retain badged rows for URL boilerplate %s', async (q) => {
