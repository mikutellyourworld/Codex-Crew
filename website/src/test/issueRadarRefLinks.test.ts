...
describe('parseRepoRef', () => {
  ...
  it('matches owner/repo case-insensitively', () => {
    expect(parseRepoRef('https://github.com/KiroDotDev/codexcrew/issues/7', gh(OWNER, REPO)))
...
describe('linkifyIssueRefs', () => {
  ...
  it('does not touch an HTML entity or a cross-repo shorthand', () => {
    ...
    expect(linkifyIssueRefs('CodexCrew#5 elsewhere', gh(O, R))).toBe('CodexCrew#5 elsewhere')
  })
