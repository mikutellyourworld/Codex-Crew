...
vi.mock('../hooks/useAgents', () => ({ useAgents: () => ({ agents: [{ name: 'codexcrew' }], defaultAgent: 'codexcrew' }) }))
...
function makeStore(model?: string) {
  return configureStore({
    ...
    preloadedState: {
      dashboard: {
        status: null,
        slots: [{ key: 'slot-a', messages: 0, running: false, mode: '', agent: 'codexcrew', model, pending_approval: false, waiting_for_input: false, last_activity_ts: undefined }],
