...
const SETUP_GUIDE =
  'https://github.com/mikutellyourworld/Codex-Crew/blob/main/src/codex_crew/docs/webex-integration.md'
...
describe('WebexPanel read-only session', () => {
  it('drops every writer and shows the stored preview only', async () => {
    ...
    expect(
      screen.getByText(
        'Webex settings are managed on the machine running Codex Crew and are read-only from remote sessions.',
      ),
    ).toBeInTheDocument()
