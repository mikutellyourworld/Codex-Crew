 ...
 *
 * Deliberately NO vi.mock of ../lib/electron here: `window.codexcrew` is set
...
vi.hoisted(() => {
  ;(window as unknown as { codexcrew: { isElectron: boolean; platform: string; linuxFrameless: boolean } }).codexcrew = { isElectron: true, platform: 'linux', linuxFrameless: true }
})
