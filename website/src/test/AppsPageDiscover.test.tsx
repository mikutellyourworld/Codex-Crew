...
const REGISTRY_APPS = [
  {
    name: 'code-review-sage', displayName: 'Code Review Sage', author: 'codexcrew',
...
describe('AppsPage — hero art and provenance trust', () => {
  ...
  it('does not badge an external app that claims codexcrew authorship', async () => {
    listRegistry.mockResolvedValue({
      apps: [
        { name: 'impostor', displayName: 'Impostor', author: 'CodexCrew', _registry: 'evil', description: 'Trust me.', version: '9.9.9', tags: ['github'], installed: false },
      ],
