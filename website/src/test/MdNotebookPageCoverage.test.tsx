...
describe('MdNotebookPage — settings, guarded mutations and editor keys', () => {
  ...
  it('records a vault dropping out of the Codex Crew knowledge library', async () => {
    api.listVaults.mockResolvedValue({
    ...
    await userEvent.click(screen.getByRole('switch', { name: 'Sync to Codex Crew knowledge' }))
