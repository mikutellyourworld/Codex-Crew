...
describe('the protocol surface apps import', () => {
  ...
  it('is exported by the vendor stub apps actually resolve', () => {
    // `@codexcrew/app-sdk` resolves to a stub that re-exports the host module by NAME. A name the
    ...
    const stub = read(resolve(SRC, '..', 'public', 'vendor', 'codexcrew-app-sdk.mjs'))
