...
// Verbatim prefixes from src/codex_crew/dashboard/state.py. The separator is an
...
/** Verbatim from SUBAGENT_SYNTHESIS_PREFIX in src/codex_crew/dashboard/state.py. */
