...
const SLOTS = [
  { key: 's1', session_id: 'sid1', title: 'One', mode: 'default', agent: 'codexcrew', last_message_at: new Date().toISOString() },
  { key: 's2', session_id: 'sid2', title: 'Two', mode: 'default', agent: 'codexcrew', last_message_at: new Date().toISOString() },
] as never[]
