...
describe('McpAppFrame', () => {
  ...
  it('answers ui/initialize with a JSON-RPC result carrying host context', () => {
    ...
    expect(reply.result.hostInfo).toEqual({ name: 'codexcrew', version: '0.1' })
  ...
  it('retires the bridge on a navigation-start signal (pre-load window)', async () => {
    ...
    // {__codexcrew_nav__:1} on the original document's pagehide/beforeunload
    ...
    try {
      ...
      dispatchFromApp({ __codexcrew_nav__: 1 }, win)
