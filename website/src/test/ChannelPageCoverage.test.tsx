...
// the `codexcrew-channel` window-event handler that stands in for the WebSocket.
//
...
function mockApi(channels: Raw[], presets?: Raw[]) {
  ...
  vi.mocked(api).codexcrewAgents = vi.fn().mockResolvedValue({ agents: [], default_agent: 'legacy-default' })
}
...
/** Fire one `codexcrew-channel` window event, the page's stand-in for the socket. */
