...
vi.mock('../api/client', () => ({
  api: {
    codexcrewAgents: vi.fn().mockResolvedValue({
      agents: [{ name: 'oncall', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default' }],
      default_agent: 'codexcrew',
    }),
    agentsInstalled: vi.fn().mockResolvedValue([{ name: 'codexcrew' }]),
