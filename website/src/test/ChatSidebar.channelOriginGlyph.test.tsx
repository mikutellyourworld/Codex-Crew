...
const slots = [
  { key: 'discord_codexcrew_direct_U1', title: 'From Discord', messages: 1, running: false, mode: '', created: '', last_ts: '2026-01-01T00:00:00Z' },
  { key: 'slack_1785370133.085469', title: 'From Slack', messages: 1, running: false, mode: '', created: '', last_ts: '2026-01-01T00:00:00Z' },
  { key: 'unified_codexcrew', title: 'From a DM', messages: 1, running: false, mode: '', created: '', last_ts: '2026-01-01T00:00:00Z' },
...
function renderSidebar() {
  const store = createTestStore({
    ...
    chat: {
      activeSlot: 'discord_codexcrew_direct_U1',
    ...
    <QueryClientProvider client={qc}>
      <Provider store={store}>
        <ThemeProvider>
          <MemoryRouter>
            <ChatSidebar
              slots={slots} activeSlot={'discord_codexcrew_direct_U1'} unreadSlots={[]}
