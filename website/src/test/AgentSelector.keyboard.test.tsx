...
const agents: CodexCrewAgent[] = [
  { name: 'coding', kiro_agent: 'codexcrew', workspace: 'default', memory_store: 'default', description: 'Coding agent', source: 'codexcrew' },
  { name: 'oncall', kiro_agent: 'oncall-agent', workspace: 'oncall', memory_store: 'oncall-kb', description: 'Oncall agent', source: 'codexcrew' },
  { name: 'research', kiro_agent: 'codexcrew', workspace: 'research', memory_store: 'research-mem', description: 'Research agent', source: 'codexcrew' },
]
