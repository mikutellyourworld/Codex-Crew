 ...
 *
 * Codex Crew convention: this suite mirrors `ArtifactDetailPage.test.tsx` —
...
vi.mock('../pages/ChatPage', () => ({
  ...
  PREFILL_STORAGE_KEY: 'codexcrew_prefill',
}))
...
describe('ArtifactDetailPage — mutation paths', () => {
  ...
  it('the sidebar ask-agent action stages the address prompt on a new session', async () => {
    ...
    await waitFor(() =>
      expect(sessionStorage.getItem('codexcrew_prefill')).toMatch(/open comment/),
    )
  })
