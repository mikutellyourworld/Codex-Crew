...
const SKILLS = [
  ...
  { key: 'ticket-pull', name: 'ticket-pull', description: 'Pull tickets', source: 'codexcrew' },
  { key: 'grill', name: 'grill', description: 'Structured questioning', source: 'codexcrew' },
]
...
describe('SkillPickerMenu', () => {
  ...
  it('shows a source badge for non-codexcrew skills', async () => {
  ...
  it('dedupes skills that share a leaf name', async () => {
    mockApi.skills.mockResolvedValue([
      { key: 'codexcrew/grill', name: 'grill', description: 'local grill', source: 'codexcrew' },
