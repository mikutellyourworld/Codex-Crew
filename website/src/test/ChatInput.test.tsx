...
describe('ChatInput', () => {
  ...
  describe('Project chip', () => {
    ...
    it('renders the project basename as label when project is set', () => {
      renderWithProviders(
        <ChatInput {...defaultProps} onProjectClick={vi.fn()} project="/home/u/workplace/CodexCrew" />
      )
      const btn = screen.getByLabelText('Project: /home/u/workplace/CodexCrew')
      expect(btn).toBeInTheDocument()
      expect(btn.getAttribute('title')).toBe('Project: /home/u/workplace/CodexCrew')
      expect(btn.textContent).toContain('CodexCrew')
