...
describe('prepareSendPayload', () => {
  ...
  // (`C:\Users\me\.codex-crew\uploads\x.png`). In a markdown destination
  ...
  describe('windows image paths (issue #3497)', () => {
    it('emits a drive path in forward-slash form in both txt and displayTxt', () => {
      ...
      expect(result.txt).toContain('![image](C:/Users/me/.codex-crew/uploads/shot.png)')
      expect(result.displayTxt).toContain('![image](C:/Users/me/.codex-crew/uploads/shot.png)')
    ...
    it('normalizes a UNC share path to forward slashes (roaming profiles)', () => {
      ...
      expect(result.displayTxt).toBe('![image](//fileserver/home/me/.codex-crew/uploads/shot.png)')
    })
