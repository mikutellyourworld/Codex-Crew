/**
 * @codexcrew/ui — shared component library for CodexCrew apps.
 *
 ...
 * standalone package, the import map resolves `@codexcrew/ui` to the
 * host's vendored copy — ensuring a single set of components and styles.
 *
 * Usage in apps:
 *   import { Card, Btn, Badge, PageHeader } from '@codexcrew/ui'
 */
