...
// asked for, via `?profile=commits` in the URL or a `codexcrew.profileCommits`
...
const STORAGE_KEY = 'codexcrew.profileCommits'
...
export function installCommitProfilerConsoleApi(): void {
  ...
  ;(window as unknown as Record<string, unknown>).codexcrewCommits = api
  // eslint-disable-next-line no-console
  console.info(
    'Commit profiling armed. Call codexcrewCommits.summary() for a table.\n' +
