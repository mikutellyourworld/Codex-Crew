...
// Codex Crew is self-hosted, open-source software — every install runs on its
...
// Codex Crew backend's own same-origin routes instead
// (src/codex_crew/dashboard/handlers/feedback.py), which forward to Aperture
...
const COOLDOWN_KEY = 'codexcrew_survey_last_shown'
                ...
                {expanded && (
                  ...
                  >
                    <div className="px-4 pb-4">
                       ...
                       * their rating + feedback leave for the Codex Crew team
