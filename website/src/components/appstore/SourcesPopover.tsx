    ...
    <Popover open={open} onOpenChange={onOpenChange}>
      ...
      <PopoverContent align="end" className="w-[480px] max-w-[92vw] max-h-[70vh] overflow-y-auto">
        ...
        <div className="border-t border-border mt-4 pt-4">
          ...
          <p className="text-[12px] text-muted mb-2.5">{i18nT('components.appstore.sourcesPopover.developer_install_of_a_local_app_directory_equiv')} <code className="bg-bg-elevated px-1 py-0.5 rounded">{i18nT('components.appstore.sourcesPopover.codexcrew_app_install_path')}</code>).</p>
