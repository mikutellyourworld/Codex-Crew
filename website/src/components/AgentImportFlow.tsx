  ...
  const stageHeader = (() => {
    ...
    const headings: Record<Stage, { title: string; description: string }> = {
      1: {
        ...
        description: i18nT('components.agentImportFlow.codex_crew_found_agent_setup_on_this_gateway_host'),
      },
      2: {
      ...
      3: {
        ...
        description: i18nT('components.agentImportFlow.review_the_merge_before_codex_crew_changes_local'),
      },
      4: {
        title: i18nT('components.agentImportFlow.import_complete'),
        description: i18nT('components.agentImportFlow.your_selected_setup_is_ready_in_codex_crew'),
      },
    }
    ...
    if (sources.length === 0 && unreadableSources.length > 0) {
      ...
      return (
        <div className="flex min-h-[360px] flex-col items-center justify-center text-center">
          <AlertTriangle className="lucide-inline text-danger" />
          <h1 ref={headingRef} tabIndex={-1} className="mt-4 text-2xl font-semibold text-text-strong outline-none">
            {i18nT('components.agentImportFlow.found_setup_codexcrew_could_not_read')}
          </h1>
      ...
      return (
        <div className="flex min-h-[360px] flex-col items-center justify-center text-center">
          ...
          <p className="mt-2 max-w-lg text-sm leading-relaxed text-muted">
            {i18nT('components.agentImportFlow.codexcrew_did_not_find_supported_setup_to_import')}
          </p>
          <SendBtn
            type="button"
            className="mt-5"
      ...
      return (
        <>
          ...
          <p className="mt-5 text-center text-[13px] text-muted">
            {i18nT('components.agentImportFlow.your_existing_codexcrew_setup_will_not_be_affecte')}
          </p>
        </>
      )
    }
        ...
        <>
          ...
          <section className="rounded-lg border border-ok/30 bg-ok-subtle p-4">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted">
              {i18nT('components.agentImportFlow.existing_codexcrew_setup_is_never_overwritten_mat')}
            </p>
          </section>
