...
[
  ...
  },
  {
    ...
    "labelSuffix": "Slack",
    "description": "The one member who can always interact with the bot (CODEXCREW_OWNER_ID). Starts with U or W.",
    "tab": "channels",
    "type": "input",
    "occurrence": 1,
    "params": {
  ...
  },
  {
    ...
    "description": "Start a gateway on this machine. Turn it off to use Codex Crew as a client only, connecting to the gateway you have configured instead of running one here. Takes effect next time you open the app.",
    "tab": "developer",
    "type": "toggle",
    "occurrence": 1
  },
  ...
  },
  {
    ...
    "description": "Highlight the N most-recently-active sessions with a graded accent stripe (0 = off). Saved to your Codex Crew config.",
    "tab": "display",
    "type": "stepper",
    "occurrence": 1
  },
