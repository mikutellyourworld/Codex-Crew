...
const PREVIEW_URL_EVENT = 'codexcrew-web-preview-url'
...
const PREVIEW_PENDING_EVENT = 'codexcrew-web-preview-pending'
/**
 ...
 */
export const PREVIEW_EXPAND_EVENT = 'codexcrew-preview-expand'
/**
 ...
 */
export const PREVIEW_SNIP_EVENT = 'codexcrew-web-preview-snip'
 ...
 *  the `*.localhost` reserved TLD (e.g. `codexcrew.localhost`, which the desktop
 *  app and tunnels use). */
 ...
 *    `codexcrew.localhost`) would send the dashboard's host-scoped auth cookie to
 ...
 * ChatPage auto-detecting a dev-server URL (or the agent's `codexcrew:preview`
...
/**
 * Feed a PENDING preview URL for a session — the agent's `codexcrew:preview`
