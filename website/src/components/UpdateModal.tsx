    ...
    >
      ...
      >
        ...
        <div className="px-4 py-3 text-sm text-text">
          <p>{i18nT('components.updateModal.codexcrew')} {version && <span className="font-semibold">{version}</span>} {i18nT('components.updateModal.is_downloaded_and_ready_to_install')}</p>
          {notes && (
