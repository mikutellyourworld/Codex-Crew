...
function FloatingGhost({
  ...
  return (
    ...
    >
      <TerminalMascot size={160} className="h-full w-full" />
    </motion.div>
  )
}
    ...
    <aside className="relative flex min-h-[248px] w-full shrink-0 overflow-hidden bg-accent text-accent-fg sm:min-h-0 sm:w-[36%]">
      ...
      <div className="relative z-10 flex w-full flex-col p-7 sm:p-10">
        <div className="flex items-center gap-3">
          <TerminalMascot size={28} className="h-8 w-7" />
          <span className="text-[15px] font-semibold tracking-wide">{i18nT('components.onboardingChapterShell.codex_crew')}</span>
        </div>
