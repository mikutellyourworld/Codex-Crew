 ...
 *     a dev server: `<!-- codexcrew:preview url="http://127.0.0.1:8080" -->`.
...
// `<!-- codexcrew:preview url="..." -->` — tolerant of surrounding whitespace.
const MARKER_RE = /<!--\s*codexcrew:preview\s+url="([^"]+)"\s*-->/gi
