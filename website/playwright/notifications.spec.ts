...
test.describe('Notifications Page', () => {
  ...
  // test/test_playwright_e2e.py sets CODEXCREW_E2E_EPHEMERAL for the throwaway
  ...
  test('POST /api/notifications/clear round-trips correctly on empty state', async ({ request }) => {
    test.skip(
      !HARNESS_GATEWAY,
      'destructive notification wipe requires the ephemeral harness gateway (CODEXCREW_E2E_EPHEMERAL)',
    )
