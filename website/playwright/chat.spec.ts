...
// src/codex_crew/testing/fake_acp_backend.py.
const SLOW = '[[SLOW]]'
 ...
 * Soft-stop E2E tests.
 *
 * Driven by the stub ACP backend (src/codex_crew/testing/fake_acp_backend.py), so
 ...
 * (src/codex_crew/tests_fixtures/minimal/config.json), comfortably inside the
