...
// CODEXCREW_E2E_EPHEMERAL for the throwaway tmp-home gateway it spawns. Token
...
test.describe('E2E: sidebar tag columns', () => {
  test.beforeEach(async ({ page }) => {
    test.skip(
      !HARNESS_GATEWAY,
      'destructive tag-column wipes require the ephemeral harness gateway (CODEXCREW_E2E_EPHEMERAL)',
    )
