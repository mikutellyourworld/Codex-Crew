...
describe('SkillsTab Integration Tests', () => {
  ...
  it('shows Edit and Delete buttons in the detail header for codexcrew skills', async () => {
    renderWithProviders(<SkillsTab />)
  ...
  it('shows AIM packages section header', async () => {
    server.use(
      http.get('/api/skills', () => {
        return HttpResponse.json([
          { name: 'amazon-writing', key: 'amazon-writing', description: 'Amazon writing guidelines', always: true, source: 'codexcrew', dir: '/path' },
          { name: 'code-search', key: 'code-search', description: 'Search code', always: false, source: 'codexcrew', dir: '/path' },
