...
const slots = [{
  key: SLOT_KEY, title: TITLE, running: false, agent: 'codexcrew',
  created: '2026-04-08T01:00:00Z', last_ts: '2026-04-08T02:00:00Z', folder_id: '', tags: [],
}]
const props = {
  slots, activeSlot: SLOT_KEY, unreadSlots: [] as string[],
  history: [], historyHasMore: false, defaultAgent: 'codexcrew',
  installedAgents: [{ name: 'codexcrew', source: 'builtin' }],
}
