...
const baseSlots = [
  { key: 'slot-1', title: 'Pipeline debug', running: false, agent: 'codexcrew', created: '2026-04-08T01:00:00Z', last_ts: '2026-04-08T02:00:00Z', folder_id: '' },
  { key: 'slot-2', title: 'Code review', running: true, agent: 'codexcrew', created: '2026-04-08T00:00:00Z', last_ts: '2026-04-08T01:30:00Z', folder_id: '' },
...
const defaultProps = {
  ...
  defaultAgent: 'codexcrew',
  installedAgents: [{ name: 'codexcrew', source: 'builtin' }, { name: 'oncall', source: 'aim' }],
}
    ...
    const slotsWithSources = [
      {
        ...baseSlots[0],
        source_links: [
          { provider: 'github' as const, number: 113, label: '#113', url: 'https://github.com/mikutellyourworld/Codex-Crew/pull/113', state: 'merged' as const },
    ...
    const slotsWithSources = [
      {
        ...baseSlots[0],
        source_links: [
          { provider: 'github' as const, number: 284, label: '#284', url: 'https://github.com/mikutellyourworld/Codex-Crew/pull/284', state: 'merged' as const, ci: 'passed' as const },
          { provider: 'github' as const, number: 285, label: '#285', url: 'https://github.com/mikutellyourworld/Codex-Crew/pull/285', state: 'open' as const, ci: 'passed' as const },
        ],
      },
    ]
    renderWithProviders(<ChatSidebar {...defaultProps} slots={slotsWithSources} />)
