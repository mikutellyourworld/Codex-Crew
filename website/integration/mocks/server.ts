...
export const mockMemoryGraph = {
  nodes: [
    ...
    { id: 'pr1', label: 'CodexCrew', group: 'project', title: 'CodexCrew' },
    { id: 'pr2', label: 'CodexCrew: AI-powered assistant', group: 'project', title: 'AI-powered development assistant' },
