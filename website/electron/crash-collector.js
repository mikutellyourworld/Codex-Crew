 ...
 * `C:\...\CodexCrew.exe` string and never match the app name.
 */
 ...
 *
 * - the DISPLAY name, `app.getName()` — `Codex Crew`, or `Codex Crew Nightly`;
 ...
 *   `executableName: "codexcrew-desktop"` for Linux and Windows, and
 *   `packaging/build-desktop.sh` overrides the nightly channel to
 *   `codexcrew-desktop-nightly`.
 *
 * So a rule anchored on the display name alone reads `codexcrew-desktop` as a
 ...
 * work either — `codexcrew-desktop-nightly` is not a prefix-extension of
 * `codexcrewnightly` in any direction.
 */
 ...
 * release channel (`CodexCrew Nightly`), or an unrelated vendor's `CodexCrewX`.
 ...
 * `CodexCrew Nightly-2026-09-03-101530.ips` read as a stable-channel crash,
 * because "codexcrew" is a prefix of "codexcrewnightly-2026-...".
 *
