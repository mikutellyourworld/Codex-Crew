...
;
; The Codex Crew data home (~/.codex-crew) is deliberately NOT touched: it holds
...
; already a Codex Crew install, which is exactly the case the executable check
...
; PHYSICAL EVIDENCE OF BIFURCATION -- a sibling Codex Crew install root in one
...
!macro customInit
  ...
  ${If} ${isUpdated}
    ...
    ; Older Codex Crew clients launch every NSIS update with /S. Convert that
