...
// Required" page telling the user to run `codexcrew token` "on your dev
 ...
 *
 * @param {object} [facts]
 * @param {"codexcrew"|"foreign"|"none"|"unknown"} [facts.localOwner="unknown"]
...
function classifyAuthBlock({ localOwner = "unknown", remoteHost = "" } = {}) {
  ...
  if (localOwner === "codexcrew") return "local";
