 ...
 *
 * Also sets `codexcrew.isElectron`, matching the dashboard's own preload. Two
 ...
 *    against a remote CodexCrew" is core's /api/instances feature instead (see
...
contextBridge.exposeInMainWorld("codexcrew", {
...
exposePetApi({
  ...
  /**
   * Open CodexCrew's dashboard in the user's default browser.
   *
