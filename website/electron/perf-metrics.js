...
// backend CLI (`codexcrew desktop metrics`) is a separate Python process and a
...
// keeps the app alive. It is OFF unless CODEXCREW_DEBUG is set, so a normal user
...
const DEBUG_ENV_VAR = "CODEXCREW_DEBUG";

// Kept in sync with codex_crew.perf_sampler.profiling_enabled: the desktop and
