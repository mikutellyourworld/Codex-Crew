...
// in src/codex_crew/config/paths.py (config_dir -> _resolve_default_home):
//   1. A valid CODEXCREW_HOME env override wins. INVALID overrides -- a
...
//      are honored.
//   2. Otherwise the default home ~/.codex-crew.
//
...
function canonicalHome(os = nodeOs, path = nodePath) {
  return path.join(os.homedir(), ".codex-crew");
}

/**
 * The resolved CODEXCREW_HOME override iff set AND valid, else null. Mirrors
 ...
 * CODEXCREW_HOME override, else the default ~/.codex-crew.
