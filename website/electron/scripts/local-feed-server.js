 ...
 *
 * Usage:
 *   node local-feed-server.js --port 8799 --zip /path/CodexCrew.zip --version 1.0.1
 *   CODEXCREW_UPDATE_FEED=http://127.0.0.1:8799/feed <app binary>
 *
...
server.listen(PORT, "127.0.0.1", () => {
  ...
  console.log(`[feed] point the app at it: CODEXCREW_UPDATE_FEED=http://127.0.0.1:${PORT}/feed`);
});
