...
// signed bytes back. See docs/windows-signing.md in CodexCrewPublishCDK.
//
...
//   WINDOWS_SIGNING_PROFILE_ID       profile identifier, e.g. CodexCrewWindowsExe
...
exports.default = async function signWindows(configuration) {
  ...
  // Codex Crew authenticates this exact upstream executable by pinned size and
  ...
  // ("CodexCrew Nightly") also carries a space, which is legal but awkward in a
