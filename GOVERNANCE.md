...
This document covers who makes decisions in Codex Crew, how those decisions get made, and how someone becomes one of the people making them. [CONTRIBUTING.md](CONTRIBUTING.md) covers how to contribute, and the two are meant to be read together.
...
**Users** are everyone running Codex Crew. Filing an issue about what is broken or missing is a real contribution to the project's direction, and most changes in direction start there.
