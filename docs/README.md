...
[`../src/codex_crew/docs/`](../src/codex_crew/docs/README.md), and frontend-specific
...
|---|---|
| [guides/](guides/README.md) | Install, run, and operate Codex Crew. Task-oriented. |
...
| [app-kit/](app-kit/README.md) | Building apps that run inside Codex Crew (third-party developer docs). |
...
- **`src/codex_crew/docs/` filenames are an API.** That tree is packaged, is read at
