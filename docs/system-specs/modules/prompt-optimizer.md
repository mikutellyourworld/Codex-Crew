...
- `src/codex_crew/dashboard/handlers/optimizer.py`: endpoint, system prompt, paste-block assembly, input screening, output redaction, and placeholder guard.
- `src/codex_crew/dashboard/routes/chat.py`: optimizer route registration.
