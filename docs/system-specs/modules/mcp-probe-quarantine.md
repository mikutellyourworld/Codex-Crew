...
Owners: `src/codex_crew/mcp_quarantine.py` (durable counter and decision), `src/codex_crew/dashboard/handlers/mcp.py` (verdict extraction, annotation, reset), and `website/src/pages/overview/McpTab.tsx` (surface).
