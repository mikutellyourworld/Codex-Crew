...
| File | Role |
|---|---|
| `src/codex_crew/dashboard/handlers/files.py` | `api_file_search` endpoint, fuzzy scorer, walk fallback |
| `src/codex_crew/dashboard/file_index.py` | `FileIndex`, `FileIndexRegistry` |
