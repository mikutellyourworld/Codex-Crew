...
will not do — is [`src/codex_crew/docs/followup-suggestions.md`](../../src/codex_crew/docs/followup-suggestions.md).
...
| Layer | Path |
| --- | --- |
| Tool declaration + dispatch | `src/codex_crew/mcp_tools/control.py` |
| Directive marker codec | `src/codex_crew/session_directive.py` |
| Directive applier (the effect) | `src/codex_crew/dashboard/session_directive_apply.py` |
| Arg schema | `src/codex_crew/validation.py` |
| Card endpoint | `src/codex_crew/dashboard/chat_handlers.py` |
| Worktree endpoint | `src/codex_crew/dashboard/handlers/worktree.py` |
