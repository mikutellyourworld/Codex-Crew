...
``src/codex_crew/_vendor`` (vendored llama-cpp-python: executable Python plus
...
(``<hex>  src/codex_crew/_vendor/<relpath>``), sorted with a trailing newline,
...
the vendored tree" section of ``src/codex_crew/_vendor/README.md``) and commit
...
_DEFAULT_VENDOR_DIR = _REPO_ROOT / "src" / "codex_crew" / "_vendor"
...
_MANIFEST_PATH_PREFIX = "src/codex_crew/_vendor/"
...
def main(argv: list[str]) -> int:
    ...
    if symlinks or caches:
        ...
        if caches:
            print(
                ...
                "removed with: find src/codex_crew/_vendor -name __pycache__ -type d "
    ...
    if any(problems.values()):
        ...
        print(
            ...
            "see 'Updating the vendored tree' in src/codex_crew/_vendor/README.md.",
            file=sys.stderr,
        )
        return 1
