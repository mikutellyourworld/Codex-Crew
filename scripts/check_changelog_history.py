...
(``src/codex_crew/changelog.py``) owns that folding, and this gate **loads it from
...
#: without installing ``codex_crew``; ``changelog.py`` has no third-party imports,
#: so the module loads standalone.
RENDERER_PATH = "src/codex_crew/changelog.py"
