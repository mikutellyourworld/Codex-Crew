...
Scans src/codex_crew/docs/*.md (same logic as tips._scan_docs_catalog) and writes
a static JSON catalog to src/codex_crew/data/tips_catalog.json.
...
_DOCS_DIR = _REPO_ROOT / "src" / "codex_crew" / "docs"
...
from codex_crew.tips_allowlist import TIP_DOC_ALLOWLIST  # noqa: E402
from codex_crew.tips_text import (  # noqa: E402
...
def main() -> None:
    ...
    out_path = _REPO_ROOT / "src" / "codex_crew" / "data" / "tips_catalog.json"
