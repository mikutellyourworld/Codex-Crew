...
# Run this once, then navigate to /apps/demo-app in the CodexCrew dashboard.
set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
APP_SOURCE="$SCRIPT_DIR/../website/public/apps/demo-app"
APP_DEST="${CODEXCREW_HOME:-$HOME/.codex-crew}/apps/demo-app"
...
echo "  Navigate to /apps/demo-app in the CodexCrew dashboard to test."
echo ""
echo "  The app will:"
