#!/usr/bin/env bash
# Turn a Codex Crew crash artifact into readable frames.
#
...
#   CODEXCREW_SYMBOL_CACHE   default ${XDG_CACHE_HOME:-~/.cache}/codexcrew/electron-symbols
set -euo pipefail
...
CACHE="${CODEXCREW_SYMBOL_CACHE:-${XDG_CACHE_HOME:-$HOME/.cache}/codexcrew/electron-symbols}"
WORK="$(mktemp -d)"
