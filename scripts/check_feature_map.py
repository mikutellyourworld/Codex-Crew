...
WATCHED_DIRS = (
    "website/src/pages/",
    "src/codex_crew/dashboard/handlers/",
)
...
PROBES: tuple[tuple[str, list[str], list[str], int, int, bool, bool], ...] = (
    ...
    (
        ...
        ["src/codex_crew/dashboard/handlers/new_thing.py"],
        [],
        0,
        0,
        False,
    ...
    (
        ...
        [],
        ["src/codex_crew/dashboard/handlers/old_thing.py"],
        0,
        0,
        False,
        False,
    ...
    ("handler-init-added", ["src/codex_crew/dashboard/handlers/__init__.py"], [], 0, 0, False, True),
    ...
    ("unrelated-module-added", ["src/codex_crew/memory.py"], [], 0, 0, False, True),
