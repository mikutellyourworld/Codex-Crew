...
export const TERMINAL_LINES = [
  { prompt: true, text: 'codexcrew gateway' },
  { text: 'Codex Crew v2.1 starting...' },
...
export const FAQ = [
  { q: 'Does any data leave my machine?', a: 'No. Codex Crew runs entirely locally. Dashboard is bound to localhost. Voice transcription uses local Whisper. The only external calls are to the LLM provider for inference.' },
  ...
  { q: 'How do I add custom tools?', a: "Drop an MCP server config in ~/.codex-crew/mcp.json. It's auto-discovered and synced. Or install via the dashboard MCP tab." },
