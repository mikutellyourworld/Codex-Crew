...
export function HowItWorks() {
  const steps = [
    { n: '1', title: 'Clone & Install', code: 'git clone https://github.com/mikutellyourworld/Codex-Crew.git\ncd codexcrew && pip install .' },
    { n: '2', title: 'Start', code: 'codexcrew gateway', note: 'Dashboard opens at localhost:7777. Run codexcrew doctor to verify.' },
    { n: '3', title: 'Connect', note: 'DM Codex Crew in Slack, or open the dashboard. Type !dashboard in Slack for a 1-click link.' },
  ];
  return (
  ...
  return (
    <section className="text-center px-6 pt-24 pb-16 bg-[radial-gradient(ellipse_60%_50%_at_50%_100%,rgba(245,158,11,0.06),transparent)]">
      <Parallax speed={-0.15}>
        ...
        <FadeUp delay={0.1}><p className="text-slate-500 dark:text-slate-400 text-lg mb-8">One command to install. Every engineer's Codex Crew ends up different — that's the point.</p></FadeUp>
        <FadeUp delay={0.2}>
          <a href="#how-it-works" className="inline-flex items-center gap-2 px-7 py-3.5 rounded-xl text-[15px] font-semibold bg-gradient-to-r from-amber-500 to-orange-600 text-white shadow-[0_0_24px_rgba(245,158,11,0.35)] hover:-translate-y-0.5 transition-all no-underline font-space">Install Codex Crew</a>
        </FadeUp>
        <FadeUp delay={0.3}>
          <div className="flex gap-4 justify-center mt-6 text-sm">
            <a href="https://github.com/mikutellyourworld/Codex-Crew" target="_blank" rel="noopener noreferrer" className="text-amber-400 no-underline hover:underline">GitHub</a>
            <span className="text-slate-600">&middot;</span>
            <a href="https://github.com/mikutellyourworld/Codex-Crew/discussions" target="_blank" rel="noopener noreferrer" className="text-amber-400 no-underline hover:underline">Discussions</a>
            <span className="text-slate-600">&middot;</span>
            <a href="https://github.com/mikutellyourworld/Codex-Crew/issues" target="_blank" rel="noopener noreferrer" className="text-amber-400 no-underline hover:underline">Issues</a>
          </div>
        </FadeUp>
      </Parallax>
    </section>
  ...
  return (
    <footer className="text-center py-10 px-6 border-t border-amber-500/12 text-slate-500 text-xs">
      <div className="flex gap-6 justify-center mb-3">
        {[['https://github.com/mikutellyourworld/Codex-Crew', 'Source'], ['https://github.com/mikutellyourworld/Codex-Crew/wiki', 'Wiki'], ['https://github.com/mikutellyourworld/Codex-Crew/issues', 'Issues']].map(([href, label]) => (
      ...
      <p>Codex Crew — Persistent, self-learning AI agent for engineers</p>
    </footer>
  );
}
