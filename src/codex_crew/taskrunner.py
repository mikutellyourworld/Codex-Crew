...
from codex_crew import git_coord, shutdown_event
...
from codex_crew.llm_helpers import stream_and_collect_json
...
from codex_crew.task_executor import (
    build_task_prompt,
    execute_single_task,
)
from codex_crew.task_executor import self_review as self_review_fn

# ── Re-exports (preserve public API) ──
from codex_crew.task_models import (  # noqa: F401
...
from codex_crew.task_planner import (
    auto_name,
    decompose,
    decompose_yaml,
...
from codex_crew.task_planner import plan_to_chat_context as _planner_plan_to_chat_context
from codex_crew.task_planner import (
    plan_to_yaml,
    update_plan_tasks,
)
from codex_crew.task_reporter import (  # noqa: F401  (NotifyCallback re-exported)
    NotifyCallback,
...
class TaskRunner:
    ...
    def __init__(
        ...
        try:
            auto_cap = compute_max_subagents(CodexCrewConfig.load())
        except Exception:
