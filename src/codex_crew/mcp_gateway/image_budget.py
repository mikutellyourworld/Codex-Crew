...
:mod:`codex_crew.acp.prompt_blocks` entirely -- and because kiro-cli replays the
...
(:func:`codex_crew.imaging.downscale_image_block`) to every image block in a
relayed tool result:
...
unmodified, mirroring :mod:`codex_crew.mcp_gateway.spill`: those frames carry no
...
from codex_crew import imaging
from codex_crew.imaging import (
    MAX_IMAGE_B64_BYTES,
    MAX_IMAGE_EDGE_PX,
...
_OMITTED_TEMPLATE = (
    "[Codex Crew: image omitted from this tool result -- it could not be "
...
_SUMMARY_TEMPLATE = (
    "[Codex Crew: {count} additional image blocks were omitted from this "
...
_EXCESS_TEMPLATE = (
    "[Codex Crew: image omitted -- this tool result asked for more image "
