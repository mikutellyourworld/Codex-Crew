...
PoolKey invariant (same reasoning as the ``CODEXCREW_SPAWNED_ENV`` marker in
:func:`codex_crew.mcp_gateway.backend.spawn_backend`): the injected value is
...
:mod:`codex_crew.agents_janitor`: ``os.lstat`` snapshots, symlinks are never
