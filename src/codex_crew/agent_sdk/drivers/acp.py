...
The layer above (:mod:`codex_crew.agent_sdk.backend_install`) owns the *contract*
...
def resolve_pin_spelling(model_id: str, advertised: object) -> str:
    ...
    Thin delegation to :func:`codex_crew.acp.client.resolve_pin_spelling` — the
    ...
    """
    from codex_crew.acp.client import resolve_pin_spelling as _impl
...
def kimi_cli_resolves() -> bool:
    """Whether Kimi Code CLI resolves through the native ACP spawn resolver."""
    from codex_crew.acp.client import _resolve_kimi_bin

    return bool(_resolve_kimi_bin())
...
def codex_adapter_install_command() -> str:
    ...
    """
    from codex_crew.acp.client import CODEX_ACP_NPM_PKG
...
def claude_adapter_install_command() -> str:
    ...
    """
    from codex_crew.acp.client import CLAUDE_ACP_NPM_PKG
...
async def run_kiro_native_commands(
    ...
    *,
    ...
    from codex_crew.acp.client import AcpAuthRequired, AcpError, AcpTimeoutError
    from codex_crew.sandbox import configured_sandbox_mode
