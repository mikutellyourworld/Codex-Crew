...
Machine-local backend readiness lives in :mod:`codex_crew.agent_sdk.backend_install`.
Promptless structured command batches live in
:mod:`codex_crew.agent_sdk.native_commands`; their ACP process lifecycle and
...
Layering::
    ...
    consumers        dashboard/  slack/  discord/  telegram/  messaging/
                     session.py  subagent.py  apps/  cli_*.py  workflows/
                            |
                            |  import codex_crew.agent_sdk for anything
                            ...
                            v
                     codex_crew.agent_sdk          domain types, role protocols,
                                                  capabilities, supervisor
                            |
                            |  resolves drivers through a registry
                            v
                     codex_crew.agent_sdk.drivers.acp
                                                  the only module INSIDE this
                                                  package that imports
                                                  codex_crew.acp
                            v
                     codex_crew.acp  (foundation)  wire, dialects, adapters,
...
from codex_crew.agent_sdk.backend_install import (
    CACHE_TTL_SECONDS,
    INSTALLED,
    MISSING,
    UNKNOWN,
...
from codex_crew.agent_sdk.native_commands import NativeCommandBatch, run_kiro_native_commands
