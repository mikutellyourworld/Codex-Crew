...
def _operator_attestation_refusal() -> str | None:
    ...
    * :func:`codex_crew.sandbox.agent_confinement_evidence` — the launcher-set
    ...
    * :func:`_grant_record_unwritable` — the sealed-record write probe, which
    ...
    """
    from codex_crew.sandbox import agent_confinement_evidence
                ...
                if not confirm_out_of_install_root:
                    ...
                    return {
                        "error": (
                            ...
                            "operator confirmation: run `codexcrew app dev "
...
def remove_dev_app(name: str) -> None:
    ...
    Called from :func:`codex_crew.apps.manager.uninstall_app` so an app removed
