...
WHAT THIS IS. The catalog at ``apps.crew.kiro.dev`` is the list Codex Crew
...
from codex_crew.apps.manifest import KEBAB_RE, app_name_error
from codex_crew.atomic_write import atomic_write
from codex_crew.config.loader import config_dir

logger = logging.getLogger(__name__)

#: Documented in the CodexCrewApps repo's docs/distribution.md and printed by
#: its publish workflow. Trailing slash matters: refs are resolved against it.
OFFICIAL_CATALOG_BASE = (
    "https://raw.githubusercontent.com/mikutellyourworld/Codex-Crew/main/catalog/"
)
