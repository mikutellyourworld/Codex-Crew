...
from codex_crew.apps.app_storage import AppStorage
from codex_crew.apps.cron_sdk import CronSDK
from codex_crew.apps.event_bus import EventBus
from codex_crew.apps.job_sdk import JobSDK
from codex_crew.apps.spawn_sdk import SpawnSDK
...
class AppContext:
    ...
    logger: logging.Logger = field(default_factory=lambda: logging.getLogger("codexcrew.app"))
...
def build_app_context(
    ...
    *,
    ...
    ctx_logger = logging.getLogger(f"codexcrew.app.{app_name}")
