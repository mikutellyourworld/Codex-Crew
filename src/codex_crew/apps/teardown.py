...
# tests patch (`patch("codex_crew.apps.teardown.on_app_disable")`), and a
...
from codex_crew.apps.lifecycle_scripts import run_lifecycle_script
...
async def teardown_app_runtime(
    ...
    * ``True`` — **trust withdrawal** (a security operation: revoke, or the blanket
    ...
    #   (b) "revocation can leave DETACHED app code running" — `codexcrew app
