...
class CronSDK:
    ...
    def _vet_command_script(self, name: str, command: str, script: str) -> None:
        ...
        """
        if command:
            from codex_crew.mcp_cron import _vet_shell_command
        ...
        if script:
            from codex_crew.mcp_cron import _vet_script_file

            # resolve_script_path rejects paths outside ~/.codex-crew/crons/ (and
