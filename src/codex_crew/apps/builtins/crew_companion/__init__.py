...
* ``website/electron/crew-companion/`` owns the window layer — the transparent,
  ...
  main-process APIs, so they live in Codex Crew's existing shell rather than
...
from codex_crew.apps.builtins.crew_companion.backend.routes import (  # noqa: F401,E402
    register_routes,
)
