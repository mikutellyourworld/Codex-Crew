...
from codex_crew.apps.builtins.crew_companion import hooks as hooks_mod
from codex_crew.apps.builtins.crew_companion.backend import routes as routes_mod
...
# repo_root/src/codex_crew/apps/builtins/crew_companion/tests/test_manifest.py
...
def test_requires_the_desktop_app_declaratively() -> None:
    ...
    The companion needs Codex Crew's desktop app to have somewhere to draw its
