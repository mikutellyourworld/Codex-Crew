...
One surface answers "which accounts can Codex Crew use, do their credentials
...
* **This Python package** owns account aggregation. It reads the existing
  deploy profile registry (``codex_crew.deploy.profiles`` — names, regions and
...
from codex_crew.apps.builtins.aws_control.backend.routes import (  # noqa: F401
    register_routes,
)
