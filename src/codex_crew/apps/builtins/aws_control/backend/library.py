...
from codex_crew.artifacts import ArtifactValidationError, _validate_slug, get_default_store
...
def push_artifact(
    ...
    from codex_crew.deploy.scan import is_credential_finding, scan_content
