 ...
 *   2. a cached copy under ~/.cache/codexcrew-design-critique (override: $DC_PW_DIR)
...
const CACHE = process.env.DC_PW_DIR || join(homedir(), '.cache', 'codexcrew-design-critique')
