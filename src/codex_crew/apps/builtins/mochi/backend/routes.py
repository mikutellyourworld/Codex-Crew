...
through :func:`codex_crew.apps.builtins.mochi.hooks` — the runtime the
...
from codex_crew.apps.builtins.mochi import activity_log, hooks
from codex_crew.apps.builtins.mochi import queue_file as qf
from codex_crew.apps.builtins.mochi import watchlist_file as wf
from codex_crew.apps.builtins.mochi.activity_log import (
    LOG_FILE,
    YESTERDAY_LOG_FILE,
    activity_mutation,
)
from codex_crew.apps.builtins.mochi.agent_policy import PolicyNotMaterialized, apply_policy
from codex_crew.apps.builtins.mochi.appearance_store import (
    MAX_BUNDLE_BYTES,
    PackError,
    delete_pack,
    export_pack,
...
from codex_crew.apps.builtins.mochi.petdex_import import (
    PetdexError,
    fetch_pet,
    list_installed,
    read_installed,
)
from codex_crew.apps.builtins.mochi.pinned_files_service import (
    DATA_FILE_NAME,
    PinsCorruptError,
    pins_mutation,
)
from codex_crew.apps.builtins.mochi.queue_file import QUEUE_FILE as _QUEUE_FILE
from codex_crew.apps.builtins.mochi.queue_file import queue_mutation
from codex_crew.apps.builtins.mochi.redact import redact_tree
from codex_crew.apps.builtins.mochi.settings import (
    _base_defaults,
    load_settings,
    save_settings,
    settings_mutation,
...
from codex_crew.apps.builtins.mochi.stats_service import STATS_FILE_NAME
from codex_crew.apps.builtins.mochi.watchlist_file import watchlist_mutation
from codex_crew.apps.builtins.mochi.watchlist_service import _ARCHIVE_FILE, _WATCHLIST_FILE
...
from codex_crew.mcp_discovery import list_servers, probe_server
...
async def _handle_mcp_tools_probe(request: web.Request) -> web.Response:
    ...
    # sets it for an entry in the Codex Crew scope, but /api/mcp/toggle writes
