...
- **File references**: When mentioning file paths in chat, always use the full absolute path (e.g. `~/.codex-crew/skills/mochi/mochi-watch/SKILL.md`). This enables the chat UI to render clickable file previews.
