...
not belong in CodexCrew's global ``config.json``, so they live in the app's data
...
this machine (port 5486 is a mutex, enforced by the shell's
...
#:
#: Empty means "follow CodexCrew" — the renderer passes it through to
