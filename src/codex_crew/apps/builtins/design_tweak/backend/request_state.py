...
def is_codexcrew_internal(runtime: Any, target: Path) -> bool:
    """Return whether ``target`` resolves within a private Codex Crew tree."""

    real = runtime.os.path.realpath(target)
    for base in runtime._CODEXCREW_INTERNAL_DIRS:
