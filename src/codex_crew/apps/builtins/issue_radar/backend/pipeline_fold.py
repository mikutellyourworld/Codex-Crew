"""Fold Codex Crew's own auto-triage pipeline into a three-level object model.
...
from codex_crew.apps.builtins.issue_radar.backend import store as issue_radar_store
from codex_crew.apps.manager import app_dir
from codex_crew.config.paths import data_home
from codex_crew.memory import workspace_dir
...
#: Matches a pull-request URL tail, e.g. ".../CodexCrew/pull/5600".
