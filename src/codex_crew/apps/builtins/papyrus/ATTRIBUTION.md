...
CodexCrew-family dashboard, and is included here as a first-party builtin app with
...
- The `papyrus-writing` skill ships under `src/codex_crew/builtin_skills/` so
