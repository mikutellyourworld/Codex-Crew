...
try:
    from codex_crew.constants import CHAT_TURN_TIMEOUT
except Exception:  # pragma: no cover - constant always present in prod
    CHAT_TURN_TIMEOUT = 1800  # type: ignore[assignment]

try:
    from codex_crew.autonudge import AutoNudgeService as _AutoNudgeService
...
logger = logging.getLogger("codexcrew.app.spec-builder")
...
def _dispatch_turn(
    ...
    *,
    ...
    try:
        ...
        from codex_crew.dashboard.turn_dispatch import bounded_chat_turn
