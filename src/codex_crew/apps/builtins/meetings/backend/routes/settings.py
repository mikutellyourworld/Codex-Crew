...
from codex_crew.apps.builtins.meetings.backend.providers import calendar as cal
from codex_crew.apps.builtins.meetings.backend.providers import tasks as taskprov
from codex_crew.apps.builtins.meetings.backend.routes._common import (
    BadRequest,
    data_root,
    field_bool,
    field_int,
    ...
    return web.json_response(
        {
            ...
            "stt_providers": [{"id": k.STT_PROVIDER_CODEXCREW, "label": "Codex Crew speech-to-text"}],
...
async def handle_put_config(request: web.Request) -> web.Response:
    ...
    config = {
        ...
        "stt_provider": k.STT_PROVIDER_CODEXCREW,  # the only provider; not client-settable
