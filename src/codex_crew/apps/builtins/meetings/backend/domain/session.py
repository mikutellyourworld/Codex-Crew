...
the shared :class:`~codex_crew.session.SessionManager` via
:func:`~codex_crew.llm_helpers.stream_and_collect` — no socket, no secret, no
second copy of the auth path. Approval runs under
:data:`~codex_crew.llm_helpers.ToolApprovalPolicy.HOOK_BASED` so the agents'
...
from codex_crew.apps.builtins.meetings.backend.domain.dictionary import DomainDictionary
from codex_crew.apps.builtins.meetings.backend.domain.translate import (
    TranslationQueue,
