...
Two extension points, both shaped like ``codex_crew.embeddings``'s
...
from codex_crew.apps.builtins.meetings.backend.providers.calendar import (  # noqa: F401
    CalendarEvent,
    CalendarProvider,
...
from codex_crew.apps.builtins.meetings.backend.providers.tasks import (  # noqa: F401
    TaskDraft,
    TaskProvider,
    TaskRef,
