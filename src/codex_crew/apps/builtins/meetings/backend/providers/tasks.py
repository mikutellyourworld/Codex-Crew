...
``codex_crew.embeddings``' ``EmbeddingBackend`` / ``register_embedding_backend``:
...
writes to a CodexCrew-local, app-scoped task ledger. That is deliberate: the
