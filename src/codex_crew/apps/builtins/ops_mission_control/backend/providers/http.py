...
dependency — Codex Crew's convention is to prefer stdlib, and these adapters make a
...
from codex_crew.apps.builtins.ops_mission_control.backend.providers import HTTP_TIMEOUT_SECS
