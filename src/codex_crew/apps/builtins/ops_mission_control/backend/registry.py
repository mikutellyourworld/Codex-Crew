...
from codex_crew.apps.builtins.ops_mission_control.backend.models import Signal, utc_now_iso
...
def _install_companions(registry: OpsProviderRegistry) -> None:
    ...
    """
    try:
        from codex_crew.apps.builtins.ops_mission_control.backend.companion import (
