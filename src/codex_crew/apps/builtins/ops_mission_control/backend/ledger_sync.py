...
from codex_crew.apps.builtins.ops_mission_control.backend import ledger, policy_store
...
_COMMIT_IDENTITY = (
    "-c",
    "user.name=Codex Crew ops-mission-control",
    "-c",
    "user.email=ops-mission-control@codexcrew.invalid",
)
...
def _credential_bearing_lines() -> list[int]:
    ...
    from codex_crew.security import get_credential_patterns
