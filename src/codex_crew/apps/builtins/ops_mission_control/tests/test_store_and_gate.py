...
``CODEXCREW_HOME`` is redirected to a temp dir so nothing here touches the real
data home.
"""
...
from codex_crew.apps.builtins.ops_mission_control.backend import rotation, routes
from codex_crew.apps.builtins.ops_mission_control.backend.providers.base import ShiftStatus
from codex_crew.cron import CronService, CronStoreUnreadable
...
class TestClaim(_HomeIsolated):
    def test_claim_creates_incident(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import models, store
...
class TestClosingAnIncidentLeavesAnArtifact(_HomeIsolated):
    """A closed incident must leave a Markdown record a non-CodexCrew reader can be handed.
...
class TestStaleSweep(_HomeIsolated):
    ...
    def _backdate(incident_id: str, hours: int) -> None:
        ...
        """
        from codex_crew.apps.builtins.ops_mission_control.backend import store
...
class TestAutonomyGate(_HomeIsolated):
    def _write_config(self, payload: dict) -> None:
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import store as store_mod
    ...
    def test_default_is_observe(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import models, rotation
    ...
    def test_unknown_action_refused(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import rotation
...
class TestTierArming(_HomeIsolated):
    ...
    def test_the_spec_table_matches_the_shipped_tiers_and_enabled_flags(self):
        ...
        # repo_root/src/codex_crew/apps/builtins/<app> -> repo_root
...
class TestLedgerGitMerge(_HomeIsolated):
    ...
    def _duplicate_every_line() -> None:
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import ledger
    ...
    def test_duplicate_lines_collapse_to_one_entry(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import ledger
        from codex_crew.apps.builtins.ops_mission_control.backend.models import LedgerEntry
...
class TestLedger(_HomeIsolated):
    def test_upsert_then_match(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import ledger, models
...
class TestTheSweepWindowsAreReadableBack(_HomeIsolated):
    ...
    def test_the_defaults_in_force_are_reported_without_any_config(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import dispatch, rotation, store
    ...
    def test_an_unset_needs_human_window_is_reported_resolved_not_as_zero(self):
        ...
        """
        from codex_crew.apps.builtins.ops_mission_control.backend import rotation, store
    ...
    def test_the_reported_windows_are_the_ones_the_heartbeat_actually_applies(self):
        ...
        """
        from codex_crew.apps.builtins.ops_mission_control.backend import dispatch, rotation
...
class TestClaimProvenance(unittest.TestCase):
    ...
    def test_the_heartbeat_is_the_default(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import (
            models,
            store,
        )
