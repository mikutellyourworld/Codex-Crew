...
from codex_crew.apps.builtins.ops_mission_control.backend import models, routes, store
...
class TestSecretsAreWriteOnly(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_provider_listing_never_contains_a_token(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import registry, secrets
...
class TestLedgerHygieneWiring(unittest.IsolatedAsyncioTestCase):
    ...
    async def _run(*, calls=None, sync_result="", index_result=None, hygiene=None):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import ledger, ledger_sync
    ...
    async def test_index_helper_survives_having_no_vector_store(self):
        ...
        with mock.patch(
            "codex_crew.vector_memory.VectorMemoryStore",
...
class TestStateReportsTheNotificationChannel(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_a_process_without_a_bus_is_not_reported_ready(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import notify_out
...
class TestProposeLoop(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_an_approved_proposal_executes_the_stored_note_not_the_request(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import registry as registry_mod
    ...
    async def test_a_token_in_the_note_never_reaches_the_sink(self):
        ...
        class _Recorder:
            ...
            async def execute(self, signal, action, payload):
                ...
                from codex_crew.apps.builtins.ops_mission_control.backend.providers.base import (  # noqa: E501
                    ActionResult,
                )
...
class TestACredentialBearingRemoteIsRefused(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_a_token_remote_is_rejected_and_never_stored(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend.providers import read_config
...
class TestAStoreThatRefusesToWriteIsReportedNotCrashed(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_a_claim_survives_a_failed_ledger_annotation(self):
        ...
        """
        from codex_crew.apps.builtins.ops_mission_control.backend import dispatch, models
    ...
    async def test_a_refused_destination_write_is_a_coded_503_too(self):
        ...
        """
        from codex_crew.apps.builtins.ops_mission_control.backend import slack_out
