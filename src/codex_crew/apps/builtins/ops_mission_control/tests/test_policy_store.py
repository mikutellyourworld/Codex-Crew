...
class TestTheCeilingIsOnTheKeystoneFloor(_HomeIsolated):
    def test_the_policy_file_is_fenced_and_config_is_not(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend.store import APP_NAME
    ...
    def test_rotation_reads_mode_and_rules_from_the_store(self):
        from codex_crew.apps.builtins.ops_mission_control.backend import policy_store, rotation
...
class TestOutboundDestinationsAreOperatorOnly(_HomeIsolated):
    ...
    def test_an_agent_write_cannot_move_the_ledger_remote(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend.providers import write_config
    ...
    def test_the_branch_stays_in_plain_config_deliberately(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import ledger_sync, policy_store
        from codex_crew.apps.builtins.ops_mission_control.backend.providers import read_config
