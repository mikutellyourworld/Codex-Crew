...
from codex_crew.apps.builtins.ops_mission_control.backend import routes
...
class TestManifestCrons(unittest.TestCase):
    ...
    def test_secrets_live_outside_the_app_dir_so_uninstall_cannot_reach_them(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend.secrets import secrets_path
    ...
    def test_settings_discloses_that_uninstall_keeps_credentials(self):
        ...
        # codex_crew/src/<root>). Resolved by counting rather than guessed — an
...
class TestSkillDelivery(unittest.TestCase):
    ...
    def _skill_root(self) -> Path:
        ...
        return Path(codex_crew.__file__).resolve().parent / "builtin_skills" / "ops-mission-control"
    ...
    def _sop_calls(self):
        ...
        # parents[4] is src/codex_crew (routes.py -> backend -> app -> builtins ->
        # apps -> codex_crew). Counted, not guessed: an off-by-one makes this SKIP,
    ...
    def test_readme_companion_contract_names_the_real_symbols(self):
        ...
        from codex_crew.apps.builtins.ops_mission_control.backend import companion
    ...
    def test_no_sop_instructs_a_blocked_or_raw_auth_path(self):
        ...
        cli_mint = re.compile(r"codexcrew\s+(?:pod\s+)?tok" + "en" + r"\b")
    ...
    def test_cron_prompts_point_at_paths_that_will_exist(self):
        ...
        prefix = "~/.codex-crew/skills/ops-mission-control/sops/"
