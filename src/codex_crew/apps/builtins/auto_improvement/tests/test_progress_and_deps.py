...
from codex_crew.apps.builtins.auto_improvement.backend import deps, mcp_server, progress, store
...
class TestMcpServer:
    ...
    def test_an_unauditable_call_is_refused_not_served(
        ...
        # so patching `codex_crew.sel` would leave the already-bound reference in place and
...
class TestWorkspaceScoping:
    ...
    def test_repo_and_branch_produce_distinct_ledgers(self, tmp_path, monkeypatch) -> None:
        ...
        _cfg(target_display="mikutellyourworld/Codex-Crew", branch="origin/main")
...
class TestMcpResultsAreRedacted:
    ...
    def test_a_credential_in_a_ledger_note_does_not_reach_the_result(
        ...
        from codex_crew.apps.builtins.auto_improvement.backend import mcp_server, store
    ...
    def test_redaction_runs_before_truncation(self) -> None:
        ...
        from codex_crew.apps.builtins.auto_improvement.backend import mcp_server
