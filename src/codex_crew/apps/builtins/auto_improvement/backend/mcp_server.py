...
port and served MCP over that port. A Codex Crew builtin runs IN-PROCESS inside the
...
Run as: ``python -m codex_crew.apps.builtins.auto_improvement.backend.mcp_server``
"""
