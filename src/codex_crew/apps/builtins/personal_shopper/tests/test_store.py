...
from codex_crew.apps.builtins import BUILTIN_NAMES, personal_shopper
from codex_crew.apps.builtins.personal_shopper.backend import store as store_mod
...
class TestManifestWiring(unittest.TestCase):
    ...
    def test_declared_assets_exist(self) -> None:
        ...
        manifest = json.loads(manifest_path.read_text(encoding="utf-8"))
        # tests/ -> personal_shopper -> builtins -> apps -> codex_crew -> src -> repo
