...
dashboard "Workflows" tab. CodexCrew proxies ``/apps/workflows/api/*`` to this
...
logger = logging.getLogger("codexcrew.app.workflows")
...
APP_NAME = os.environ.get("CODEXCREW_APP_NAME", "workflows")
