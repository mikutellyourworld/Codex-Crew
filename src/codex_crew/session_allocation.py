...
never imports :mod:`codex_crew.session` at runtime; patchable compatibility seams
...
from codex_crew.metrics.sessions import (
    END_REASON_EVICTED,
    ...
    def context_info(self) -> list[dict[str, object]]:
        ...
        for key, session in self._sessions.items():
            ...
            if self._deps.is_claude_provider(provider):
                ...
                if model == "auto" and agent and agent != "codexcrew":
