...
:mod:`codex_crew.messaging.sessions_view`, shared with the chat channels'
...
Beyond ``codex_crew.slack.blocks.session_task_card`` this module has no
...
from codex_crew.messaging.sessions_view import (  # noqa: F401 — re-exported surface
...
from codex_crew.messaging.sessions_view import _collect_recent_sessions as _collect_neutral
from codex_crew.messaging.sessions_view import (  # noqa: F401 — re-exported surface
    _default_session_title,
)
from codex_crew.security import redact_credentials, redact_exfiltration_urls
from codex_crew.slack.blocks import session_task_card
...
def _build_sessions_blocks(
    ...
    shared :func:`codex_crew.slack.blocks.session_task_card` builder so the
