...
from codex_crew.executors import stt_executor
from codex_crew.stt import models
from codex_crew.stt.limits import DEFAULT_IDLE_EVICT_SECS, DEFAULT_TIMEOUT_SECS
...
def thread_count() -> int:
    ...
    host with other work (a Codex Crew host runs the gateway and agent sessions
...
class WhisperEngine:
    ...
    def _build_model(key: LoadedKey) -> Any:
        ...
        fetch in Codex Crew goes through the sha256-pinned store instead.
        """
