...
**Agent selection (only when the conductor skill is enabled).** If Codex Crew's
...
Prompt-and-orchestration only — no Codex Crew core changes. If it proves valuable,
