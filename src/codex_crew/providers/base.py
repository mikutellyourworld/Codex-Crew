...
from codex_crew.acp.types import (  # noqa: F401
...
from codex_crew.acp.types import AcpEvent as LLMEvent  # noqa: F401
...
class SessionMcpReport(Protocol):
    ...
    Declared at the provider seam rather than imported from ``codex_crew.acp`` so
