...
The translation itself lives in :mod:`codex_crew.acp.session_mcp` (spec entry ->
...
:mod:`codex_crew.acp.kas_permissions` stays beside the mirror as its translation
...
from codex_crew.providers.mirrors.base import (
    AgentConfigMirror,
    Concern,
    Disposition,
    Ruling,
