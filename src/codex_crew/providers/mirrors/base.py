...
every backend Codex Crew drives, and no two backends read it the same way. kiro-cli
...
``tools: ["@codexcrew-core", ...]`` with nothing defining ``codexcrew-core`` — refs
...
:mod:`codex_crew.acp.kas_agents`, whose comment states the rule this vocabulary
