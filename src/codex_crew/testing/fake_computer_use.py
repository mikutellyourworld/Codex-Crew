...
:mod:`codex_crew.testing.fake_acp_backend`, so a downstream suite can exercise
...
from codex_crew.computer_use import cursor_motion
from codex_crew.computer_use.backend import ComputerUseBackend
...
FAKE_FILES_APP = AppRef(
    name="Fake Files",
    pid=4101,
    bundle_id="dev.codexcrew.fake.files",
    window_id=8801,
...
FAKE_LOGIN_APP = AppRef(
    name="Fake Login",
    pid=4102,
    bundle_id="dev.codexcrew.fake.login",
    window_id=8802,
...
FAKE_DRAW_APP = AppRef(
    name="Fake Draw",
    pid=4104,
    bundle_id="dev.codexcrew.fake.draw",
    window_id=8804,
