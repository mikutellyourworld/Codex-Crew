...
image wider or taller than :data:`codex_crew.imaging.MAX_IMAGE_EDGE_PX`::
...
----------------------------------------------------
The files belong to kiro-cli, not to Codex Crew, and automatically rewriting
...
-------------------------------------------
:func:`codex_crew.imaging.downscale_image_block` fails closed -- it returns
