...
Each subagent gets a folder at ``~/.codex-crew/subagents/{id}/`` containing:
...
from codex_crew.jsonl_util import rotate_jsonl_at
...
def create_agent_folder(
    ...
    *,
    ...
    """Create ``~/.codex-crew/subagents/{id}/`` with ``state.json``.
