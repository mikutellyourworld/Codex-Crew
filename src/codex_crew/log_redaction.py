...
from codex_crew.credential_patterns import AWS_KEY_ID_REDACTION, JWT_MULTI_SEGMENT
...
_FACTORY_BASE = "_codexcrew_redaction_base"
_FACTORY_FILTER = "_codexcrew_redaction_filter"
