...
The sibling of :mod:`codex_crew.widget_artifacts`, for the other thing an agent
...
``(message_ts, image_index)`` via :func:`codex_crew.widget_slug.derive_widget_slug`,
...
from codex_crew.widget_slug import derive_widget_slug
