...
There is no runtime import of :mod:`codex_crew.session`.  Patchable module
...
class SessionLifecycleDeps:
    ...
    ``codex_crew.session.build_provider_factory`` and
    ``codex_crew.session.schedule_abort`` effective after service construction.
    """
