...
from codex_crew.atomic_write import read_bytes_with_retry, replace_with_retry
from codex_crew.config.loader import CodexCrewConfig, resolve_agent_bindings
...
from codex_crew.llm_helpers import _extract_json_of_type, run_bg_oneliner
...
class CrewOrchestrator:
    ...
    async def _dispatch_agent(self, slot: Any) -> str:
        ...
        the default crew: ``default`` binds the template ``codexcrew``. Passing the
        ...
        try:
            # CodexCrewConfig.load() reads and parses from disk; this runs on the
