...
KEY_KIND = "codexcrew_kind"
KEY_CHOICE = "codexcrew_choice"
KEY_NONCE = "codexcrew_nonce"
KEY_REQUEST = "codexcrew_request"
...
def options_card(choices: list[str], *, nonce: str) -> dict[str, Any] | None:
    ...
    *choices* must already be capped by
    :func:`codex_crew.messaging.renderer.apply_options_cap`, which is what puts the
