...
# stdlib plus Codex Crew's site-packages — is well under this; anything beyond
...
def pycache_cache_dir() -> Path:
    ...
    Only ever returns Codex Crew's own configured cache directory. The
    ...
    recursive deletion root: their ``.pyc`` mirrors are not Codex Crew's to
