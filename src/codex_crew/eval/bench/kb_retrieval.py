...
from codex_crew.eval.bench.retrieval import (
    ndcg_at_k,
    recall_all_at_k,
    recall_any_at_k,
    recall_micro_at_k,
)
from codex_crew.eval.bench.safepath import UnsafePathError, read_text_nofollow
...
# knowledge.store / sqlite into an unrelated `codexcrew` subcommand's boot path.
