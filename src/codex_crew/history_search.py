...
from codex_crew._sqlite_compat import is_cjk_char, script_runs
...
def _is_cjk_char(ch: str) -> bool:
    ...
    The ranges themselves live in :mod:`codex_crew._sqlite_compat`, which the
...
#: ``codex_crew.dashboard.handlers.source_providers`` — a 7k-line module that
...
def _facade_search_scan_window() -> int:
    ...
    ``codex_crew.history._SEARCH_SCAN_WINDOW`` after construction.
    """
