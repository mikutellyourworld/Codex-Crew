...
stay in ``codex_crew.messaging.attachments``.
"""
...
# ``from codex_crew.discord.attachments import append_attachment_context``
...
# Kept in this module's public API so existing `from codex_crew.discord.attachments
