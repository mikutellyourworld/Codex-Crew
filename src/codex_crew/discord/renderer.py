...
:mod:`codex_crew.messaging.status_reactions`, driven through a sink bound to the
...
Length splitting belongs to :func:`codex_crew.messaging.split.split_markdown_safe`,
...
from codex_crew.constants import split_trailing_protocol_suffix
...
from codex_crew.messaging.approval import APPROVAL_TIMEOUT_S
...
from codex_crew.messaging.status_reactions import (
    PHASE_QUEUED,
    PHASE_THINKING,
    PhaseReactionLadder,
    StallEmojis,
