...
computed by :mod:`codex_crew.resource_status` reaches agents (the injected
...
from codex_crew.notifications.bus import NotificationPayload
from codex_crew.resource_status import (
    POSTURE_AMPLE,
    POSTURE_CRITICAL,
    POSTURE_TIGHT,
    ResourceStatus,
...
from codex_crew.sandbox import check_agents_slice_pressure
...
class ResourcePressureNotifier:
    ...
    def _run_probe(self) -> ResourceStatus:
        ...
        try:
            ...
            # cadence: new OOM kills inside codexcrew-agents.slice are logged
