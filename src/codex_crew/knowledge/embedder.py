...
Wraps the shared ``LlamaCppEmbedder`` from ``codex_crew.embeddings``. Returns
...
if TYPE_CHECKING:
    from codex_crew.embeddings import EmbeddingBackend
...
class InProcessEmbedder:
    ...
    def _get_embedder(self) -> "EmbeddingBackend":
        ...
        # patches of codex_crew.embeddings.get_shared_embedder stay effective.
