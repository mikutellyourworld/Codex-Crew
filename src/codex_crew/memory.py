...
from codex_crew._sqlite_compat import (
...
from codex_crew.metrics.db_metrics import timed, timed_query
from codex_crew.platform_compat import file_lock, first_linked_ancestor, is_link_or_junction
...
class MemoryStore:
    ...
    def _atomic_write_text(self, path: Path, content: str) -> None:
        ...
        to :func:`codex_crew.atomic_write.atomic_write`, which stages the
    ...
    def append_history(self, entry: str) -> None:
        ...
        :func:`codex_crew.platform_compat.file_lock` (real cross-platform locking
    ...
    def _guarded_entry(self, path: Path) -> dict:
        ...
        through :func:`codex_crew.hooks.safe_read_file_bytes_nolink` confined
