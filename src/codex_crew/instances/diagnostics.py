...
_REASONS = {
    ...
    REMOTE_DOWN: "SSH works but the remote Codex Crew dashboard isn't responding (is the "
...
_SSM_REASONS = {
    ...
    REMOTE_DOWN: "SSM reaches the instance but the remote Codex Crew dashboard isn't "
...
async def _probe_ssm_managed(ssm_target: str, profile: str = "", region: str = "") -> bool:
    ...
    :func:`codex_crew.cloud.ssm.instance_is_managed` (read-only
