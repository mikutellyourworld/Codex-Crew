...
from codex_crew.wakatime.client import DEFAULT_API_BASE, WakaTimeClient
...
def resolve_base_url(config: CodexCrewConfig | None = None) -> str:
...
def build_client(config: CodexCrewConfig | None = None) -> WakaTimeClient | None:
