"""The real :class:`~codex_crew.cloud.launch_job.LaunchEngine` — binds the launch
...
from codex_crew.cloud import ec2, iam, login, sizes
...
class RealLaunchEngine:
    ...
    def register(self, *, instance_id: str, tag: str, profile: str, region: str) -> None:
        ...
        registered = connect_mod.register_instance(
            instance_id, name=f"Codex Crew Cloud ({tag})", profile=profile, region=region,
        )
