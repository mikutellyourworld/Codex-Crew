...
one promptless kiro-cli ACP session under the real Codex Crew agent, then reads
...
exposure rules; Codex Crew receives only bounded status and counts.
"""
...
from codex_crew.agent_sdk import run_kiro_native_commands
