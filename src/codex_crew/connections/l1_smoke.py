...
Invariants: **Codex Crew holds no token** (kiro-cli injects the bearer in its own
...
:func:`~codex_crew.mcp_grant.grant_presence` -- paired artifacts stat-ed,
...
from codex_crew.connections.registry import Provider, get_all_registry_providers
...
_CLIENT_INFO = {"name": "codexcrew-l1-smoke", "version": "1"}
