...
KAS credentials live in a DEDICATED :class:`~codex_crew.secrets.SecretVault`
...
from codex_crew.platform_compat import is_link_or_junction, make_owner_only_dir
