"""CodexCrew computer use — read and drive desktop app windows via accessibility.
...
Architecture in one paragraph: the ``codexcrew-computer`` MCP sidecar dispatches
...
:class:`~codex_crew.computer_use.backend.ComputerUseBackend`. The accessibility
...
from codex_crew.computer_use.index import SnapshotIndex, get_shared_index, reset_shared_index
