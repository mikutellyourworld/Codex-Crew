...
Electron/Chromium apps (Slack, VS Code, Obsidian, and CodexCrew's own desktop app)
...
def _title_stem(window_title: str) -> str:
    ...
    ``'fix(ci): keep GHCR package priv…est #621 · mikutellyourworld/Codex-Crew'``), so only
