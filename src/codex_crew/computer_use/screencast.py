...
from codex_crew.computer_use.types import MAX_SCREENSHOT_MAX_PX, OBS_SCREENSHOT, Snapshot
...
def _ingress_url() -> str:
    ...
    process actually bound over an inherited ``CODEXCREW_PORT``, so an auto-port
...
def _headers() -> dict[str, str]:
    ...
    sibling is never reached -- including when an inherited ``CODEXCREW_PORT`` names
