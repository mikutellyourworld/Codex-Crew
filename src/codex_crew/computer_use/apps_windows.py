...
from codex_crew.computer_use import policy, windows_ffi
from codex_crew.computer_use.types import AppRef, ComputerUseError
...
def _denied_title(title: str) -> bool:
    """Whether *title* trips the built-in denylist (Codex Crew's own window)."""
