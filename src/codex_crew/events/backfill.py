...
Usage::
    ...
    python -m codex_crew.events.backfill            # report
    python -m codex_crew.events.backfill --limit 200 --home /path/to/home
"""
...
from codex_crew.events.base import Event, kind_of, serialize
...
def _open_binary_no_follow(path: Path) -> "io.BufferedReader":
    ...
    The record readers in :mod:`codex_crew.jsonl_util` require a binary handle
