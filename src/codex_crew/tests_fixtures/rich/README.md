...
Fully-populated `$CODEXCREW_HOME`: everything `minimal` ships **plus**
...
Running `codexcrew gateway --seed rich` against a fresh `$CODEXCREW_HOME`
lands you on a dashboard where:

- **Sessions** panel shows 3 active slots: pinned **Welcome to CodexCrew**
...
│   ├── dashboard_coder-demo.jsonl     # pinned, codexcrew agent, folder=demos, 8 msg
