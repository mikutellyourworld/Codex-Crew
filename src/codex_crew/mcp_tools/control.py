...
from codex_crew import autonudge, mcp_core, platform_compat, session_directive
...
from codex_crew.monitoring.github_pull_request import parse_github_pull_request_target
...
def wait(name: str, args: dict[str, Any]) -> str:
    ...
    # CODEXCREW_SESSION_KEY) a subagent's sleep would publish its deadline onto
    ...
    # CODEXCREW_SESSION_KEY, or a HMAC-verified pid sidecar.
