...
Chat with your Codex Crew agent from the Messages app you already use — from your
...
account. Codex Crew talks to Messages.app locally, so nothing about the
...
2. **Turn the channel on** in `~/.codex-crew/config.json`. Your own handle is the
