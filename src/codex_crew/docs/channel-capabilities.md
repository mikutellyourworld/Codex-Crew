...
A ✅ means Codex Crew supports that behaviour on that channel today, not that the
...
[`docs/system-specs/modules/messaging.md`](https://github.com/mikutellyourworld/Codex-Crew/blob/main/docs/system-specs/modules/messaging.md),
the spec that owns
