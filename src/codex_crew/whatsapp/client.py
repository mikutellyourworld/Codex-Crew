...
never load the bundled Go core, so a missing ``codexcrew[whatsapp]`` extra
...
from codex_crew.platform_compat import make_owner_only_dir, restrict_to_owner
from codex_crew.whatsapp.jids import OwnIdentity, jid_to_str
...
class WhatsAppClient:
    ...
    async def send_text(
        ...
        from codex_crew.whatsapp.renderer import render_chunks_off_loop
    ...
    def _parse_jid(self, jid_str: str) -> Any:
        ...
        from codex_crew.whatsapp.jids import USER_SERVER, normalize_jid
