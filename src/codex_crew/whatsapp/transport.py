...
Wraps :class:`codex_crew.whatsapp.client.WhatsAppClient` in the channel-neutral
...
1. **shape**: the message is unwrapped (ephemeral, view-once and edited
   ...
   :mod:`codex_crew.whatsapp.media`. Anything that yields neither text, nor
...
4. **group gate**: group chats are dropped unless configured, then gated by
   mode/mention/cooldown (:mod:`codex_crew.whatsapp.group_gate`);
...
from codex_crew.messaging.attachments import append_attachment_context, cleanup
from codex_crew.messaging.dispatch import inbound_permitted
from codex_crew.messaging.transport import (
...
from codex_crew.whatsapp.attachments import ingest_media
from codex_crew.whatsapp.client import WhatsAppClient
from codex_crew.whatsapp.commands import parse_command
from codex_crew.whatsapp.echo import EchoTracker
from codex_crew.whatsapp.group_gate import GroupGate, GroupVerdict
from codex_crew.whatsapp.jids import (
    LID_SERVER,
    is_group_jid,
    jid_to_str,
    jid_user,
...
from codex_crew.whatsapp.media import describe, unsupported_note, unwrap_message
from codex_crew.whatsapp.renderer import WHATSAPP_CHUNK_LIMIT
