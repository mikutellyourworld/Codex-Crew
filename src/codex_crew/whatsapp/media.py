...
an :class:`codex_crew.messaging.attachments.Attachment`: fetching needs the live
...
#: :func:`codex_crew.messaging.attachments.ingest_attachments` can turn them into
...
def unsupported_note(desc: MediaDescription) -> str:
    ...
    :func:`codex_crew.messaging.attachments.append_attachment_context` appends a
