...
from codex_crew.messaging.approval import (
...
from codex_crew.whatsapp.commands import (
...
from codex_crew.whatsapp.group_gate import build_silence_contract
from codex_crew.whatsapp.jids import is_group_jid, wa_id_to_user_jid
from codex_crew.whatsapp.transport import WHATSAPP_CAPABILITIES, WhatsAppTransport
from codex_crew.whatsapp.turn_renderer import WhatsAppRenderer
...
class WhatsAppDispatcher:
    ...
    def _seed_gen(self, scope: str) -> int:
        ...
        exists to prevent.
        """
        from codex_crew.messaging.link import CHAT_TYPE_DIRECT, CHAT_TYPE_FORUM
