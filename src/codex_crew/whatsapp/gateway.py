...
from codex_crew.whatsapp.jids import normalize_jid
from codex_crew.whatsapp.transport import WhatsAppTransport
from codex_crew.whatsapp.transport_dispatch import WhatsAppDispatcher
...
async def maybe_start_whatsapp(orch: "GatewayOrchestrator") -> "WhatsAppClient | None":
    ...
    if not neonize_available():
        from codex_crew.whatsapp.client import MISSING_EXTRA_HINT
