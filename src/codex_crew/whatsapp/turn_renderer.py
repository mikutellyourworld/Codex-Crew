...
from codex_crew.constants import OPTIONS_RE_TRAILER, split_trailing_protocol_suffix
...
from codex_crew.messaging.outbound_files import Rejection, hide_local_refs
from codex_crew.messaging.renderer import Renderer
from codex_crew.messaging.transport import TransportCapabilities
from codex_crew.whatsapp import client as wa_client
from codex_crew.whatsapp.files import (
    REASON_UPLOAD_FAILED,
    plan_uploads_off_loop,
    rejection_note,
)
from codex_crew.whatsapp.group_gate import SILENCE_SENTINEL
from codex_crew.whatsapp.renderer import display_safe_text, render_chunks_off_loop
