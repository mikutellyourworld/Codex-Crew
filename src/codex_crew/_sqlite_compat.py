...
CodexCrew's memory and knowledge stores require SQLite's FTS5 full-text
...
FTS5_UNAVAILABLE_HINT = (
    ...
    "build. CodexCrew memory and knowledge search require it.\n"
    "  - Linux x86_64: pip install pysqlite3-binary (CodexCrew depends on it here).\n"
