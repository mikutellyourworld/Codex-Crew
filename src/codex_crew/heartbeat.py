...
from codex_crew import platform_compat, shutdown_event
...
_HEADER = (
    ...
    "CodexCrew picks them up on next heartbeat. -->\n"
)
...
class HeartbeatService:
    ...
    async def start(self) -> None:
        ...
        # CODEXCREW_READY, and workspace_dir() may sit on a network or synced
    ...
    async def _beat(self) -> None:
        ...
        if self._tick % _PRUNE_TICKS == 0:
            max_days = CodexCrewConfig.load().memory.history_max_days
            loop = asyncio.get_running_loop()
            ...
            try:
                ...
                try:
                    get_recorder().counter("codexcrew.sel.prune_failed.count")
                except Exception:
                    pass
