...
from codex_crew.security import canonicalize_ip
...
_USER_AGENT = "CodexCrew/1.0 (skill-discovery)"
...
def _audit_ssrf_blocked(url: str, host: str, canonical_host: str) -> None:
    ...
    """
    try:
        from codex_crew.sel import sel  # circular import: sel -> ... -> skill_providers
