...
:mod:`codex_crew.messaging.session_resume`, shared with Discord. This module is only what
is Teams-shaped:
...
from codex_crew.messaging.driver import sanitize_channel_replay_text
from codex_crew.messaging.link import ChannelLink
from codex_crew.messaging.session_resume import ResumeReleaseError  # noqa: F401  (re-export)
...
from codex_crew.teams.cards import resolved_card, session_picker_card
from codex_crew.teams.client import TEAMS_MAX_TEXT, TeamsSendError
from codex_crew.teams.renderer import _display_safe
