...
* inbound classification, size limits, image-signature validation, text/document
  ...
  ownership -> :mod:`codex_crew.messaging.attachments`
* outbound reference scanning, the security floor, the raster sniff and the
  per-message budgets -> :mod:`codex_crew.messaging.outbound_files`
...
from codex_crew.messaging.renderer import _default_redactor
...
#: Budgets for :func:`codex_crew.messaging.outbound_files.extract_local_refs`.
