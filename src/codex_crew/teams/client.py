...
inbound token verification (an optional ``codexcrew[teams]`` extra). This keeps
...
from codex_crew import link_unfurl
from codex_crew.sel import sel
from codex_crew.teams.attachments import quoted_reply_text
from codex_crew.teams.commands import STOP_ALIASES

logger = logging.getLogger(__name__)

# PyJWT is an optional dependency (codexcrew[teams]); the channel refuses to
...
class TeamsInbound:
    ...
    :mod:`codex_crew.teams.attachments`, downstream of the transport's
...
class TeamsClient:
    ...
    async def send_inline_image(
        ...
        :func:`codex_crew.teams.attachments.inline_image_attachment`.
