...
(``codex_crew.tips._scan_docs_catalog``) and the release-time generator
...
and opened Codex Crew, so a product-overview tip like "Getting Started" can
...
pulling in the full codex_crew runtime.
"""
