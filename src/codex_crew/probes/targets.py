...
(mikutellyourworld/Codex-Crew, branch ...)" -- so asking the caller to also supply a
...
#: source locations, and ``src/codex_crew/autonudge.py#1751`` would otherwise read as
#: owner ``codex_crew`` / repo ``autonudge.py`` / PR 1751 -- so it would manufacture
