...
(:meth:`~codex_crew.irq.Probe.identity`) and *what does it look like right now*
(:meth:`~codex_crew.irq.Probe.observe`) -- and nothing else. Everything generic
lives in :mod:`codex_crew.irq`: state persistence, per-epoch reset, time-bounded
...
if TYPE_CHECKING:  # pragma: no cover - typing only
    from codex_crew.irq import Probe
