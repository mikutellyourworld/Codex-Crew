...
def is_wait_tool(title: str) -> bool:
    """True when a tool title names the codexcrew-core ``wait`` tool.

    Titles vary by transport ("wait", "codexcrew-core___wait", "wait (mcp)");
...
class LivenessOracle:
    ...
    One instance per :class:`~codex_crew.acp.session_handle.AcpSessionHandle`.
    ...
    def _check_tool(self, runtime_pid: int | None, tool: ToolCallState) -> tuple[str, str]:
        ...
        # Declared-duration contract for the codexcrew-core wait tool: the
