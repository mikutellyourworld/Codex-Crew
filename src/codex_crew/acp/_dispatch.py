...
from codex_crew import mcp_apps_render, session_directive
...
def _build_tool_call_event(
    ...
    # Round-trip clock for codexcrew.tool.call.duration. Placed after the trusted
...
def tool_call_content_text(entry: Any) -> str | None:
    ...
    (mikutellyourworld/Codex-Crew#8522).
    """
    if not isinstance(entry, dict):
        return None
