...
split into chunks by :mod:`codex_crew.weixin.renderer_chunks`. While the turn
...
from codex_crew.messaging.renderer import Renderer, render_options_as_text
from codex_crew.messaging.transport import TransportCapabilities
from codex_crew.weixin.client import TYPING_START, TYPING_STOP
from codex_crew.weixin.renderer import render_chunks
