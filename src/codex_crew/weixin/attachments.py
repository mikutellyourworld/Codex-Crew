...
:mod:`codex_crew.messaging.attachments`.

Mirrors :mod:`codex_crew.telegram.attachments` and
:mod:`codex_crew.discord.attachments` -- same shared pipeline, only the envelope
...
from codex_crew.weixin.client import ITEM_FILE, ITEM_IMAGE, ITEM_VIDEO, ITEM_VOICE
from codex_crew.weixin.media import CDN_BASE_URL, download_media, media_ref
