"""Explicit owner consent before Codex Crew delivers a file whose contents the
...
:mod:`codex_crew.aws_consent` gives for a paid AWS call: ``file_send`` fires from
...
#: because it has TWO writers -- its dashboard handler and the ``codexcrew
