"""``codexcrew.tool.call.duration`` -- how long each tool round-trip takes.
...
TOOL_CALL_METRIC = "codexcrew.tool.call.duration"
...
#: The recognised ACP tool kinds, plus Codex Crew's own ``client_built_in`` (used
...
def record_tool_call_finished(
    ...
    """Emit one ``codexcrew.tool.call.duration`` sample; never raises.
