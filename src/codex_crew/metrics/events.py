...
subagent manager) can emit ``codexcrew.*`` counters without importing
``metrics.provider`` at module top — that import chain reads CodexCrewConfig
...
CHILD_PERMISSION_DENIED = "codexcrew.acp.child_permission.denied"
...
CHILD_PERMISSION_ROUTED = "codexcrew.acp.child_permission.routed"
...
DROPPED_FRAMES = "codexcrew.acp.dropped_frames"
...
TURN_TIMEOUT_CAUSE = "codexcrew.turn.timeout.cause"
...
SESSION_IDLE_EXPIRED = "codexcrew.session.idle_expired"
...
SUBAGENTS_SPAWNED = "codexcrew.subagent.spawned"
...
CRON_FIRES = "codexcrew.cron.fires"
...
ARTIFACTS_CREATED = "codexcrew.artifact.created"
...
WORKFLOW_RUNS = "codexcrew.workflow.runs"
...
CONTEXT_COMPACTIONS = "codexcrew.context.compactions"
...
MCP_RECONNECTS = "codexcrew.mcp.reconnects"
...
APPROVAL_DECISIONS = "codexcrew.approval.decisions"
