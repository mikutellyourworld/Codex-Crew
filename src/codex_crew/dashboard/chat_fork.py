...
from codex_crew.dashboard.chat_persistence import save_slot_off_loop, session_was_deleted
...
from codex_crew.history import carry_provenance
from codex_crew.history_projection import drop_persisted_tail_prefix as _drop_persisted_tail_prefix
...
async def api_chat_slot_fork(request: web.Request) -> web.Response:
    ...
    if direction == _FORK_DIRECTION_TAIL and not CodexCrewConfig.load().dashboard.tail_fork_enabled:
