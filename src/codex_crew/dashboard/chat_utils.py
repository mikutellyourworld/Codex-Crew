...
from codex_crew.context_blocks import attributable_user_chars
...
from codex_crew.history import transcript_sort_key
from codex_crew.hooks import safe_read_file
from codex_crew.messaging.link import canonical_key, is_channel_session_key
...
from codex_crew.session_surface import has_dashboard_surface, set_dashboard_surfaced
...
async def run_config_write(fn, /, *args, **kwargs):
    ...
    """
    from codex_crew.dashboard.handlers.agents import _get_config_lock  # lazy: import cycle
...
def _sync_dashboard_slots(state: "DashboardState") -> None:
    ...
    (see :mod:`codex_crew.session_surface`). A channel-born slot contributes its
...
#: ``codex_crew.acp.types``, following the precedent in ``metrics/turns.py``:
