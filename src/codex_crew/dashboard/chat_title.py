...
from codex_crew.context import ui_language_tag
from codex_crew.context_management import extract_plan_metadata, rephrase_plan
from codex_crew.dashboard.chat_folder_suggest import maybe_suggest_folder
from codex_crew.dashboard.chat_utils import (
    slot_history_key,
)
from codex_crew.dashboard.state import NEW_SESSION_TITLE, DashboardState, _ChatSlot
from codex_crew.llm_helpers import background_turn, run_bg_oneliner
...
def _ui_language() -> str:
    ...
    **Call this OFF the event loop.** ``CodexCrewConfig.load()`` stats, reads and
...
async def _rephrase_plan_lite(
    ...
    *,
    ...
    """Rephrase a plan using the cheap background session (codexcrew-lite)."""
