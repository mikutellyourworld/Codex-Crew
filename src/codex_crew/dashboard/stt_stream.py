...
from codex_crew import aws_consent, stt
...
from codex_crew.transcribe import _ProfileCredentialResolver, _whisper_language, availability_detail
...
def _build_endpointer(
    ws: web.WebSocketResponse, cfg: "CodexCrewConfig", request: web.Request
) -> "_Endpointer | None":
...
def _apple_start_failure_code(cfg: "CodexCrewConfig") -> str:
