...
from codex_crew.acp.runtime import _get_rss_tree_mb, _iter_descendant_pids
from codex_crew.dashboard.handlers_system import _get_static_system_info
...
from codex_crew.subagent import _CLK_TCK, _subtree_cpu_jiffies
...
def _spend_for_session(
    ...
    if not isinstance(slot_key, str) or not slot_key:
        return None
    from codex_crew.dashboard.handlers.usage import spend_key_for_slot
...
class SessionMemorySampler:
    ...
    def _blocking_sample(self, rows: list[dict[str, object]]) -> dict[str, object]:
        ...
        from codex_crew.dashboard.handlers.usage import slot_spend
