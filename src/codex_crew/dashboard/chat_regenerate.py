...
from codex_crew.dashboard.chat_persistence import _save_slot_to_history, save_slot_off_loop
...
async def api_chat_slot_edit_resend(request: web.Request) -> web.Response:
    ...
    # ``import codex_crew.dashboard.chat_regenerate`` fail on its own. Same reason
