...
``codex_crew.dashboard.handlers.themes`` and import from here; this module must
...
# declaring a higher major is rejected with an honest "needs a newer CodexCrew"
...
def _validate_theme_dir(
    ...
    # for a newer CodexCrew gets the honest version message, not an opaque
    ...
    if fmt > _THEME_FORMAT_VERSION:
        return None, (
            f"this pack requires a newer version of Codex Crew "
