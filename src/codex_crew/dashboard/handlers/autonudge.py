...
from codex_crew.autonudge import is_structured_monitor_loop, structured_monitor_binding_key_for
...
from codex_crew.autonudge_authz import (  # noqa: F401 - re-exported
...
from codex_crew.session_ledger import ledger_key, render_snapshot
...
async def api_autonudge_start(request: web.Request) -> web.Response:
    ...
    if svc is None:
        return web.json_response(
            {
                "error": "auto-nudge disabled (CODEXCREW_AUTONUDGE not set)",
