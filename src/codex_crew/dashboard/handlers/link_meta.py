...
:mod:`codex_crew.link_unfurl`. This module owns the parts that need a loop: the
...
from codex_crew.link_unfurl import (
...
_USER_AGENT = "CodexCrew-LinkPreview/1"
...
async def link_meta_get(request: web.Request) -> web.Response:
    ...
    """
    # Offloaded: CodexCrewConfig.load() stats, reads and validates config files,
