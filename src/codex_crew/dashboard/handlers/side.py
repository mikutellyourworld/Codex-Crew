...
from codex_crew.dashboard.side_context import build_side_message
...
from codex_crew.security import StreamRedactor, redact
...
async def _run_side_turn(
    ...
    *,
    ...
    auth_required = False
    try:
        # Resolve the CodexCrew slot agent name (e.g. "default") to the real
        # kiro-cli agent (e.g. "codexcrew") before creating the session. Passing
        ...
        from codex_crew.dashboard.chat_runner import _mark_kiro_signed_out
