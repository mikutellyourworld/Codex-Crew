...
from codex_crew.config.loader import CodexCrewConfig, config_dir, config_path  # noqa: F401
from codex_crew.dashboard.handlers_system import (  # noqa: F401
...
from codex_crew.dashboard.origin import is_loopback  # noqa: F401
from codex_crew.platform_compat import is_link_or_junction
from codex_crew.security import (  # noqa: F401
    is_sensitive_path,
    redact_credentials,
    redact_exfiltration_urls,
)
from codex_crew.session import _sync_kill_provider  # noqa: F401


def sel():
    """Dynamic sel() that always resolves from codex_crew.sel for test patching."""
    from codex_crew.sel import sel as _s
...
from codex_crew.dashboard.cron_inject import inject_cron_result_to_dashboard  # noqa: E402, F401

# ── Memory (extracted to handlers/memory.py) ──
from codex_crew.dashboard.handlers._shared import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.agents import (  # noqa: E402, F401
    _find_agent_config,
    _get_config_lock,
    ...
    api_default_agent,
    api_effort_levels,
    api_codexcrew_agent_avatar_get,
    api_codexcrew_agent_avatar_upload,
    api_codexcrew_agent_delete,
    api_codexcrew_agent_resolved_model,
    api_codexcrew_agent_update,
    api_codexcrew_agents,
    api_codexcrew_agents_create,
    api_codexcrew_agents_sync,
    api_models,
    api_slash_commands,
)

# ── Connections OAuth relay (handlers/connections.py) ──
from codex_crew.dashboard.handlers.connections import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.cron import (  # noqa: E402, F401
    api_cron_ack,
...
from codex_crew.dashboard.handlers.diagnostics import (  # noqa: E402, F401
    api_diagnostics_collect,
    api_diagnostics_download,
)

# ── Files & Workspaces (extracted to handlers/files.py) ──
from codex_crew.dashboard.handlers.files import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.hooks import (  # noqa: E402, F401
    _get_hook_store,
    _load_hook_context,
    _run_hook_agent,
    _run_hook_inner,
...
from codex_crew.dashboard.handlers.kiro_prerequisite import (  # noqa: E402, F401
    api_kiro_prerequisite_repair_specs,
    api_kiro_prerequisite_status,
    api_kiro_prerequisite_update_cli,
)
from codex_crew.dashboard.handlers.mcp import (  # noqa: E402, F401
    _bg_mcp_probe,
    _sync_mcp_to_agent,
    api_mcp_active,
    api_mcp_apply,
...
from codex_crew.dashboard.handlers.mcp_apps import (  # noqa: E402, F401
    api_mcp_apps_call,
)

# ── Crew Members (handlers/members.py) ──
from codex_crew.dashboard.handlers.members import (  # noqa: E402, F401
    api_member_activity,
...
from codex_crew.dashboard.handlers.memory import (  # noqa: E402, F401
    _get_vector_store,
...
from codex_crew.dashboard.handlers.messaging import (  # noqa: E402, F401
    _redact,
...
from codex_crew.dashboard.handlers.prompts import (  # noqa: E402, F401
    MAX_PROMPT_BYTES,
...
from codex_crew.dashboard.handlers.session_ledger import (  # noqa: E402, F401
    api_session_ledger_get,
    api_session_ledger_record,
)

# ── Sessions (extracted to handlers/sessions.py) ──
from codex_crew.dashboard.handlers.session_storage import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.sessions import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.side import (  # noqa: E402, F401
    api_side_close,
    api_side_open,
...
from codex_crew.dashboard.handlers.skill_budget import (  # noqa: E402, F401
    api_skills_budget,
)
from codex_crew.dashboard.handlers.sso_login import (  # noqa: E402, F401
    api_sso_login_ws,
)
from codex_crew.dashboard.handlers.steering import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.tailnet import (  # noqa: E402, F401
    api_tailnet_status,
)
from codex_crew.dashboard.handlers.tailnet_mobile import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.taskrunner import (  # noqa: E402, F401
    _run_refine,
...
from codex_crew.dashboard.handlers.telemetry import (  # noqa: E402, F401
    api_beacon_status,
...
from codex_crew.dashboard.handlers.terminal import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.themes import (  # noqa: E402, F401
    api_theme_asset,
    api_theme_detail,
    api_theme_overlay,
    api_theme_topbar,
...
from codex_crew.dashboard.handlers.updates import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.usage import (  # noqa: E402, F401
    api_kiro_usage,
    api_usage,
)

# ── Themes: validation/parsing core (extracted to theme_validate.py) ──
from codex_crew.dashboard.theme_validate import (  # noqa: E402, F401
...
def _list_aim_prompts(project_dir: Path | None = None) -> list[dict[str, Any]]:
    ...
    process-wide ``CODEXCREW_PROJECT_DIR`` is neither of them. Resolving in the
...
# alongside the ``codexcrew aws-consent`` CLI.
from codex_crew.dashboard.handlers.aws_consent import (  # noqa: E402, F401
...
# loopback legs: ``invoke`` (the ``codexcrew-computer`` MCP shim's forward) and
# ``frame`` (the live-view PiP mirror of an already-captured screenshot).
from codex_crew.dashboard.handlers.computer_use import (  # noqa: E402, F401
...
from codex_crew.dashboard.handlers.core import (  # noqa: E402, F401
    _DIST_DIR,
    _STATIC_DIR,
    ...
    api_branding,
    api_health,
    api_codexcrew_config,
    api_codexcrew_config_patch,
    api_live,
    api_logout,
    api_ready,
...
from codex_crew.dashboard.handlers.file_delivery_consent import (  # noqa: E402, F401
    api_file_delivery_consent_delete,
    api_file_delivery_consent_get,
    api_file_delivery_consent_post,
)

# One-shot OpenAI-compatible model consultation. The gateway owns the endpoint,
# model and API key (one encrypted vault record); the MCP shim only ever sends a
# prompt and receives redacted text, so no pooled subprocess sees the credential.
from codex_crew.dashboard.handlers.model_consult import (  # noqa: E402, F401
    api_model_consult,
)
from codex_crew.dashboard.handlers.notifications_push import (  # noqa: E402, F401
    api_push_notification,
)
from codex_crew.dashboard.handlers.onboarding_import import (  # noqa: E402, F401
    api_onboarding_import_apply,
    api_onboarding_import_scan,
    api_onboarding_import_state,
)
from codex_crew.dashboard.handlers.optimizer import (  # noqa: E402, F401
    handle_optimize,
)

# ── Portability (export/import as zip) ──
from codex_crew.dashboard.handlers.portability import (  # noqa: E402, F401
    api_portability_export,
    api_portability_import,
    api_portability_preview,
)
from codex_crew.dashboard.handlers.security import (  # noqa: E402, F401
