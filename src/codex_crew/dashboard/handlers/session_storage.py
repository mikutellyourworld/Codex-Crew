...
stores underneath (see :mod:`codex_crew.session_storage`), but that is an
...
from codex_crew.session_digest import digest
from codex_crew.session_map import SESSION_MAP_FILENAME, SessionMap
from codex_crew.session_storage import (
    BUCKET_DAYS,
...
def _build_index(state: DashboardState | None = None) -> SessionIndex:
    ...
    Stems come from :func:`codex_crew.history.transcript_stems`, which returns both
