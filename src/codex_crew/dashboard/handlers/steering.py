...
* ``~/.kiro/steering/**/*.md`` — **global** (``user`` source).  kiro-cli loads
  ...
  (:func:`codex_crew.context._load_steering_resources`) globs the agent
...
base (:func:`codex_crew.context.steering_target_admissible`: ``$HOME`` for
...
from codex_crew.context import steering_target_admissible
from codex_crew.dashboard.state import DashboardState
from codex_crew.executors import discovery_executor
from codex_crew.frontmatter import STEERING_LOADER, set_frontmatter_fields, split_frontmatter
...
# declaration is the harness's own business, documented upstream. Codex Crew
...
def _sel():
    ...
    import codex_crew.dashboard.handlers as _pkg  # circular import
