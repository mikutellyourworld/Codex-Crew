"""Lightweight web dashboard — status page at ``localhost:5486``.
...
# first attribute access; ``from codex_crew.dashboard import <submodule>``
...
if TYPE_CHECKING:  # names for static type checkers only
    from codex_crew.dashboard.server import start_api_server, start_dashboard
    from codex_crew.dashboard.state import DashboardState, _ChatSlot, _fmt_duration
