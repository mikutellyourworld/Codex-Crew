...
:mod:`codex_crew.session_summary` before the model sees them; the rest are
...
async def generate_session_summary(
    ...
    *,
    ...
    if log is None:
        return False
    # Off-loop: CodexCrewConfig.load() stats and reads config files, and this
