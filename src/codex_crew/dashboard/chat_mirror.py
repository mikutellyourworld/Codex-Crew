...
from codex_crew.dashboard.chat_runner import _resolve_channel_target, _resolve_mirror_target
from codex_crew.dashboard.chat_slack import list_slack_channels
...
async def api_chat_slot_mirror_link(request: web.Request) -> web.Response:
    ...
    def _units_for(row: dict) -> list[str]:
        ...
        speaker = "You" if row.get("role") == "user" else "Codex Crew"
