...
def register(app: web.Application) -> None:
    ...
    # Codex Crew Agent CRUD
    app.router.add_get("/api/agents", handlers.api_codexcrew_agents)
    app.router.add_get("/api/agents/resolved-model", handlers.api_codexcrew_agent_resolved_model)
    app.router.add_post("/api/agents", handlers.api_codexcrew_agents_create)
    app.router.add_post("/api/agents/sync", handlers.api_codexcrew_agents_sync)
    app.router.add_put("/api/agents/{name}", handlers.api_codexcrew_agent_update)
    app.router.add_delete("/api/agents/{name}", handlers.api_codexcrew_agent_delete)
    ...
    app.router.add_get("/api/agents/{name}/avatar", handlers.api_codexcrew_agent_avatar_get)
    app.router.add_post("/api/agents/{name}/avatar", handlers.api_codexcrew_agent_avatar_upload)
