"""Dynamic workflows for Codex Crew — the FROZEN CONTRACT.
...
ports native to Codex Crew are all written against this contract — several of them
...
class WorkflowContext(Protocol):
    ...
    # --- ports native to Codex Crew; None when not permitted for this run ---
