...
This module reuses the generic, already-tested :class:`codex_crew.acp.worker_pool.WorkerPool`
...
from codex_crew.workflows.agent_exec import _MAX_TURNS_PER_STEP
...
class _WorkflowSessionWorker:
    ...
    Implements the :class:`codex_crew.acp.worker_pool.PoolWorker` protocol. One
