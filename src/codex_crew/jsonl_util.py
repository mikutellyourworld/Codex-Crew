...
stated on :func:`codex_crew.snapshot._merge_notifications`.

:func:`codex_crew.session_storage._manifest_records` is a third reader and
...
def bounded_raw_records(
    ...
    *handle* is BINARY so the cap is a memory bound rather than a code-point
    ...
    :func:`codex_crew.session_storage._manifest_records`, whose caller needs the
    splitlines shape.
