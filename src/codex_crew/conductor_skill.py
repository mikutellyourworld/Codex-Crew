...
Loaded into the default codexcrew agent so delegation is transparent. The crew
...
You (codexcrew) are the default crew and handle most tasks directly. Delegate only
