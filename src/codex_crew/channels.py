...
from codex_crew.discord.gateway import maybe_start_discord
from codex_crew.feishu.gateway import maybe_start_feishu
from codex_crew.imessage.gateway import maybe_start_imessage
from codex_crew.messaging.registry import ChannelDescriptor
from codex_crew.teams.gateway import maybe_start_teams
from codex_crew.telegram.gateway import maybe_start_telegram
from codex_crew.webex.gateway import maybe_start_webex
from codex_crew.wecom.gateway import maybe_start_wecom
from codex_crew.weixin.gateway import maybe_start_weixin
from codex_crew.whatsapp.gateway import maybe_start_whatsapp
...
def channel_readiness(cfg: object, creds: Mapping[str, str]) -> tuple[ChannelReadiness, ...]:
    ...
    ``cfg`` is a :class:`~codex_crew.config.loader.CodexCrewConfig`; each channel's
