...
from codex_crew.trust_patterns import extract_bash_command
...
# "codexcrew-core___send_message" (kiro-cli) and
# "mcp__codexcrew-core__send_message" (canonical MCP prefix form).
