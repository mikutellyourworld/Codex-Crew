...
# must exclude them, or Codex Crew warns the user about a key it wrote itself.
...
# CodexCrewConfig._extra_sections and re-emitted by to_dict() so an
...
#: Marker used in :attr:`CodexCrewConfig.degraded_sections` for "a whole config
