"""Schema registry for CodexCrew configuration.
...
def build_json_schema(root_cls: type) -> dict:
    ...
    # (CodexCrewConfig itself doesn't have field metadata since it's the root)
    return schema
...
JSON_SCHEMA: dict = build_json_schema(CodexCrewConfig)
