#!/usr/bin/env python3
"""Detach a per-app backend from the shared CodexCrew CloudFront distribution.
...
def aws(profile, region, *args):
    ...
    # codex_crew wasn't importable is exactly the environment an attacker would
    ...
    # bare python3 without codex_crew on sys.path.
    try:
