...
Security boundary (mirrors ``codex_crew.metrics.profile_install``, the
...
from codex_crew.constants import AWS_PROFILE_NAME_RE
...
# pods/tests with CODEXCREW_HOME override isolate correctly.
...
def create_aws_profile(name: str, region: str, *, account: str = "",
    ...
    if account and role:
        ...
        script = (
            ...
            '"--role-session-name","codexcrew-deploy",'
