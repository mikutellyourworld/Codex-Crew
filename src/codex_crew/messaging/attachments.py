...
IMAGE        a local path the ACP prompt path inlines as an image block
             (see :mod:`codex_crew.acp.prompt_blocks`)
TEXT         redacted, truncated text inlined into the prompt
DOCUMENT     text extracted via :mod:`codex_crew.doc_parser`, then as TEXT
...
from codex_crew.doc_parser import extract_text, is_parseable_document
...
#: Raster types that :func:`codex_crew.acp.prompt_blocks.build_prompt_blocks` can
