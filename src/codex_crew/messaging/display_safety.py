...
Slack first and hoisted here when :func:`codex_crew.messaging.renderer.
...
``codex_crew.security``, so it stays importable from anywhere and each caller
...
from codex_crew.preview_text import drop_format_chars
...
def _strip_format_chars(text: str) -> str:
    ...
    Delegates to :func:`codex_crew.preview_text.drop_format_chars`, the one
