...
(:mod:`codex_crew.messaging.attachments`) sniffs a downloaded temp file, and
outbound extraction (:mod:`codex_crew.messaging.outbound_files`) sniffs a local
...
Deliberately dependency-free: it imports nothing from ``codex_crew``, so either
