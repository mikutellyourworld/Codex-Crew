...
# ``codex_crew.constants``, which is their canonical home, because the roster has
...
from codex_crew.constants import CHANNEL_SESSION_NAMESPACES, SLACK_NAMESPACE
...
def is_channel_session_key(key: str) -> bool:
    ...
    of their own. Unlike :func:`codex_crew.autonudge.is_channel_key` (which
