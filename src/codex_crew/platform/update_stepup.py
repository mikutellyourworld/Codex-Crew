...
* **Approve** (only the host can do this): ``codexcrew update approve`` reads
...
from codex_crew.platform_compat import make_owner_only_dir
...
def public_view(pending: PendingUpdate) -> dict[str, object]:
    ...
    return {
        ...
        "approve_command": "codexcrew update approve",
    }
