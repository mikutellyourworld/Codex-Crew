...
# to live under src/codex_crew/. The normal scan never reads this directory
...
def clear_text_credential_dump(fh, password, key, secret, url):
    # ruleid: codexcrew.clear-text-credential-dump
    ...
    # ok: codexcrew.clear-text-credential-dump
