...
from codex_crew.apps.builtins.mochi.activity_budget import (
    DEFAULT_TIER,
    TIER_UNLIMITED,
    TIERS,
    ActivityBudget,
...
class TestFloorAndModel:
    ...
    def test_floor_defers_recently_checked_items_but_never_drops(self, tmp_path, monkeypatch):
        ...
        from codex_crew.apps.builtins.mochi.settings import save_settings
...
class TestSeparationOfAxes:
    ...
    def test_budget_module_never_reads_mode(self):
        ...
        from codex_crew.apps.builtins.mochi import activity_budget
...
class TestPollerBudgetPlumbing:
    def test_none_budget_uses_vendored_constants(self):
        ...
        from codex_crew.apps.builtins.mochi import queue_poller as qp
