...
from codex_crew.dashboard.chat_utils import _history_key_for, _prepare_messages
...
def test_stage_result_capture_redacts_before_writing_to_disk(tmp_path, monkeypatch) -> None:
    ...
    from codex_crew.dashboard.chat_orchestrator import _capture_stage_result
    from codex_crew.dashboard.state import _ChatSlot
...
def test_oauth_completion_redacts_restored_meta_before_broadcast() -> None:
    ...
    """
    from codex_crew.dashboard.chat_runner import _mark_mcp_oauth_completed
    from codex_crew.dashboard.state import _ChatSlot
...
def test_oauth_url_gate_still_blocks_a_tampered_url() -> None:
    ...
    from codex_crew.dashboard.chat_utils import _redact_meta_for_role
...
def test_oauth_completion_preserves_a_legitimate_url() -> None:
    ...
    legit = (
        ...
        "&redirect_uri=http%3A%2F%2Flocalhost%3A5486%2Fcallback&response_type=code"
