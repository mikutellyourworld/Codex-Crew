...
from codex_crew.computer_use import index as index_mod
from codex_crew.computer_use import render
from codex_crew.computer_use.index import SnapshotIndex, drift_message
...
class TestRendering:
    ...
    def test_app_list_rendering(self, fake):
        ...
        assert "dev.codexcrew.fake.files" in text
...
class TestScreenshotSpoolNamesAreUnique:
    ...
    def _service(self, tmp_path, monkeypatch):
        from codex_crew.computer_use import service as service_mod
...
class TestTheCeilingRoundTripIsLossless:
    ...
    def test_every_ElementRec_field_survives_the_payload_round_trip(self):
        ...
        from codex_crew.computer_use.tools import _element_from_payload, _element_payload
    ...
    def test_a_malformed_frame_becomes_None_not_a_bogus_rect(self):
        ...
        """
        from codex_crew.computer_use.tools import _element_from_payload
...
class TestASuppressedScreenshotAlwaysSaysSoWhy:
    ...
    def test_the_note_appears_and_disappears_through_the_REAL_dispatch_path(
        ...
        # ``~/.codex-crew`` must never decide this test's outcome.
