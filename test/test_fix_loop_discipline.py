...
class TestPatternHarvest:
    ...
    def test_semgrep_owns_the_sentinel_rule_with_fixtures(self) -> None:
        ...
        assert "codexcrew.find-sentinel-in-boolean-context" in rule
        fixture = SEMGREP_FIXTURE.read_text(encoding="utf-8")
        assert "# ruleid: codexcrew.find-sentinel-in-boolean-context" in fixture
        assert "# ok: codexcrew.find-sentinel-in-boolean-context" in fixture
