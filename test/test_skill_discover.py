...
def _make_app(state, provider):
    from codex_crew.dashboard.handlers import discover as discover_mod
    from codex_crew.skill_providers.base import ProviderRegistry
...
class TestDiscoverSearch:
    async def test_search_includes_installs(self, fake_home, reset_registry):
        from codex_crew.skill_providers.base import SkillSearchResult
...
class TestDiscoverInstallLogSanitization:
    ...
    _LOGGER = "codex_crew.dashboard.handlers.discover"
