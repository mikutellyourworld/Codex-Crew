"""Tests for codex_crew.webex.cards — Adaptive Cards, Webex's Block Kit analogue.
...
from codex_crew.webex.cards import (
    CARD_CONTENT_TYPE,
    CARD_VERSION,
    KEY_CHOICE,
    KEY_KIND,
...
from codex_crew.webex.renderer import _safe_tool_label
...
class TestReadPress:
    ...
    def test_the_reserved_keys_are_namespaced(self) -> None:
        ...
        for key in (KEY_KIND, KEY_CHOICE, KEY_NONCE, KEY_REQUEST):
            assert key.startswith("codexcrew_")
