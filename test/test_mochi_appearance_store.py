...
class TestStagedOverwriteAcrossEveryWriter:
    ...
    def test_a_failed_editor_save_leaves_the_existing_pack_intact(
        ...
        import codex_crew.apps.builtins.mochi.appearance_store as store
...
class TestBundleRoundTrip:
    ...
    def test_import_then_export_round_trips(self, tmp_path) -> None:
        from codex_crew.apps.builtins.mochi.appearance_store import export_pack, import_bundle
    ...
    def test_path_traversal_entry_is_refused(self, tmp_path) -> None:
        from codex_crew.apps.builtins.mochi.appearance_store import PackError, import_bundle
    ...
    def test_export_of_a_missing_pack_raises(self, tmp_path) -> None:
        from codex_crew.apps.builtins.mochi.appearance_store import PackError, export_pack
...
class TestSavePackFromContent:
    ...
    def test_a_traversal_mood_slot_is_refused(self, tmp_path) -> None:
        ...
        from codex_crew.apps.builtins.mochi.appearance_store import PackError, save_pack
    ...
    def test_identical_content_is_written_once_and_shared(self, tmp_path) -> None:
        from codex_crew.apps.builtins.mochi.appearance_store import get_pack_detail, save_pack
