...
from codex_crew.safety_override import approval_mode_permitted
...
class TestNonDeniableHoldsAtRuntimeNotJustParseTime:
    ...
    def test_a_governance_evaluation_error_cannot_deny_a_non_deniable_mode(self, monkeypatch):
        import codex_crew.platform.governance_profiles as gp_mod
    ...
    def test_the_predicate_reads_the_catalog_rather_than_a_hardcoded_list(self):
        ...
        from codex_crew.platform.governance import SCOPE_CATALOG
        from codex_crew.safety_override import _non_deniable_approval_modes
