...
from codex_crew.workflows import store as workflow_store
from codex_crew.workflows.library import WorkflowDefinitionLibrary
from codex_crew.workflows.store import WORKFLOW_LIBRARY_DIR_NAME
...
class TestWorkflowLibraryProtection:
    ...
    def test_shell_reads_writes_and_extracts_are_blocked(self) -> None:
        commands = (
            "cat ~/.codex-crew/workflow_library/wfd_example.json",
            "echo '{}' > ~/.codex-crew/workflow_library/wfd_example.json",
            "tar -xf planted.tar -C ~/.codex-crew/workflow_library",
        )
