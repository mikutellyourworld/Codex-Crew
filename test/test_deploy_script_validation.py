...
class TestAwsSpawnFlow:
    ...
    ``codex_crew.sandbox`` (the fail-closed import), so the patch point is the
    ...
    def _patch(self, monkeypatch, profile_file, run):
        import codex_crew.sandbox as sandbox
...
class TestAwsHelperResolvesAbsolutely:
    ...
    def test_cmd_head_absolute_under_minimal_path(self, mod, monkeypatch, tmp_path):
        from codex_crew import github_runner, sandbox
        ...
        # The helper imports these lazily from codex_crew.sandbox at call time,
