...
import codex_crew.whatsapp.gateway as gw
from codex_crew.messaging.driver import APPROVAL_AUTO, APPROVAL_INTERACTIVE
from codex_crew.whatsapp.gateway import (
...
def _cfg(**wa):
    ...
    agent = SimpleNamespace(default_agent="codexcrew", approval_mode="auto")
...
def test_check_names_only_the_unmatched_groups_in_one_warning(caplog):
    ...
    with caplog.at_level(logging.DEBUG, logger="codex_crew.whatsapp.gateway"):
