...
2. **Delegation to something holding a shell.** ``@codexcrew-core`` carries
...
ESCALATION_ROUTES = {
    ...
    "@codexcrew-core": "spawn_run can bind an agent template that has execute_bash",
...
def test_escalation_routes_name_tools_that_really_exist() -> None:
    ...
    mochi = ROOT / "src/codex_crew/apps/builtins/mochi/agents/mochi.json"
    ...
    assert "@codexcrew-core" in mochi_tools
