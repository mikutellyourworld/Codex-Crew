...
``src/codex_crew/apps/builtins/...`` is never collected by CI.
...
from codex_crew.apps.builtins.meetings.backend import constants as k
from codex_crew.apps.builtins.meetings.backend import store
from codex_crew.apps.builtins.meetings.backend.domain import session as sess
from codex_crew.apps.builtins.meetings.backend.routes import _common
...
class TestMeetingLifecycleRoutes:
    ...
    async def test_delete_waits_for_in_flight_initialization(
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import meeting_lifecycle
    ...
    async def test_delete_waits_for_in_flight_agent_toggle(
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import agents, meeting_lifecycle
    ...
    async def test_task_mutation_cannot_resurrect_a_deleted_meeting(
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import tasks as task_routes
...
class TestAgentRoutes:
    ...
    async def test_stop_waits_for_an_in_flight_transcript_append(
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import (
            agents,
            meeting_lifecycle,
        )
...
class TestTaskRoutes:
    ...
    async def test_file_task_provider_failure_is_502(self, app, root: Path, monkeypatch):
        from codex_crew.apps.builtins.meetings.backend.providers import tasks as taskprov
        ...
        monkeypatch.setattr(
            "codex_crew.apps.builtins.meetings.backend.routes.tasks."
...
class TestAgentAndPresetSanitizers:
    ...
    @staticmethod
    def _mod():
        from codex_crew.apps.builtins.meetings.backend.routes import settings as mod
...
class TestOutputsPollIsRedactedAndOffLoop:
    ...
    def test_the_handler_reads_off_the_event_loop(self):
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import meeting_lifecycle as ml
...
class TestNoStoreCallRunsOnTheEventLoop:
    ...
    def _route_modules(self) -> list:
        from codex_crew.apps.builtins.meetings.backend import calendar_poller, calendar_sync
        from codex_crew.apps.builtins.meetings.backend.routes import (
            agents,
            calendar,
            meeting_lifecycle,
    ...
    def test_every_read_modify_write_handler_uses_one_thread_hop(self):
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import agents as ag
        from codex_crew.apps.builtins.meetings.backend.routes import meeting_lifecycle as ml
        from codex_crew.apps.builtins.meetings.backend.routes import settings as st
        from codex_crew.apps.builtins.meetings.backend.routes import tasks as tk
    ...
    def test_each_grouped_helper_is_documented_as_blocking(self):
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import agents as ag
        from codex_crew.apps.builtins.meetings.backend.routes import calendar as cl
        from codex_crew.apps.builtins.meetings.backend.routes import meeting_lifecycle as ml
        from codex_crew.apps.builtins.meetings.backend.routes import settings as st
        from codex_crew.apps.builtins.meetings.backend.routes import tasks as tk
...
class TestTaskWritesAreSerialized:
    ...
    def test_duplicate_agent_written_task_ids_are_made_unique(self, root: Path) -> None:
        ...
        """
        from codex_crew.apps.builtins.meetings.backend import store as meetings_store
        from codex_crew.apps.builtins.meetings.backend.routes import tasks as task_routes
    ...
    def test_every_metadata_writer_holds_the_transaction(self) -> None:
        ...
        import codex_crew.apps.builtins.meetings.backend as backend_pkg
    ...
    def test_concurrent_metadata_updates_all_survive(self, root: Path) -> None:
        ...
        from codex_crew.apps.builtins.meetings.backend import store as meetings_store
        from codex_crew.apps.builtins.meetings.backend.routes import agents as agent_routes
        from codex_crew.apps.builtins.meetings.backend.routes import meeting_lifecycle as lifecycle
    ...
    def test_concurrent_dictionary_edits_all_survive(self, root: Path) -> None:
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import settings as settings_routes
...
class TestTeardownDrainsBeforeClearing:
    ...
    async def test_set_warns_rather_than_silently_dropping_a_queue(self, caplog) -> None:
        ...
        with caplog.at_level(logging.WARNING, logger="codexcrew.app.meetings"):
            active.set(None)
    ...
    async def test_no_teardown_path_still_uses_the_lossy_clear(self) -> None:
        ...
        routes_init = importlib.import_module(
            "codex_crew.apps.builtins.meetings.backend.routes"
        )
...
class TestTeardownLeavesNoMeetingFalselyActive:
    ...
    async def test_gateway_shutdown_marks_the_live_meeting_ended(
        ...
        from codex_crew.apps.builtins.meetings.backend import routes as routes_pkg
    ...
    def test_every_teardown_path_persists_a_terminal_status(self) -> None:
        ...
        from codex_crew.apps.builtins.meetings.backend.routes import agents as agents_routes
        from codex_crew.apps.builtins.meetings.backend.routes import (
            meeting_lifecycle,
        )

        routes_init = importlib.import_module("codex_crew.apps.builtins.meetings.backend.routes")
