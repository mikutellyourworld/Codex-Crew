...
from codex_crew.dashboard import boot_id, refresh_tokens, token_auth

_MOD = "codex_crew.dashboard.boot_id"
...
class TestBootId:
    ...
    def test_is_not_persisted_anywhere(self, tmp_path, monkeypatch) -> None:
        ...
        """
        monkeypatch.setattr("codex_crew.config.loader.config_dir", lambda: tmp_path, raising=False)
