"""Tests for :mod:`codex_crew.agent_scratch` (issue #5063).
...
from codex_crew import agent_scratch as sc
...
class TestEnv:
    def test_exports_temp_triple_and_scratch_alias(self, tmp_path: Path) -> None:
        ...
        value = str(tmp_path)
        assert env == {"TMPDIR": value, "TMP": value, "TEMP": value, "CODEXCREW_SCRATCH": value}
