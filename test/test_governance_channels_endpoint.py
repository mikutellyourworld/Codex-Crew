...
class TestPolicyDenies:
    ...
    def test_eval_error_is_null_not_denied(self, monkeypatch):
        ...
        from codex_crew.platform.governance_profiles import GOVERNANCE_ERROR_REASON
        ...
        monkeypatch.setattr("codex_crew.platform.governance_profiles.governance_permits", _degraded)
        result = handlers_system._collect_channel_governance()
...
class TestSessionKey:
    def test_uses_host_session_key(self, monkeypatch):
        ...
        monkeypatch.setattr("codex_crew.platform.governance_profiles.governance_permits", _spy)
