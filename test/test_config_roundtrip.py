"""Tests that CodexCrewConfig.save() preserves all dataclass fields.
...
def test_to_dict_includes_all_dataclass_fields():
    """Every public field on CodexCrewConfig must appear in to_dict() output."""
    cfg = CodexCrewConfig()
    d = cfg.to_dict()
    ...
    for f in fields(CodexCrewConfig):
