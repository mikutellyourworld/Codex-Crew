...
from codex_crew.taskrunner import Step, StepStatus, TaskRun, TaskRunner
...
class TestGitWorkspaceIdentitySurvivesRestart:
    ...
    def _git_run(self, task_id: str = "g1") -> TaskRun:
        ...
        run.work_dir = "/repos/proj/../.codexcrew-work/g1"
        run.branch_name = "codexcrew/task/g1"
        run.base_branch = "main"
        run.worktree_path = "/repos/.codexcrew-work/g1"
    ...
    def test_every_git_field_round_trips(self, tmp_path: Path) -> None:
        ...
        assert back.branch_name == "codexcrew/task/g1"
        assert back.base_branch == "main"
        assert back.worktree_path == "/repos/.codexcrew-work/g1"
...
class TestAsyncMutationPersistence:
    def test_update_plan_offloads_atomic_write(self, tmp_path: Path, monkeypatch) -> None:
        ...
        monkeypatch.setattr("codex_crew.taskrunner.atomic_write", record_write)
