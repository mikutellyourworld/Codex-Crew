...
from codex_crew.discord import client as dc
...
class TestInvalidRequestBreaker:
    ...
    async def test_it_closes_after_the_cool_off_and_starts_clean(
        ...
        with caplog.at_level(logging.INFO, logger="codex_crew.discord.client"):
...
class TestRouteKeyCarriesNoCredential:
    ...
    ring, where the operator's own ``codexcrew logs`` would then hand it out.
    """
