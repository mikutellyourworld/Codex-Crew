...
from codex_crew.apps import manager, registry
...
class TestProvenanceCapture:
    ...
    def signing_home(self, tmp_path, monkeypatch) -> Path:
        """An explicitly-isolated CODEXCREW_HOME, so writing an admission policy
        below can never reach the developer's real ``~/.codex-crew``."""
