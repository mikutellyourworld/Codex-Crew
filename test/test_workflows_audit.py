...
``codex_crew.sel``. Audit failures must never break a run.
...
from codex_crew.workflows.runner import WorkflowRunner, _result_hash
...
async def test_audit_failure_never_breaks_run() -> None:
    ...
    from codex_crew.workflows.runner import _default_audit
