...
class TestFindDrive:
    ...
    def test_single_match_is_returned(self):
        name = "codexcrew-drive-0123456789ab"
    ...
    def test_both_discovery_tags_are_anded_in_the_filter(self):
        # Discovery is a trust decision: BOTH codexcrew:managed=true AND
        # codexcrew:drive=default must be required, or a bucket carrying only one
...
class TestCreateDrive:
    ...
    def test_a_bucket_in_an_unconfirmed_account_never_becomes_a_drive(self):
        ...
        assert "codexcrew-drive-" in str(exc.value)
