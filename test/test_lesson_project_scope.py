...
from codex_crew.vector_memory import _lesson_display_text, _lesson_scope, _lesson_slug
...
class TestProjectScopeSatisfied:
    ...
    def test_the_schema_refuses_a_scope_the_gate_cannot_satisfy(self):
        ...
        from codex_crew.validation import LEARN_ADD_SCHEMA, ValidationError, validate_tool_args
    ...
    def test_a_symlink_into_a_sensitive_tree_is_refused(self, tmp_path, monkeypatch):
        ...
        from codex_crew import project_scope as ps
...
class TestVectorStoreLessonScope:
    ...
    def test_a_stale_client_legacy_scope_is_refused_not_globalised(self):
        ...
        # it replaced.
        from codex_crew.mcp_tools import learn as mcp_learn
