...
def test_synthetic_recovery_messages_carry_a_known_marker() -> None:
    ...
    """
    from codex_crew.dashboard.chat_utils import _SYNTHETIC_RECOVERY_MSGS
