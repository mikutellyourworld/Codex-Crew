...
from codex_crew.apps.builtins.workflows.server import (
    handle_examples,
    handle_run,
    handle_validate,
)
from codex_crew.apps.manifest import AppManifest
from codex_crew.workflows.runner import WorkflowRunner
...
# A planted AWS access key id (matches codex_crew.security._CREDENTIAL_PATTERNS)
...
def test_redact_obj_scrubs_credentials_and_exfil_urls_in_run_payload() -> None:
    from codex_crew.apps.builtins.workflows.server import _redact_obj
...
def test_handler_send_redacts_before_writing_to_the_wire() -> None:
    ...
    from codex_crew.apps.builtins.workflows.server import _Handler
