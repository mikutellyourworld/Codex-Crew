...
from codex_crew.dashboard.handlers._shared import admits_registry as _admits
from codex_crew.platform import context as ctx_mod
from codex_crew.platform.bootstrap import build_default_context
from codex_crew.platform.defaults import DefaultExternalAccessPolicy


def _base_context():
    return build_default_context(CodexCrewConfig())
...
def _reset_registries():
    ...
    from codex_crew.dashboard.handlers import discover, mcp_discover
...
class TestSkillProviderGating:
    def test_denied_provider_is_not_registered(self, monkeypatch, _reset_registries):
        from codex_crew.dashboard.handlers import discover
...
class TestCloudDeploymentGating:
    ...
    def test_config_reports_the_disabled_state(self, monkeypatch):
        ...
        from codex_crew.deploy import handlers as dh
