...
from codex_crew.embeddings import PRIORITY_BULK, PRIORITY_NORMAL
...
class TestInProcessEmbedder:
    ...
    def test_embed_for_item_bounds_pathological_blob(self, monkeypatch):
        ...
        from codex_crew.knowledge.embedder import _EMBED_CONTENT_BUDGET
    ...
    def _capture_warnings():
        ...
        from codex_crew.knowledge import embedder
...
class TestSearchForContext:
    ...
    def test_estimate_tokens(self):
        from codex_crew.dashboard.handlers.knowledge import _estimate_tokens

        assert _estimate_tokens("hello world") == 2  # 11 chars // 4
        assert _estimate_tokens("") == 0

    def test_knowledge_fetch_defaults(self):
        from codex_crew.dashboard.handlers.knowledge import (
    ...
    def test_context_card_carries_citation_fields(self):
        from codex_crew.dashboard.handlers.knowledge import _build_context_card
...
class TestRedactMeta:
    ...
    def test_redacts_strings(self):
        from codex_crew.dashboard.chat_utils import _redact_meta
