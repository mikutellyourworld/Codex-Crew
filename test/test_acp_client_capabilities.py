...
Locks in what CodexCrew declares during the ACP `initialize` handshake, and that
...
from codex_crew.acp.types import ACP_CLIENT_CAPABILITIES
...
def test_both_acp_transports_send_capabilities() -> None:
    ...
    agent subprocess.
    """
    for rel in ("src/codex_crew/acp/client.py", "src/codex_crew/acp/runtime.py"):
...
def test_both_acp_transports_send_client_info_name() -> None:
    ...
    "codexcrew"). AcpRuntime previously sent the flat key; this locks in the
