...
* :mod:`codex_crew.mcp_gateway.tool_surface` — the pure projection and the change
...
* :class:`~codex_crew.mcp_gateway.backend.Backend` — recording the tool set a
...
from codex_crew.mcp_gateway.tool_surface import (
    _MAX_NAME_LEN,
    _MAX_TOOLS,
    _is_control,
