...
class TestShortcuts:
    ...
    def test_defaults_match_the_shell(self, tmp_path: Path) -> None:
        ...
        from codex_crew.apps.builtins.mochi.settings import _default_shortcuts
...
class TestCrossPlatformAccelerators:
    ...
    def test_option_is_normalised_to_alt(self) -> None:
        from codex_crew.apps.builtins.mochi.settings import validate_accelerator
    ...
    def test_defaults_avoid_ctrl_shift_off_darwin(self, monkeypatch) -> None:
        from codex_crew.apps.builtins.mochi import settings as mod
