...
from codex_crew.dashboard.chat_nav import (
...
class TestApiEndpoint:
    ...
    async def test_invalid_json(self):
        ...
        from codex_crew.dashboard.chat_nav import api_chat_nav_resolve_links
    ...
    async def test_success(self, monkeypatch):
        ...
        from codex_crew.dashboard import chat_nav
        from codex_crew.dashboard.chat_nav import api_chat_nav_resolve_links
