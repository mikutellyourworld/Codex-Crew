...
from codex_crew.acp.types import AcpEvent as LLMEvent
from codex_crew.eval.runner import (
    EvalRunner,
    ScenarioResult,
    SessionResult,
    TurnResult,
...
from codex_crew.eval.scenario import (
    Assertion,
    AssertionType,
    Scenario,
    SeedProfile,
...
# with lazy imports of SessionManager/CodexCrewConfig. The tests exercise the full
...
class TestConsolidationFailure:
    ...
    async def test_consolidation_failure_tracked(self):
        ...
        with patch(
            "codex_crew.history.HistoryConsolidator._consolidate",
