...
from codex_crew import credential_patterns as cp
...
class TestImportFreeShape:
    ...
    def test_fresh_import_pulls_in_no_module(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        mod_name = "codex_crew.credential_patterns"
        monkeypatch.setattr(codex_crew, "credential_patterns", sys.modules[mod_name])
...
class TestSharedSpellings:
    ...
    def test_redaction_floor_compiles_the_shared_spellings(self) -> None:
        ...
        from codex_crew.log_redaction import _AWS_KEY_ID_RE, _JWT_RE
    ...
    def test_no_module_spells_the_prefix_group_by_hand(self) -> None:
        """No module under ``src/codex_crew`` writes the prefix group as a literal.
    ...
    def test_siblings_read_their_spelling_from_the_home(self) -> None:
        ...
        from codex_crew import sel
        from codex_crew.apps.builtins.pptx_maker.backend import routes as pptx_routes
        from codex_crew.metrics import schema as metrics_schema
