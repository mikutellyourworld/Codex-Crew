"""Tests for codex_crew.apps.manifest — AppManifest parser and validator."""
...
class TestValidation:
    ...
    def test_literal_route_segment_name_rejected(self, name):
        ...
        from codex_crew.apps.manifest import app_name_error, is_reserved_app_name
    ...
    def test_device_stem_vocabulary_is_not_duplicated(self):
        ...
        from codex_crew.apps.manifest import UNPORTABLE_APP_NAMES
    ...
    def test_module_style_entrypoint_ok(self):
        ...
        m = AppManifest.from_dict(
            _valid_manifest(backend={"entryPoint": "codex_crew.apps.builtins.x.server"})
        )
        assert m.validate() == []
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "codex_crew.apps.builtins.x.server",  # dotted module-style
...
class TestDependencies:
    ...
    def test_every_shipped_builtin_manifest_keeps_its_declared_commands(self):
        ...
        builtins = _REPO_ROOT / "src/codex_crew/apps/builtins"
...
class TestCapabilityDepTypesContract:
    ...
    def test_types_match_dataclass_fields(self):
        ...
        from codex_crew.apps.dependency_ledger import CAPABILITY_DEP_TYPES
    ...
    def test_installable_subset_is_derived(self):
        from codex_crew.apps.dependencies import _INSTALLABLE_TYPES
        from codex_crew.apps.dependency_ledger import CAPABILITY_DEP_TYPES
...
class TestRequiresDesktopApp:
    ...
    def test_windows_is_expressible(self):
        """CodexCrew runs natively on Windows, so a manifest must be able to say so.
    ...
    def test_current_os_names_windows_in_the_manifest_vocabulary(self, monkeypatch):
        ...
        from codex_crew.apps import manifest as manifest_mod
...
def test_overlay_builtins_must_not_ship_a_ui_bundle():
    ...
    """
    offenders = []
    for entry in sorted((_REPO_ROOT / "src/codex_crew/apps/builtins").iterdir()):
...
def test_command_bar_builtin_is_overlay_only_and_default_on():
    ...
    raw = json.loads(
        (
            _REPO_ROOT / "src/codex_crew/apps/builtins/command_bar/app.json"
