...
def mock_sel():
    ...
    _resolve_permission does a lazy import: ``from codex_crew.sel import sel``
    ...
    with patch("codex_crew.sel.sel", return_value=sel_instance):
        ...
        with patch("codex_crew.llm_helpers._sel", return_value=sel_instance):
            yield sel_instance
...
class TestResolveDenyByDefault:
    ...
    async def test_empty_title_rejected(self, mock_sel):
        from codex_crew.llm_helpers import _resolve_permission
...
class TestAgentExecRedaction:
    ...
    async def test_credentials_redacted_from_output(self):
        ...
        from codex_crew.workflows.agent_exec import build_agent_fn
