...
from codex_crew.discord import commands as dcmd
from codex_crew.discord import transport_dispatch as dtd
from codex_crew.discord.session_resume import RoutingDecision
...
async def test_a_real_command_still_runs(permitted: None) -> None:
    ...
    assert len(client.sent) == 1
    assert "Codex Crew" in client.sent[0]
