...
@dataclass
class _FakePoolKey:
    server_name: str = "codexcrew-core"
    agent_name: str = "codexcrew"
...
async def test_old_request_fresh_ping_warns_once() -> None:
    ...
    with patch("codex_crew.mcp_gateway.backend.logger") as mock_logger:
...
def test_cancel_event_check() -> None:
    ...
    import codex_crew.mcp_shared as mod
    from codex_crew.mcp_shared import is_tool_cancelled
...
def test_tool_cancelled_exception_suppresses_response() -> None:
    ...
    import codex_crew.mcp_shared as mod
    from codex_crew.mcp_shared import ToolCancelled, run_mcp_stdio_loop
...
def test_unknown_notification_silently_ignored() -> None:
    ...
    import codex_crew.mcp_shared as mod
    from codex_crew.mcp_shared import run_mcp_stdio_loop
