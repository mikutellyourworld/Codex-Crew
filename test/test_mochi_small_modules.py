...
from codex_crew.apps.builtins.mochi.pet_state_machine import (
    ALL_EVENTS,
    ALL_STATES,
    ERROR_TIMEOUT_MS,
    TRANSITIONS,
...
from codex_crew.apps.builtins.mochi.pet_state_manager import (
...
class TestPetStateManager:
    ...
    def test_persistent_mood_lingers_until_cleared(self) -> None:
        from codex_crew.apps.builtins.mochi.pet_state_manager import MOOD_DURATION_MS
    ...
    def test_mood_reset_timer_is_independent_of_error_recovery(self) -> None:
        ...
        from codex_crew.apps.builtins.mochi.pet_state_machine import ERROR_TIMEOUT_MS
        from codex_crew.apps.builtins.mochi.pet_state_manager import MOOD_DURATION_MS
