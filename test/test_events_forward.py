...
from codex_crew.slack.events import (
...
class TestRouteMessageFallbackRecovery:
    ...
    async def test_placeholder_text_with_no_recoverable_blocks_drops_message(self):
        ...
        from codex_crew.slack.events import _route_message
        ...
        with patch("codex_crew.slack.enterprise.check_message_origin", return_value=True), \
             patch("codex_crew.slack.events.sel") as mock_sel, \
             patch("codex_crew.slack.events.is_allowed_user", return_value=True), \
             patch("codex_crew.slack.events.handle_message", new_callable=AsyncMock) as mock_handle:
