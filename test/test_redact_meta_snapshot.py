...
slot's save. Observed twice in the gateway log:
    ...
    ERROR codex_crew.dashboard.chat_persistence: Failed to save slot
    chat-73-... to history
    WARNING codex_crew.dashboard.state: Flush failed for slot chat-73-...
...
def test_flush_file_changes_marks_slot_dirty() -> None:
    ...
    restart."
    """
    from codex_crew.dashboard.chat_runner import _flush_file_changes
...
def _flush_harness(save_fn):
    ...
    """
    from codex_crew.dashboard import chat as chat_mod
