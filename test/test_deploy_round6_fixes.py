...
from codex_crew.deploy.scan import Finding, is_credential_finding, summarize
...
def test_409_response_does_not_leak_akia_key():
    ...
    from codex_crew.deploy.handlers import _redact_text
...
def test_binary_file_does_not_crash_scan():
    ...
    from codex_crew.deploy.handlers import _scan_tree
