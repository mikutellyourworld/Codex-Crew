"""Tests for codex_crew.log_redaction."""
...
from codex_crew.log_redaction import (
...
class TestSecretRedactionFilter:
    ...
    def test_no_vault_io_at_construction(self) -> None:
        ...
        # of codex_crew.secrets happen inside SecretRedactionFilter.
...
def _make_record(msg: str, exc_info: object = None) -> logging.LogRecord:
    ...
    return logging.getLogRecordFactory()("codex_crew.test", logging.INFO, "", 0, msg, None, exc_info)
...
class TestInstallLogRedaction:
    ...
    def test_install_survives_a_module_reload(self) -> None:
        ...
        """
        import codex_crew.log_redaction as mod
    ...
    def test_zero_vault_imports(self, monkeypatch: pytest.MonkeyPatch) -> None:
        """log_redaction module does NOT import codex_crew.secrets."""
        import codex_crew

        mod_name = "codex_crew.log_redaction"
        ...
        # both, or `codex_crew.log_redaction` keeps pointing at the duplicate and one
        # process-global chokepoint has two module objects. monkeypatch reverts even
        # when the assertion below fails.
        monkeypatch.setattr(codex_crew, "log_redaction", sys.modules[mod_name])
        ...
        vault_imports = [m for m in new_imports if "secrets" in m and "codex_crew" in m]
