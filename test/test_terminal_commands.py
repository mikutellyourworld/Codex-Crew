...
from codex_crew.dashboard import terminal_commands as tc
...
class TestCompleteOrchestration:
    ...
    async def test_refuses_to_run_a_probe_in_a_sensitive_directory(self):
        ...
        with patch.object(tc, "_resolve_and_vet", return_value=(("/usr/bin/gh", ("x", 1, 2)), None)), \
            ...
            entries, reason = await tc.complete(["gh"], "", "/home/u/.codex-crew")
...
class TestRunProbe:
    ...
    async def test_the_environment_is_an_allowlist_not_a_filtered_inherit(self, monkeypatch, tmp_path):
        ...
        # launcher injects its own markers (`CODEXCREW_*`, `GIT_SSH_COMMAND`,
        ...
        sandbox_injected = {"CODEXCREW_HOST_PID", "CODEXCREW_SANDBOX_ACTIVE",
                            "CODEXCREW_SANDBOX_LEVEL", "CODEXCREW_SPAWNED",
