...
from codex_crew.vector_memory import _HAS_FAISS, _HAS_NUMPY, VectorMemoryStore
...
class TestLessonsSingleQuery:
    def _builder(self, tmp_path: Path):
        from codex_crew.context import ContextBuilder, LessonStore, MemoryStore, SkillsLoader
...
class TestEpisodicSqliteCosineNumpy:
    ...
    def _search(
        ...
        import codex_crew.vector_memory as vm
