...
from codex_crew.dashboard.chat_handlers import _is_interrupted, api_chat_slot_continue
...
def _patched(monkeypatch):
    ...
    with (
        patch("codex_crew.dashboard.chat_handlers.sel", return_value=mock_sel),
        patch("codex_crew.dashboard.chat_handlers._start_next_queued_turn", started),
    ):
        yield started
