...
from codex_crew.connections import get_provider, l1_smoke
...
async def test_a_tokenless_401_is_grant_held_not_needs_reconsent(granted):
    """The regression that matters most: Codex Crew holds no bearer, so a healthy
...
def test_a_small_report_on_a_hung_up_pipe_still_exits_clean():
    ...
    program = (
        "import time\n"
        "from codex_crew.connections.l1_smoke import _echo\n"
