...
KEY = "discord:codexcrew:direct:42"
...
class TestDelivery:
    ...
    async def test_an_undeliverable_notice_is_a_logged_noop(
        ...
        with patch(
            ...
            with caplog.at_level(logging.WARNING, logger="codex_crew.dashboard.state"):
...
class TestNoticeIsSafeAndHuman:
    ...
    def test_every_audited_reason_has_a_phrase(self) -> None:
        ...
        from codex_crew.dashboard.state import _INBOUND_UNBIND_WHY
        from codex_crew.messaging.link import UNBIND_REASON_USER_UNLINK, UNBIND_REASONS
