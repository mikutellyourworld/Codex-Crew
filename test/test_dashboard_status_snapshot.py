...
class TestStatusSnapshot:
    ...
    def test_ships_the_resolved_release_channel(
        ...
        """
        monkeypatch.setattr("codex_crew.release_channel.__version__", version)
...
def inspect_module_root() -> str:
    ...
    return str(pathlib.Path(codex_crew.__file__).parent)
...
class TestBuildInfoResolution:
    ...
    BEFORE main() detects CODEXCREW_PROJECT_DIR, so it resolved with no project dir
