"""Tests for codex_crew.apps.permissions — permission validation and enforcement."""
from __future__ import annotations

from codex_crew.apps.manifest import AppManifest, Permissions
from codex_crew.apps.permissions import (
    PermissionCheck,
