...
from codex_crew.loopback_http import build_loopback_opener, loopback_urlopen
...
class TestNoNewBareLoopbackSender:
    ...
    def test_no_bare_urlopen_in_a_secret_sending_module(self):
        ...
        assert offenders == [], (
            ...
            "urlopen; route them through codex_crew.loopback_http.loopback_urlopen, or add "
