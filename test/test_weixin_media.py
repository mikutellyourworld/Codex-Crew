...
from codex_crew.weixin.media import (
    MAX_CDN_BYTES,
    WeixinMediaError,
    build_download_url,
    decrypt_aes_ecb,
...
from codex_crew.weixin.transport import WEIXIN_CAPABILITIES, WeixinTransport
...
def _encrypt(plaintext: bytes, key: bytes = KEY) -> bytes:
    ...
    # WeChat CDN uses; see codex_crew.weixin.media's module docstring.
