...
from codex_crew.testing.channel_fixtures import (
    Provenance,
    ShapeMismatch,
    Source,
    assert_same_shape,
...
class TestNoImplicitFixturesRoot:
    ...
    ``codex_crew.testing`` is in the runtime wheel, where no ``test/`` tree
...
class TestRouteScriptSemantics:
    ...
    def test_a_shared_sequence_is_copied_not_consumed(self) -> None:
        from codex_crew.testing.fake_channel_wire import FakeWireSession
    ...
    def test_calling_past_the_script_raises_instead_of_repeating(self) -> None:
        from codex_crew.testing.fake_channel_wire import (
            FakeWireSession,
...
class TestSymlinkContainment:
    ...
    def test_a_mid_write_failure_does_not_double_close_the_descriptor(
        ...
        from codex_crew.testing import channel_fixtures as cf
    ...
    def test_a_mapping_body_survives_being_read_not_just_routed(self) -> None:
        ...
        from codex_crew.testing.fake_channel_wire import WireResponse
