...
Covers :func:`codex_crew.resource_status.compute_xdist_auto_workers` (clamping),
:func:`codex_crew.resource_status.inject_xdist_auto_cap` (config modes,
...
def _with_raw_config(raw: dict):
    return patch("codex_crew.config.loader._raw_config", return_value=raw)
