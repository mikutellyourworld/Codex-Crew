...
from codex_crew.connections import get_provider, tool_test
...
def fake_client(monkeypatch: pytest.MonkeyPatch, tmp_path):
    ...
    monkeypatch.setattr("codex_crew.sandbox.configured_sandbox_mode", lambda: "strict")
...
async def test_usable_requires_running_server_and_agent_exposed_tools(fake_client):
    ...
    assert client.kwargs["agent"] == "codexcrew"
