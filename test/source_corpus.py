"""One cached read of the ``codex_crew`` source tree, shared by every AST ratchet.

Several gates in this suite pin a structural property of the whole package by
walking ``src/codex_crew/**/*.py`` and ``ast.parse``-ing each file. Independently
