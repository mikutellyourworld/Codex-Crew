...
from codex_crew.knowledge import ingestion as ingestion_mod
...
from codex_crew.knowledge.ingestion import FileTooLargeError, IngestionPipeline
...
class TestSizeGuard:
    ...
    async def test_oversized_file_raises_with_actionable_warning(
        ...
        with caplog.at_level(logging.WARNING, logger="codex_crew.knowledge.ingestion"):
    ...
    def test_config_load_failure_falls_back_to_default(self, monkeypatch):
        ...
        monkeypatch.setattr(
            loader_mod.CodexCrewConfig, "load",
...
class TestChunkPropsCoercion:
    ...
    async def test_nonpositive_chunk_size_falls_back(
        ...
        from codex_crew.knowledge.chunker import CHUNK_OVERLAP, CHUNK_TOKEN_SIZE
...
class TestZipArchivePreflight:
    ...
    def test_a_forged_directory_size_is_refused_before_zipfile(self, tmp_path, monkeypatch):
        ...
        from codex_crew.dashboard.handlers import knowledge
