...
from codex_crew import session_directive as sd
from codex_crew.acp import _dispatch
...
from codex_crew.acp.types import EVENT_TOOL_RESULT, JsonRpcMessage
from codex_crew.mcp_apps_render import find_marker
from codex_crew.mcp_gateway.apps import append_marker
from codex_crew.validation import build_tool_response, strip_hidden_unicode
...
class TestSurvivesMcpResponseExit:
    ...
    def test_sentinel_is_pure_ascii(self):
        ...
        assert _encoded().isascii() or "[[CODEXCREW_SESSION_DIRECTIVE]]" in _encoded()
...
class TestSurvivesADuplicatingResultEnvelope:
    ...
    (reproduced from a live ``codexcrew-conductor`` frame). Two copies of ONE
