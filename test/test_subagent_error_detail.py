...
from codex_crew.dashboard.chat_runner import _MAX_NATIVE_CARD_ERROR, _clip_card_error
...
class TestClipCardError:
    ...
    def test_native_sync_publishes_an_error_keeping_the_request_id(self):
        ...
        from codex_crew.dashboard.chat_runner import _native_subagent_sync
