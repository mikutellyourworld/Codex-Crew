...
PROMPT = ROOT / "src" / "codex_crew" / "config" / "prompt.md"
BABYSIT_SKILL = (
    ROOT / "src" / "codex_crew" / "builtin_skills" / "codexcrew-dev" / "babysit" / "SKILL.md"
)
...
def test_a_bare_number_is_still_refused_so_the_ratchet_means_something() -> None:
    ...
    assert infer("Babysit PR #8184 (mikutellyourworld/Codex-Crew), branch fix/x") is None
