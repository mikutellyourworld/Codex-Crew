...
from codex_crew.vector_memory import _EPISODIC_TEXT_MAX
...
def test_an_os_error_is_reported_at_the_cli_boundary(monkeypatch) -> None:
    ...
    monkeypatch.setattr("codex_crew.eval.bench.datasets.ensure", boom)
...
def test_a_programming_error_is_not_swallowed(monkeypatch) -> None:
    ...
    monkeypatch.setattr("codex_crew.eval.bench.datasets.ensure", bug)
