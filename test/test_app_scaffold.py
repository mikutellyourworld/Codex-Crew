"""Tests for codex_crew.apps.scaffold — app scaffolding."""
...
from codex_crew.apps.scaffold import (
...
class TestWriteContainment:
    ...
    def test_a_runtime_write_failure_leaves_an_existing_manifest_intact(
        ...
        monkeypatch.setattr(
            "codex_crew.apps.scaffold._placeholder_icon_png", _boom
        )
    ...
    def test_a_failed_icon_write_leaves_no_partial_placeholder(
        ...
        monkeypatch.setattr("codex_crew.apps.scaffold.atomic_write", _boom)
    ...
    def test_a_failed_final_manifest_write_leaves_the_old_manifest_intact(
        ...
        import codex_crew.apps.scaffold as scaffold_mod
...
class TestAppNameValidation:
    ...
    manifest that `codexcrew app install` then refused -- the scaffold reported
...
class TestScaffold:
    ...
    def test_readme_has_name(self, tmp_path):
        ...
        assert "codexcrew app install" in readme
    ...
    def test_scaffold_installable(self, tmp_path, monkeypatch):
        ...
        from codex_crew.apps.manager import install_app
    ...
    def test_scaffold_with_ui(self, tmp_path):
        ...
        assert "@codexcrew/app-sdk" in vite_cfg
        assert "@codexcrew/app-sdk/ui" in vite_cfg
