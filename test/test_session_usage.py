...
codex_crew.dashboard.handlers.sessions: _parse_usage, _redact_strings, and the
...
from codex_crew.dashboard.handlers.sessions import (
...
class TestFetchUsageBg:
    ...
    def _reset(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "codex_crew.dashboard.handlers.sessions.wrap_argv",
...
class TestTextScrapeIsOptIn:
    ...
    def test_the_gate_fails_closed_when_config_is_unreadable(self, monkeypatch):
        ...
        monkeypatch.setattr(
            loader_mod.CodexCrewConfig, "load", staticmethod(lambda *a, **k: 1 / 0)
        )
