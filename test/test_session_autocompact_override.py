...
from codex_crew.dashboard.chat import api_chat_slot_autocompact
...
def _manager() -> SessionManager:
    return SessionManager(CodexCrewConfig(), provider_factory=lambda *a, **k: object())
...
class TestOverrideLifecycle:
    ...
    def test_slot_save_owns_the_key_so_a_clear_erases_it(self) -> None:
        ...
        """
        from codex_crew.history import SLOT_OWNED_META_KEYS, carry_unowned_metadata
...
class TestAliasSlotsShareOneTranscript:
    ...
    def test_alias_slots_resolve_to_one_lock(self) -> None:
        from codex_crew.dashboard.chat_handlers import _autocompact_txn_lock
...
class TestObservedBitRecordedAtEveryHydrationSite:
    ...
    def test_every_identity_recording_site_sets_the_observed_bit(self) -> None:
        ...
        import codex_crew.dashboard as dash_pkg
