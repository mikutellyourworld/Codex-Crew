"""codex_crew.messaging.approval -- both channel-neutral approval seams.
...
from codex_crew.messaging import approval
...
SESSION = "whatsapp:codexcrew:direct:447700900000"
...
class TestDenyByDefault:
    ...
    async def test_an_unanswered_prompt_denies_and_stops_waiting(
        ...
        """
        monkeypatch.setattr("codex_crew.messaging.approval.APPROVAL_TIMEOUT_S", 0.01)
        pending = PendingApprovals("webex")
