...
from codex_crew.dashboard import handlers_cloud as hc
...
class TestInstanceMutations:
    ...
    async def test_a_retry_after_an_interrupted_teardown_still_clears_the_row(
        ...
        def _gone(*a, **k):
            raise hc.AWSError("Stack with id codexcrew-kc-3f9a does not exist")
    ...
    async def test_destroy_denied_maps_403(self, tmp_path, monkeypatch):
        from codex_crew.cloud.aws import CloudActionDenied
