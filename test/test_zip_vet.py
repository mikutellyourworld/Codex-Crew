"""Tests for the shared untrusted-archive inventory vet (codex_crew.zip_vet).
...
from codex_crew.zip_vet import (
    TAIL_WINDOW,
...
def test_only_the_tail_is_read(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("codex_crew.zip_vet.open", _fake_open, raising=False)
    vet_zip_inventory(path, max_members=4096)
