...
from codex_crew.feishu.gateway import _resolve_approval_mode, maybe_start_feishu
...
@patch("codex_crew.feishu.gateway.LarkClient")
@patch("codex_crew.feishu.gateway.FeishuTransport")
@patch("codex_crew.feishu.gateway.FeishuDispatcher")
class TestMaybeStartFeishu:
    ...
    async def test_import_error_swallowed(
        ...
        # Names the DEPENDENCY, not `codexcrew[feishu]`: this project is not on an
        ...
        assert "codexcrew[" not in orch.dashboard_state.feishu_connect_error
