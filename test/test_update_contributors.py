...
@pytest.mark.parametrize(
    "repo_link",
    [
        'See <a href="https://github.com/mikutellyourworld/Codex-Crew/releases">releases</a>.',
        "docs at https://github.com/mikutellyourworld/Codex-Crew/",  # trailing slash on a repo
        "https://github.com/mikutellyourworld/Codex-Crew#install",  # repo + fragment
    ],
)
