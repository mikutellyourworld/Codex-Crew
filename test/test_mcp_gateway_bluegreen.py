...
async def test_drain_and_rewarm_schedules_prewarm_on_success() -> None:
    ...
    from codex_crew.mcp_gateway.gatewayd import _drain_and_rewarm_on_credential_change
...
def test_credwatch_streaming_digest_matches_oneshot(tmp_path: Path) -> None:
    ...
    from codex_crew.mcp_gateway import credwatch
...
def test_default_identity_watch_paths_empty() -> None:
    ...
    from codex_crew.platform.defaults import DefaultIdentityProvider
...
def test_manager_resolves_no_watch_paths_by_default() -> None:
    ...
    from codex_crew.mcp_gateway.manager import GatewayManager
...
def test_gatewayd_argparser_accepts_repeatable_watch_flag() -> None:
    ...
    from codex_crew.mcp_gateway.gatewayd import _build_argparser
