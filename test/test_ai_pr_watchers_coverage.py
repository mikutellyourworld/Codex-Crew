...
(``src/codex_crew/apps/builtins/auto_improvement/tests/test_pr_watchers.py``), but CI
...
from codex_crew.apps.builtins.auto_improvement.backend import pr_checks
...
class TestMakeRunner:
    ...
    def test_no_provider_refuses_the_subprocess_fallback(
        ...
        self._accept_egress()
        from codex_crew.apps.builtins.auto_improvement.spine import agent_runner
