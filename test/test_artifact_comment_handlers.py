...
from codex_crew.dashboard.handlers import artifacts as h
...
class TestEditComment:
    ...
    async def test_edit_pushes_in_place_for_liveprov_origin(self, store, monkeypatch):
        from codex_crew.artifacts import ArtifactComment
        from codex_crew.publish_provider import Capability
        ...
        monkeypatch.setattr(
            "codex_crew.dashboard.handlers.artifacts.get_provider", lambda name: prov
        )
...
class TestFetchOnViewMerge:
    ...
    async def test_provider_author_redacted_at_read_boundary(self, store, monkeypatch):
        from codex_crew.publish_provider import RemoteComment
