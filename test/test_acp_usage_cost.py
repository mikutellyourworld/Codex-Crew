...
from codex_crew.acp._dispatch import parse_prompt_token_usage, parse_usage_cost
from codex_crew.acp.client import AcpClient
from codex_crew.acp.types import AcpPromptStats, TurnUsage
...
class TestParsePromptTokenUsage:
    ...
    def test_codex_acp_nested_usage_shape(self):
        result = {
            "stopReason": "end_turn",
            "usage": {
                "totalTokens": 160,
        ...
        assert parse_prompt_token_usage(result) == (75, 25, 60, 0)
...
class TestClientTracking:
    ...
    def test_reset_state_drops_cost_baseline(self):
        ...
        with patch("codex_crew.session._untrack_pid"):
            client._reset_state()
