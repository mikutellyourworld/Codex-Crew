...
from codex_crew.apps.builtins.pptx_maker.backend import pdftoppm_shim, preview_tools
...
class TestLauncherInstall:
    ...
    def test_launcher_runs_from_a_path_the_shell_would_mangle(
        ...
        """CODEXCREW_HOME is user-chosen, so the launcher must survive its characters.
