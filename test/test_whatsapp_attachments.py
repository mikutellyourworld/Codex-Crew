...
nothing in :mod:`codex_crew.whatsapp.attachments` needs it: it takes a
:class:`~codex_crew.whatsapp.media.MediaDescription` (already read off the
...
from codex_crew.messaging.attachments import DOCUMENT, IMAGE, OTHER, classify, cleanup, safe_suffix
from codex_crew.whatsapp import attachments as wa_attachments
from codex_crew.whatsapp.attachments import (
    AUDIO_MIMETYPES,
...
from codex_crew.whatsapp.media import (
    KIND_AUDIO,
    KIND_DOCUMENT,
    KIND_IMAGE,
    KIND_STICKER,
...
def _temp_suffix(desc: MediaDescription) -> str:
    ...
    Derived exactly as :func:`codex_crew.messaging.attachments.ingest_attachments`
