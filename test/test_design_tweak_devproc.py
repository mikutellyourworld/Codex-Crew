...
class TestChildEnv:
    ...
    def test_strips_proxy_secret(self):
        ...
        with patch.dict(os.environ, {"CODEXCREW_PROXY_SECRET": "s3cr3t", "HOME": "/h"}):
    ...
    def test_strips_all_codexcrew_prefixed(self):
        """Forward-compatible prefix strip catches vars added later upstream."""
        injected = {
            "CODEXCREW_HOME": "/home/u/.codex-crew",
            "CODEXCREW_APP_PORT": "9999",
            "CODEXCREW_PROJECT_DIR": "/proj",
            "CODEX_CREW_SOMETHING": "v",
        }
