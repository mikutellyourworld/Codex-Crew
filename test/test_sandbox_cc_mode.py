...
import codex_crew.sandbox as _sb_mod
...
class TestCcFilesList:
    ...
    def test_has_codexcrew_env(self):
        assert ".codexcrew/.env" in _CC_FILES
...
class TestBuildSeatbeltProfileCcMode:
    ...
    def test_cc_denies_sensitive_files(self):
        ...
        assert ".codexcrew/.env" in profile
...
class TestAgentDeniedEnvKeys:
    ...
    def test_default_set_includes_slack_tokens(self):
        ...
        assert "CODEXCREW_OWNER_ID" in _AGENT_DENIED_ENV_KEYS
    ...
    def test_cc_sandbox_exec_scrubs_agent_creds(self, monkeypatch):
        ...
        try:
            ...
            assert "CODEXCREW_OWNER_ID" in argv
        finally:
            if cleanup:
                os.unlink(cleanup)
...
_FAKE_CHANNEL_ENV = {
    ...
    "CODEXCREW_OWNER_ID": "U_FAKE_OWNER",
}
...
class TestChannelCredentialIsolation:
    ...
    def test_denylist_covers_loader_credentials(self):
        ...
        """
        from codex_crew.config.loader import _CREDENTIAL_KEYS, CRED_KIRO_API_KEY
    ...
    def test_scrub_env_strips_channel_secrets(self, monkeypatch):
        ...
        assert cleaned.get("CODEXCREW_UNRELATED_KEEPME") == "keep-this-value"
    ...
    def test_scrub_agent_denied_env_strips_all_denied_keys(self):
        ...
        env["CODEXCREW_UNRELATED_KEEPME"] = "keep-this-value"
