...
class TestUpdateEndpoints:
    ...
    async def test_simulate_walks_through_steps(self, monkeypatch, tmp_path) -> None:
        ...
        monkeypatch.setattr("codex_crew.dashboard.state.config_dir", lambda: tmp_path)
        monkeypatch.setattr("codex_crew.dashboard.handlers.config_path", lambda: tmp_path / "c.json")

        from codex_crew.dashboard.handlers import api_update_simulate
    ...
    async def test_cancel_clears_progress(self, monkeypatch, tmp_path) -> None:
        ...
        from codex_crew.dashboard.handlers import api_update_cancel
    ...
    async def test_update_apply_rejects_dirty_tree(self, monkeypatch, tmp_path) -> None:
        ...
        from codex_crew.dashboard.handlers import api_update_apply
