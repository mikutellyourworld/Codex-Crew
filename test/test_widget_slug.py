...
``codex_crew.widget_slug.derive_widget_slug`` and the frontend's
...
from codex_crew.widget_slug import DERIVED_SLUG_RE, derive_widget_slug
...
class TestDeriveWidgetSlug:
    ...
    def test_slug_passes_artifact_slug_validation(self):
        ...
        from codex_crew.artifacts import _validate_slug
