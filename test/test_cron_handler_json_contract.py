...
async def test_lessons_delete_refuses_a_non_object_body(payload) -> None:
    ...
    with (
        patch("codex_crew.dashboard.handlers.cron._recognize_session", AsyncMock(return_value=None)),
        patch("codex_crew.dashboard.handlers.cron._blocks_reads_session", return_value=False),
