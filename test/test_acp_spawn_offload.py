...
from codex_crew.acp.client import AcpClient, _resolve_spawn_env
...
class TestSpawnFailureCannotLeaveAnUntrackedProcess:
    ...
    async def test_client_spawn_kills_the_process_when_the_window_raises(
        ...
        with (
            ...
            patch("codex_crew.session._track_pid", side_effect=_raise_if("track_pid")),
            patch(
                "codex_crew.session._track_session_pid",
