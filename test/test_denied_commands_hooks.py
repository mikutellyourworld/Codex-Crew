...
def _install_ceiling_with_command_deny(patterns):
    ...
    from codex_crew.platform.profile import PROFILE_STANDALONE

    ceiling = gov.parse_policy(
        {"version": 1, "boot": {}, "commands": {"mode": "deny", "deny": list(patterns)}}
    )
    ctx = build_default_context(CodexCrewConfig(), profile=PROFILE_STANDALONE)
...
class TestResolveDeniedNotes:
    ...
    def test_excludes_note_that_would_forge_a_second_reason_line(self):
        ...
        from codex_crew.security import DENY_REASON_PREFIX
    ...
    def test_forging_note_cannot_produce_two_parseable_reason_lines(self):
        ...
        """
        from codex_crew.security import DENY_REASON_PREFIX, is_denied
...
class TestGovernancePins:
    ...
    def test_governance_pinned_ids_helper_failsoft(self):
        ...
        from codex_crew.hooks import _governance_pinned_command_ids
...
class TestSearchArgDenyTarget:
    ...
    def test_a_path_cannot_forge_a_depth_cap(self):
        ...
        from codex_crew.hooks import _search_deny_target
    ...
    def test_a_tilde_root_is_denied_by_a_home_rule(self, monkeypatch, tmp_path):
        ...
        from codex_crew.hooks import _normalize_search_path
...
class TestSearchDenyTargetSynthesis:
    ...
    def _path_field(raw: str) -> str:
        ...
        """
        from codex_crew.hooks import _encode_search_field, _normalize_search_path
...
class TestSearchTargetSynthesizedTier:
    ...
    def _effective(self):
        from codex_crew.security import BUILTIN_DENIED_RULES, compute_effective_denied
    ...
    def test_no_shipped_builtin_is_authored_against_the_grammar(self):
        ...
        from codex_crew.security import _deny_pattern_matches
    ...
    def test_no_deny_exception_can_exonerate_a_synthesized_target(self):
        ...
        from codex_crew.security import _DENY_EXCEPTIONS, _deny_pattern_matches
    ...
    def test_a_command_rule_takes_no_part_in_a_synthesized_target(self):
        from codex_crew.security import is_denied_synthesized_target
    ...
    def test_an_argv_floor_cannot_be_needed_by_a_synthesized_target(self):
        ...
        from codex_crew.hooks import _search_deny_target
        from codex_crew.security import _is_credential_mint, is_denied_synthesized_target

        target = _search_deny_target({"path": "/srv/codexcrew token", "pattern": "*.py"})
