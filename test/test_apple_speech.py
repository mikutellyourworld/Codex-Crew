"""Tests for the ``apple`` STT provider (codex_crew.apple_speech).
...
from codex_crew import apple_speech, platform_compat
...
class TestHelperBuild:
    ...
    async def test_no_sandbox_backend_fails_with_a_remedy_not_an_exception(self, monkeypatch):
        ...
        result shape.
        """
        from codex_crew import sandbox as sb
...
class TestTranscribePlumbing:
    ...
    async def test_webm_without_ffmpeg_degrades_instead_of_refusing(self):
        ...
        with (
            ...
            patch("codex_crew.transcribe.ensure_ffmpeg_in_path"),
        ):
...
class TestTranscodeTempOwnership:
    ...
    async def test_cancellation_on_the_close_await_still_removes_the_owned_temp(
        ...
        with (
            ...
            patch("asyncio.create_subprocess_exec", return_value=proc),
            patch(
                "codex_crew.transcribe._close_ffmpeg_for_execution",
...
class TestNoBlockingCallOnEventLoop:
    ...
    def _no_spawn():
        ...
        return (
            ...
            patch("codex_crew.apple_speech._swiftc", boom),
    ...
    def test_transcribe_is_available_spawns_nothing(self):
        from codex_crew.transcribe import is_available
