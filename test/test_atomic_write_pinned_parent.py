...
``codex_crew.atomic_write`` + ``codex_crew.pinned_fs``, both leaf modules. The ACL
...
from codex_crew.atomic_write import atomic_write, pinned_parent_replace_supported
