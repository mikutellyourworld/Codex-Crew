"""Tests for the api_codexcrew_config PUT validator's max_subagents handling.
...
from codex_crew.dashboard.handlers.core import api_codexcrew_config
...
async def _put(agent_settings: dict, cfg_path) -> web.Response:
    ...
    with patch("codex_crew.config.loader.config_path", return_value=cfg_path):
        return await api_codexcrew_config(request)
