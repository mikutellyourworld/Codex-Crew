...
from codex_crew.discord import commands as dc
from codex_crew.discord.client import _APP_COMMAND_DESC_LIMIT, _APP_COMMAND_NAME_RE
...
class TestBuildHelpText:
    ...
    def test_keeps_the_frame_around_the_rows(self) -> None:
        ...
        assert "Codex Crew" in head and "Discord" in head
