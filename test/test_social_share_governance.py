...
def fake_sel(monkeypatch):
    ...
    (tool-invocation rows) and ``codex_crew.sel.sel`` (the governance_decision row,
    ...
    with patch("codex_crew.dashboard.handlers.sel", return_value=fake):
        yield fake
...
class TestGovernanceGenerationFrame:
    def test_the_slots_frame_carries_the_ceiling_generation(self) -> None:
        ...
        from codex_crew.dashboard.state import _slots_ws_frame
