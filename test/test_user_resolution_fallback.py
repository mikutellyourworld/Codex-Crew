...
from codex_crew.config.loader import CodexCrewConfig, MessagingConfig, SlackConfig
...
def _make_orch(allowed_users: list[dict] | None = None) -> MagicMock:
    ...
    orch._cfg = CodexCrewConfig(slack=slack_cfg, messaging=MessagingConfig(use_transport=False))
