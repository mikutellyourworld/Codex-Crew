"""Tests for codex_crew.mcp_gateway.secret_uri."""
...
class TestResolveSecretUris:
    ...
    def test_batch_reads_store_once_for_multiple_refs(
        ...
        """
        from codex_crew.secrets import SecretVault
        from codex_crew.secrets.vault import SecretVault as VaultClass
...
class TestSecretUriPrefixConstant:
    ...
    ``codex_crew.mcp_gateway.secret_uri`` and imported by
    ``codex_crew.secrets.migrate``.  These tests pin that relationship so the
