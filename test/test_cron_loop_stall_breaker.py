...
from codex_crew import cron_inflight
from codex_crew.cron import CronJob, CronService, CronStoreUnreadable
...
class TestBreaker:
    async def test_pauses_the_attributed_job_before_the_timer_arms(
        ...
        try:
            ...
            assert f"codexcrew cron resume {job.id}" in paused.last_error
