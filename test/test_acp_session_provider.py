...
from codex_crew.acp.types import AcpEvent, AcpPromptStats
...
class TestAcpSessionProviderRound4Parity:
    ...
    def test_agent_reads_from_runtime(self):
        ...
        handle = _make_handle()
        runtime = _make_runtime()
        runtime._agent = "codexcrew-lite"
        provider = AcpSessionProvider(handle, runtime)
        assert provider._agent == "codexcrew-lite"
...
class TestAcpSessionProviderContractParity:
    ...
    async def test_stream_base_runtime_error_translates_to_acp_error(self):
        ...
        from codex_crew.acp.session_handle import AcpRuntimeError
...
class TestNewConversation:
    ...
    async def test_creates_fresh_session_on_same_runtime_and_swaps_handle(self):
        ...
        runtime.create_session.assert_awaited_once_with(cwd="/tmp/ws", agent="codexcrew")
