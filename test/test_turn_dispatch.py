...
def _patch_configured_ceiling(monkeypatch, value: object, *, acp: float = 7200.0) -> None:
    ...
    ``CodexCrewConfig`` is imported at module scope, so the module attribute is
    ...
    monkeypatch.setattr(td, "CodexCrewConfig", holder)
...
class TestBoundedIntCoercion:
    ...
    def test_callers_without_bounds_are_unaffected(self) -> None:
        ...
        from codex_crew.config.loader import _safe_int
