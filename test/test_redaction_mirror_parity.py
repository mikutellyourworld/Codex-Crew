...
BACKEND = ROOT / "src" / "codex_crew" / "security.py"
PREPARE_PR = (
    ROOT / "src" / "codex_crew" / "builtin_skills" / "codexcrew-dev" / "prepare-pr" / "scripts" / "pr_findings.py"
)
FRONTEND = ROOT / "website" / "src" / "utils" / "sanitize.ts"
TOKEN_MINT = ROOT / "src" / "codex_crew" / "instances" / "token_mint.py"
