...
from codex_crew.monitoring import models
from codex_crew.monitoring.models import MonitorBudgets, MonitorOutcome, MonitorState
...
async def test_completion_hook_delivers_one_typed_record_with_explicit_unknown_usage() -> None:
    ...
    assert importlib.util.find_spec("codex_crew.monitoring.completion") is not None
