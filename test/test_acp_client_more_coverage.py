"""Additional coverage for :mod:`codex_crew.acp.client`.
...
from codex_crew import model_registry as mr
...
from codex_crew.hooks import HOOK_EVENT_POST_TOOL_USE
...
class TestEnsureReady:
    ...
    @pytest.mark.asyncio
    async def test_auth_required_is_not_retried(self, tmp_path):
        client = _client(tmp_path)
