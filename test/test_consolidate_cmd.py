...
class TestConsolidateCmd:
    ...
    @patch("codex_crew.cli.sel")
    @patch("codex_crew.cli.SkillsLoader")
    @patch("codex_crew.cli.SessionManager")
    @patch("codex_crew.cli.MemoryStore")
    @patch("codex_crew.cli.HistoryConsolidator")
    @patch("codex_crew.cli.ConversationLog")
    @patch("codex_crew.cli.CodexCrewConfig")
    def test_list_sessions(
        ...
        from codex_crew.cli import _consolidate_cmd
...
class TestOnSessionExpire:
    ...
    @patch("codex_crew.session.sel")
    @patch("codex_crew.session.SessionManager.reset", new_callable=AsyncMock)
    @patch("codex_crew.session.Stats")
