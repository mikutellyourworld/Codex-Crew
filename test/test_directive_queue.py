...
from codex_crew.dashboard.chat_utils import _redact_tool_field
from codex_crew.dashboard.handlers.sessions import api_session_directive
...
class TestPublishAndClaim:
    ...
    def test_unknown_kind_is_refused(self):
        """The only legitimate publishers are Codex Crew's own directive tools, so
