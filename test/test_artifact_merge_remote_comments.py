...
from codex_crew.artifacts import ArtifactComment, ArtifactStore
...
class TestRemoteCommentAnchorRedaction:
    ...
    def test_serialize_remote_comment_redacts_anchor_fields(self):
        from codex_crew.dashboard.handlers.artifacts import _serialize_remote_comment
        from codex_crew.publish_provider import CommentAnchor, RemoteComment
