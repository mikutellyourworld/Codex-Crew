...
from codex_crew.dashboard.handlers.knowledge import add_source, confirm_source
...
class TestFolderChunkBudgetResolution:
    def test_configured_default_applies_with_no_property(self):
        with patch("codex_crew.config.loader.CodexCrewConfig.load",
...
class TestEstimator:
    ...
    def test_estimate_is_capped_per_file(self, tmp_path):
        ...
        from codex_crew.knowledge.chunker import MAX_CHUNKS_PER_FILE
