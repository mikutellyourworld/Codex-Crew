...
from codex_crew.cli_bench import bench_cmd
...
class TestGoldenSet:
    ...
    def test_control_bearing_filename_is_escaped_in_errors(
        ...
        import codex_crew.eval.bench.kb_retrieval as kbr
    ...
    def test_sensitive_path_is_refused(
        ...
        import codex_crew.security as security
...
class TestCli:
    ...
    def test_real_embedder_refuses_when_absent(
        ...
        import codex_crew.knowledge.embedder as emb
    ...
    def test_real_embedder_reports_actual_model_identity(
        ...
        """
        import codex_crew.knowledge.embedder as emb
        from codex_crew.eval.bench.toy_embedder import toy_embed_fn
...
class TestRound7Fixes:
    ...
    def test_recall_micro_is_fractional_for_partial_hit(self) -> None:
        ...
        from codex_crew.eval.bench.kb_retrieval import KBQueryResult, KBRetrievalReport
        from codex_crew.eval.bench.retrieval import recall_micro_at_k
    ...
    def test_store_error_is_a_refusal_not_a_traceback(
        ...
        import codex_crew.cli_bench as cb
