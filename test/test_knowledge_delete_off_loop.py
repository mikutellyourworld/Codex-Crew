...
async def test_run_to_completion_forwards_the_return_value():
    ...
    """
    from codex_crew.knowledge.ingestion import run_to_completion
...
def test_artifact_deduped_state_write_keeps_a_late_adoption(tmp_path):
    ...
    """
    from codex_crew.knowledge.artifact_ingest import _record_deduped_state
...
def test_agent_deduped_state_write_keeps_a_late_adoption(tmp_path):
    ...
    from codex_crew.knowledge.agent_source import _record_deduped_state
