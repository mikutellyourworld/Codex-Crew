...
from codex_crew import mcp_quarantine
...
class TestAnnotation:
    ...
    def test_every_server_is_counted(self, store):
        """Including Codex Crew's own. An earlier revision filtered these out so no
