...
from codex_crew.mcp_gateway.gatewayd import (
    _count_open_fds,
    _read_rss_kb,
    _snapshot_state,
)
...
class TestCountOpenFds:
    ...
    def test_returns_minus_one_when_the_shared_probe_has_no_value(self) -> None:
        ...
        with patch("codex_crew.mcp_gateway.gatewayd._shared_count_open_fds", return_value=None):
    ...
    def test_passes_the_shared_probe_count_through_unchanged(self) -> None:
        ...
        with patch("codex_crew.mcp_gateway.gatewayd._shared_count_open_fds", return_value=7):
...
class TestReadRssKb:
    ...
    def test_returns_minus_one_when_all_sources_fail(self) -> None:
        ...
        with patch("codex_crew.mcp_gateway.gatewayd._proc_rss_bytes", return_value=0):
            result = _read_rss_kb()
        assert result == -1
