...
from codex_crew import task_executor
...
from codex_crew.task_models import SESSION_PREFIX, Project, Task
...
def _intercept_usage(monkeypatch: pytest.MonkeyPatch) -> list[dict]:
    ...
    monkeypatch.setattr(task_executor, "CodexCrewConfig", fake_config)
    return captured
