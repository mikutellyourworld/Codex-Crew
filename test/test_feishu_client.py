"""Tests for codex_crew.feishu.client."""
...
def _fake_lark_sdk():
    ...
    if "codex_crew.feishu.client" in sys.modules:
        mod = sys.modules["codex_crew.feishu.client"]
...
class TestInit:
    ...
    def test_builds_rest_client(self) -> None:
        from codex_crew.feishu.client import LarkClient
...
class TestSendReply:
    ...
    async def test_long_reply_is_chunked_not_truncated(self) -> None:
        ...
        from codex_crew.feishu.client import FEISHU_MAX_TEXT, LarkClient
...
class TestHandleReceiveV1DropLogging:
    ...
    def test_missing_event_logs(self, caplog: Any) -> None:
        ...
        with caplog.at_level("INFO", logger="codex_crew.feishu.client"):
            client._handle_receive_v1(Data())
    ...
    def test_empty_resolved_text_logs(self, caplog: Any, monkeypatch: Any) -> None:
        ...
        mention-only check.
        """
        import codex_crew.feishu.client as client_mod
...
class TestThresholdClamp:
    ...
    def test_soft_above_hard_is_lowered_to_hard(self) -> None:
        ...
        from codex_crew.config.loader import FeishuConfig
    ...
    def test_matches_the_sibling_channel_configs_exactly(self) -> None:
        ...
        from codex_crew.config.loader import FeishuConfig, WeixinConfig
...
class TestMentionResolution:
    ...
    def test_reply_payload_is_utf8_not_escaped(self) -> None:
        ...
        from codex_crew.feishu import client as client_mod
