...
def cfg_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("codex_crew.dashboard.handlers.config_dir", lambda: cfg_dir)
    monkeypatch.setattr("codex_crew.dashboard.handlers.files.data_home", lambda: tmp_path)
    return cfg_dir
...
def _quiet_sel():
    ...
    with (
        patch("codex_crew.dashboard.handlers.sel") as handler_sel,
        patch("codex_crew.sel.sel") as gate_sel,
    ):
