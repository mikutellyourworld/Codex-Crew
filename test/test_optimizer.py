...
from codex_crew.dashboard.handlers.optimizer import (
    OPTIMIZER_SYSTEM,
    handle_optimize,
)
...
class TestPasteSeqs:
    ...
    def test_extracts_seq_numbers(self):
        from codex_crew.dashboard.handlers.optimizer import _paste_seqs
...
class TestBuildPastedContentBlock:
    ...
    def test_includes_only_referenced_blocks(self):
        from codex_crew.dashboard.handlers.optimizer import _build_pasted_content_block
...
class TestStripOuterWrapperTag:
    ...
    def test_strips_matching_wrapper(self):
        from codex_crew.dashboard.handlers.optimizer import _strip_outer_wrapper_tag
