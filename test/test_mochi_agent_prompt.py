...
from codex_crew.apps.bridges import _apply_agent_prompt
from codex_crew.apps.builtins.mochi import soul_loader
...
class TestPolicyCarriesThePrompt:
    def test_build_policy_pins_a_prompt_for_every_agent(self, tmp_path):
        from codex_crew.apps.builtins.mochi.agent_policy import BG_AGENT, CHAT_AGENT, build_policy
    ...
    def test_without_a_data_dir_no_prompt_is_claimed(self):
        from codex_crew.apps.builtins.mochi.agent_policy import CHAT_AGENT, build_policy
