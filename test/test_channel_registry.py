...
from codex_crew.messaging import registry
...
class TestRegistryRoster:
    ...
    def test_channel_type_matches_each_transport_class(self) -> None:
        ...
        from codex_crew.slack.transport import SlackTransport
        ...
        from codex_crew.whatsapp.transport import WhatsAppTransport
