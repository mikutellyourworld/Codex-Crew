...
_VENDOR_SRC = _REPO_ROOT / "src" / "codex_crew" / "_vendor"
...
def test_manifest_reincludes_libs_after_the_excludes() -> None:
    ...
    reinclude = f"recursive-include src/codex_crew/_vendor/{_LIBS_DIR_NAME} *"
...
def test_manifest_rules_keep_every_required_lib() -> None:
    ...
    for plat, required in _REQUIRED_VENDORED_LIBS.items():
        directory = f"src/codex_crew/_vendor/{_LIBS_DIR_NAME}/{plat}"
