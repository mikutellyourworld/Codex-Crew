"""Tests for the select_crew MCP tool (codex_crew.mcp_core._do_select_crew)."""
...
def test_roster_mode_lists_only_crews_with_triggers(tmp_path):
    ...
    with unittest.mock.patch("codex_crew.config.loader.config_path", return_value=p):
...
def test_schema_accepts_crew_names_with_spaces_and_dots():
    ...
    from codex_crew.validation import SELECT_CREW_SCHEMA, validate_tool_args
