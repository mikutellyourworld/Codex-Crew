...
from codex_crew.eval.bench.corpus import CAT_SINGLE_HOP, BenchQuery
from codex_crew.eval.bench.ingest import IngestError
from codex_crew.eval.bench.retrieval import RetrievalConfig, retrieve_for_query
from codex_crew.eval.bench.run import write_report
...
def _plain_report(monkeypatch):
    monkeypatch.setattr(
        "codex_crew.eval.bench.run.format_report", lambda outcome: "# report\n"
    )
