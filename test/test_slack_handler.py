...
from codex_crew.hooks import AutoReplyHook, HookManager, HooksConfig
from codex_crew.providers.base import LLMEvent
from codex_crew.slack.format import CONTINUATION, SLACK_MSG_LIMIT, split_message
...
class TestHandleMessage:
    ...
    def _ensure_reactions_enabled(self, monkeypatch):
        ...
        _real_load = CodexCrewConfig.load
        ...
        monkeypatch.setattr(CodexCrewConfig, "load", _patched_load)
    ...
    async def test_streaming_credential_split_across_chunks_not_leaked(self, monkeypatch):
        ...
        import codex_crew.slack.handler as _h
    ...
    def _force_show_thinking(monkeypatch):
        ...
        monkeypatch.setattr(CodexCrewConfig, "load", _patched)
...
class TestHookIntegration:
    ...
    async def test_auto_reply_records_agent_in_first_turn(self):
        ...
        from codex_crew.slack.handler import _hydrated_sessions
...
class TestToolApproval:
    ...
    def _reset_globals(self):
        from codex_crew.slack.handler import _trusted_sessions
    ...
    async def test_approval_blocks_omit_code_when_no_tool_input(self):
        ...
        from codex_crew.slack.handler import _build_approval_blocks
    ...
    async def test_request_approval_rejects_tool_when_post_fails(self):
        ...
        from codex_crew.slack.handler import _request_approval
...
class TestCronMessageSplitting:
    ...
    async def test_short_cron_result_sends_single_block_message(self):
        ...
        from codex_crew.slack.format import build_cron_ack_block, to_slack_mrkdwn
        from codex_crew.slack.gateway import _CRON_MSG_LIMIT
    ...
    async def test_all_cron_parts_within_block_kit_limit(self):
        ...
        from codex_crew.slack.format import to_slack_mrkdwn
        from codex_crew.slack.gateway import _CRON_MSG_LIMIT
...
class TestAgentCommand:
    ...
    def setup_agents_dir(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("codex_crew.slack.handler._set_default_agent", lambda name: None)
...
class TestThreadTitle:
    ...
    def _clean_titled_threads(self):
        from codex_crew.slack.handler import _titled_threads
...
class TestAutoTitleSlack:
    ...
    async def test_auto_title_happy_path(self):
        ...
        from codex_crew.slack.handler import _mark_titled, _maybe_auto_title_slack, _titled_threads
    ...
    async def test_auto_title_unexpected_error_surfaces_at_warning(self, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="codex_crew.messaging.auto_title"):
    ...
    async def test_auto_title_stream_timeout_stays_at_debug(self, caplog):
        ...
        with caplog.at_level(logging.DEBUG, logger="codex_crew.messaging.auto_title"):
            await _maybe_auto_title_slack(
    ...
    async def test_auto_title_with_curly_braces(self):
        ...
        from codex_crew.slack.handler import _mark_titled, _maybe_auto_title_slack
...
class TestToSlackMrkdwnTruncation:
    ...
    def test_no_newline_long_text_truncates_under_limit(self):
        from codex_crew.slack.format import SLACK_MAX_TEXT, to_slack_mrkdwn
...
class TestMermaidSequenceArrows:
    ...
    def _seq(line: str) -> str:
        from codex_crew.slack.format import _mermaid_sequence
...
class TestStopReasonCompactionFailed:
    ...
    async def test_compaction_failed_resets_the_abandoned_session(self):
        from codex_crew.acp.types import STOP_REASON_COMPACTION_FAILED
...
class TestBuildTimingFooter:
    ...
    def test_duration_seconds(self):
        from codex_crew.slack.handler import build_timing_footer
...
class TestSlackTrustSubagentPropagation:
    ...
    async def test_trust_sets_session_approval_policy_auto(self):
        from codex_crew.slack.handler import _PendingApproval
    ...
    async def test_late_trust_click_sets_session_approval_policy_auto(self):
        ...
        with patch("codex_crew.session.SessionMap", return_value=fake_map):
            result = await handle_interaction(
                "C9",
                "ts9",
                "trust_tool",
