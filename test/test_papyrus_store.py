...
class TestPdfPathIsContained:
    ...
    `main.pdf -> ~/.codex-crew/.local_secret` had that file served verbatim by the
...
class TestProjectConfigIsContained:
    ...
    def test_an_in_project_config_symlink_cannot_overwrite_the_manuscript(
        ...
        manuscript with JSON. This is a file CodexCrew owns and writes by name, so a link
...
class TestTheWalkAndTheScanRefuseJunctionsToo:
    ...
    module refuses a link at a name Codex Crew owns has to refuse a junction too, or
