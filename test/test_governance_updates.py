...
class TestSourcePin:
    ...
    def test_glob_matches(self):
        ...
        assert pins.permits_source("https://github.com/acme/codexcrew")
        assert not pins.permits_source("https://github.com/acme-evil/codexcrew")
...
class TestSeam:
    ...
    def test_ungoverned_host_is_unpinned(self, monkeypatch):
        monkeypatch.setattr(
            "codex_crew.platform.governance.active_update_pins", lambda: UpdatePins()
        )
    ...
    def test_governance_error_does_not_block(self, monkeypatch):
        ...
        monkeypatch.setattr("codex_crew.platform.context.current_context", _boom)
...
class TestPrimaryBranchResolution:
    ...
    * Too wide, or steerable -> unreviewed code is installed and executed, or a
    ...
    def test_unrelated_primary_fork_gets_no_unattended_update(self):
        ...
        `codexcrew update` and the dashboard apply path still serve it, and both
...
class TestWorktreeRedirectRefusal:
    ...
    def test_unresolvable_work_tree_is_refused(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "codex_crew.platform.update_governance._git_probe",
...
class TestRepoExecConfigRefusal:
    ...
    def test_unreadable_config_refuses(self, monkeypatch):
        ...
        monkeypatch.setattr("codex_crew.platform.update_governance._git_probe", lambda *a, **k: None)
        assert update_governance.repo_exec_config_reason("/proj") != ""
    ...
    def test_driver_regex_agrees_with_the_worktree_gate(self):
        ...
        """
        from codex_crew.dashboard.handlers.worktree import _FILTER_KEY_RE
