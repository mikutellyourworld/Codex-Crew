...
class TestSyncEffortLevels:
    def test_syncs_levels_to_persistence(self):
        ...
        with patch(
            "codex_crew.dashboard.chat_persistence.update_reasoning_effort_values"
        ) as mock_update:
...
class TestUpdateReasoningEffortValues:
    def setup_method(self):
        import codex_crew.dashboard.chat_persistence as mod
        self._mod = mod
...
async def test_api_effort_levels_global_fallback():
    ...
    import codex_crew.dashboard.chat_persistence as mod
    from codex_crew.dashboard.handlers.agents import api_effort_levels
