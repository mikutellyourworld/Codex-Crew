"""Coverage-focused tests for :mod:`codex_crew.dashboard.handlers.artifacts`.
...
from codex_crew import publish_provider
...
from codex_crew.publish_provider import Capability, CommentAnchor, PublishProvider, RemoteComment
