...
from codex_crew.on_loop_db import OnLoopDBGuard, OnLoopStoreError
...
class TestWarnThrottleClock:
    ...
    def test_this_surface_stays_on_the_shared_switch(self):
        ...
        shared ``CODEXCREW_STRICT_ON_LOOP_PERSIST`` switch and the dev-mode arm --
        ...
        from codex_crew.on_loop_db import STRICT_ENV
