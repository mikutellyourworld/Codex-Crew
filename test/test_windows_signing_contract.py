...
# failing with AccessDeniedException. Deployed in CodexCrewPublishCDK
# lib/windows-signer-stack.ts.
SIGNER_APPLICATION_NAME = "CodexCrewWindows"
EXPECTED_SIGNING_ENV = {
    "WINDOWS_SIGNING_UNSIGNED_BUCKET": "codexcrew-windows-unsigned-116101834266",
    "WINDOWS_SIGNING_SIGNED_BUCKET": "codexcrew-windows-signed-116101834266",
    "WINDOWS_SIGNING_PROFILE_ID": "CodexCrewWindowsExe",
...
def test_the_updater_offers_exactly_the_channels_that_publish_windows() -> None:
    ...
    assert "CodexCrew-notarized-stable-" in release["with"]["installer_artifact"]
...
def test_publishing_callers_consume_the_artifact_the_build_uploads() -> None:
    ...
    for caller in PUBLISHING_CALLERS:
        ...
        for job in publish_jobs:
            ...
            assert "CodexCrew-notarized-stable-" in consumed, (
