...
from codex_crew.config.loader import DiscordConfig, CodexCrewConfig, SlackConfig
from codex_crew.discord import renderer as renderer_mod
from codex_crew.discord.client import DISCORD_OK, DISCORD_TRANSIENT, DiscordApiResult
from codex_crew.discord.renderer import DiscordRenderer
from codex_crew.discord.transport import DISCORD_CAPABILITIES
from codex_crew.messaging.status_reactions import LadderTimings, PhaseReactionLadder
...
class TestDiscordConfigToggles:
    ...
    def _load(tmp_path: Path, monkeypatch: pytest.MonkeyPatch, data: dict) -> DiscordConfig:
        ...
        return CodexCrewConfig.load().discord
