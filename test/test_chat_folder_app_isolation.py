...
from codex_crew.dashboard.chat_folders import api_chat_slot_folder
...
class TestFolderFilingIsAppScoped:
    ...
    async def test_an_app_cannot_refile_another_apps_session(self) -> None:
        ...
        with patch("codex_crew.dashboard.chat_folders.save_slot_off_loop"), patch(
            "codex_crew.dashboard.chat_folders._unhide_folder", AsyncMock(return_value=True)
        ):
