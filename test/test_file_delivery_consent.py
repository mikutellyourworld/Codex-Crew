...
from codex_crew import file_delivery_consent, security
from codex_crew.config.loader import file_delivery_consent_path
...
class TestThirdPartyLegsCanNeverBeGranted:
    ...
    def test_the_shared_upload_gate_cannot_read_the_consent_store(self):
        ...
        """
        from codex_crew.dashboard.handlers import files as files_handlers
...
class TestNoDetectorMoved:
    ...
    def test_redact_does_not_strip_local_paths(self):
        ...
        """
        probe = "[Errno 2] No such file or directory: '/home/someone/.codex-crew/x'"
...
class TestConsentEndpointRequiresTheOwner:
    ...
    def test_an_app_token_is_refused(self, verb):
        from codex_crew.dashboard.handlers import file_delivery_consent as handler
...
class TestFileSendHonoursTheGrant:
    def _call(self, path):
        from codex_crew.mcp_tools.messaging import file_send
