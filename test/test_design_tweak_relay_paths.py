...
class TestRelayHttpCredentialStripping:
    ...
    def test_cookie_stripped_from_request(self):
        ...
        p = _make_probe(
            headers={
                "Cookie": "codexcrew_session=secret123",
    ...
    def test_set_cookie_stripped_from_response(self):
        ...
        fake_resp = _FakeHTTPResponse(
            ...
            [
                ...
                ("Set-Cookie", "codexcrew_session=evil"),
                ("X-Safe", "keep"),
            ],
            b"body",
        )
...
class TestRelayWsCredentialStripping:
    ...
    def test_cookie_not_in_handshake(self):
        ...
        p = _make_probe(
            headers={
                "Upgrade": "websocket",
                "Cookie": "codexcrew_session=secret",
        ...
        assert "codexcrew_session" not in handshake
...
class TestRelayWsHandshakeSanitization:
    ...
    def test_set_cookie_stripped_from_101(self):
        ...
        handshake_response = (
            ...
            b"Upgrade: websocket\r\n"
            b"Set-Cookie: codexcrew_session=evil\r\n"
        ...
        assert "codexcrew_session" not in decoded
