...
class TestMcpCoreUserActions:
    """Simulate the exact JSON-RPC calls kiro-cli sends to codexcrew-core."""
    ...
    def test_learn_remove(self):
        with patch("codex_crew.mcp_core._delete") as mock_del:
...
class TestMcpCronUserActions:
    """Simulate the exact JSON-RPC calls kiro-cli sends to codexcrew-cron."""
    ...
    def test_remove_all(self):
        ...
        # session at all by setting CODEXCREW_CLI=1, which is the forgeable claim
...
class TestJsonRpcProtocol:
    ...
    def test_initialize_handshake(self):
        ...
        from codex_crew.validation import validate_jsonrpc_request
...
class TestDashboardApiPatterns:
    ...
    def test_cron_create_body(self):
        ...
        from codex_crew.validation import validate_api_body, validate_string_field
