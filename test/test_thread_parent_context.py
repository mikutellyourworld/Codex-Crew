...
from codex_crew.slack.handler import handle_message, set_allowed_users, set_owner_id
...
class TestThreadInjectionDropIsAudited:
    ...
    def test_parent_injection_drop_emits_audit(self, tmp_path, monkeypatch):
        import codex_crew.context as context_module
...
class TestContainsInjectionHelper:
    def test_flags_known_patterns(self):
        from codex_crew.security import contains_injection
