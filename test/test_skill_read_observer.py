...
from codex_crew.acp.client import _mentions_skill_file
from codex_crew.skill_usage import (
...
class TestRegistrationIsNotRouteDependent:
    ...
    def test_both_server_entry_points_register(self):
        ...
        import codex_crew.dashboard.server as mod
    ...
    def test_the_cli_entry_point_registers_without_importing_the_dashboard(self):
        ...
        import codex_crew.cli_server as mod
        ...
        assert "from codex_crew.dashboard.server import register" not in src
