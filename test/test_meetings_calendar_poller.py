...
from codex_crew.apps.builtins.meetings.backend import calendar_poller as poller
from codex_crew.apps.builtins.meetings.backend import calendar_sync
...
class TestPollOnce:
    ...
    async def test_a_provider_failure_is_logged_and_the_tick_still_returns_a_delay(
        ...
        with caplog.at_level(logging.INFO, logger="codexcrew.app.meetings"):
