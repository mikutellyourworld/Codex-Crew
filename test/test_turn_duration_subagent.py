...
copy of it. Subagent-registry and ``CODEXCREW_HOME`` isolation come from the
...
async def _spawn_and_capture(stream_factory) -> list[dict]:
    ...
    with (
        ...
        patch(
            "codex_crew.dashboard.handlers.usage._write_token_record",
        ...
        patch(
            ...
            return_value="codexcrew",
        ),
        patch(
            "codex_crew.dashboard.handlers.usage.read_effective_model",
