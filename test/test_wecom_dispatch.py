"""Tests for codex_crew.wecom.transport_dispatch (WeComDispatcher) + commands."""
...
from codex_crew.wecom.commands import ConversationState, parse_command
...
class TestCommands:
    ...
    async def test_link_binds_the_dashboard_mirror(self) -> None:
        ...
        key = "wecom:codexcrew:direct:Wei"
