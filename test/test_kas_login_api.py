...
from codex_crew.auth.login.portal import PortalAuthError, wait_for_callback
from codex_crew.auth.service import KasLoginService, LoopbackUnavailableError, UnknownLoginError
from codex_crew.dashboard.handlers import kas_login
from codex_crew.dashboard.handlers.kas_login import (
...
def test_handlers_package_does_not_import_kas_at_boot():
    ...
    code = (
        ...
        "bad = [m for m in sys.modules if 'kas_login' in m or m.startswith('codex_crew.auth')]; "
