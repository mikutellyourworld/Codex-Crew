...
from codex_crew.pycache_gc import _fd_traversal_supported, prune_pycache
...
def test_platform_without_dir_fd_support_is_a_noop(tmp_path, monkeypatch):
    ...
    """
    tmp_path = tmp_path.resolve()
    from codex_crew import pycache_gc
...
def test_arbitrary_pycache_prefix_is_not_adopted(tmp_path, monkeypatch):
    ...
    Only Codex Crew's own configured cache directory is ever pruned; an active
