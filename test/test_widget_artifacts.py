"""Tests for :mod:`codex_crew.widget_artifacts` — chat-widget auto-registration."""
...
from codex_crew import widget_artifacts
from codex_crew.artifacts import ArtifactComment, ArtifactPublication, ArtifactStore
