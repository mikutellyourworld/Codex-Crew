...
class TestAliasFold:
    ...
    def test_fold_sums_deliveries_and_reports_alias(self, tmp_path):
        ...
        from codex_crew.dashboard.handlers.skill_budget import (
            _compute_budget,
        )
    ...
    def test_unresolvable_ledger_key_is_dropped(self, tmp_path):
        ...
        from codex_crew.dashboard.handlers.skill_budget import _compute_budget
...
class TestNameIsRedacted:
    ...
    def test_an_ordinary_name_is_left_alone(self, tmp_path):
        ...
        class FakeLoader:
            ...
            def _cached_frontmatter(self, path, mtime=None, within=None):
                return {"name": "codexcrew-worktree-dev"}
        ...
        assert row["name"] == "codexcrew-worktree-dev"
