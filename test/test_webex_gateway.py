"""Tests for codex_crew.webex.gateway (maybe_start_webex).
...
from codex_crew.webex import gateway as webex_gateway
from codex_crew.webex.gateway import _resolve_approval_mode, maybe_start_webex
