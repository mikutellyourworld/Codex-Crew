...
class TestCorrectedDeclarations:
    ...
    def test_slack_has_exactly_one_declaration(self) -> None:
        ...
        from codex_crew.slack import renderer as slack_renderer
        from codex_crew.slack import transport as slack_transport
    ...
    def test_wecom_char_declaration_is_safe_under_its_byte_cap(self) -> None:
        ...
        from codex_crew.wecom.client import WECOM_MAX_REPLY_BYTES
    ...
    def test_webex_declares_the_capabilities_it_now_performs(self) -> None:
        ...
        """
        from codex_crew.webex.cards import MAX_CARD_ACTIONS
        from codex_crew.webex.transport import WEBEX_CAPABILITIES
...
class TestSessionResumeIsDeclaredOnlyWhereItIsHonoured:
    ...
    def test_no_other_transport_declares_it(self) -> None:
        ...
        from codex_crew.whatsapp.transport import WHATSAPP_CAPABILITIES
