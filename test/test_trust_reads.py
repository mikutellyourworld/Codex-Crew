...
from codex_crew.dashboard.chat import _extract_bash_command
...
class TestIsReadOnlyBash:
    ...
    def test_help_suffix_does_not_auto_approve_across_segments(self):
        ...
        """
        assert is_read_only_bash("cd ~/.codex-crew --help && cat token_signing.key --help") is False
        assert (
            is_read_only_bash("cd ~/.codex-crew --help && tee denied_commands.json --help") is False
        )
