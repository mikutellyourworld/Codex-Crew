...
:data:`codex_crew.security.DENIED_ROOT_PARTS`; both apps must consume the SAME
...
from codex_crew.apps.builtins.design_critique.backend import routes
from codex_crew.apps.builtins.design_tweak.backend import server
from codex_crew.security import DENIED_ROOT_PARTS
