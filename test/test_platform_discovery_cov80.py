...
from codex_crew.platform.admission import MODE_OPEN, AdmissionPolicy, PluginManifest
from codex_crew.platform.context import PROFILE_STANDALONE, PlatformCompositionError
from codex_crew.platform.discovery import (
    PLUGIN_GROUP,
