...
def _wecom_renderer() -> Any:
    from codex_crew.wecom.renderer import WeComRenderer
...
def _weixin_renderer() -> Any:
    from codex_crew.weixin.transport import WEIXIN_CAPABILITIES
    from codex_crew.weixin.turn_renderer import WeixinRenderer
...
def _imessage_renderer() -> Any:
    from codex_crew.imessage.renderer import IMessageRenderer
    from codex_crew.imessage.transport import IMESSAGE_CAPABILITIES

    return IMessageRenderer(object(), "+61400000000", IMESSAGE_CAPABILITIES)


def _feishu_renderer() -> Any:
    from codex_crew.feishu.renderer import FeishuRenderer
    from codex_crew.feishu.transport import FEISHU_CAPABILITIES
...
def _all_channel_capabilities() -> dict[str, TransportCapabilities]:
    ...
    from codex_crew.feishu.transport import FEISHU_CAPABILITIES
    from codex_crew.imessage.transport import IMESSAGE_CAPABILITIES
    from codex_crew.slack.transport import SLACK_CAPABILITIES
    from codex_crew.teams.transport import TEAMS_CAPABILITIES
    from codex_crew.telegram.transport import TELEGRAM_CAPABILITIES
    from codex_crew.webex.transport import WEBEX_CAPABILITIES
    from codex_crew.wecom.transport import WECOM_CAPABILITIES
    from codex_crew.weixin.transport import WEIXIN_CAPABILITIES
...
class TestSharedHelper:
    ...
    def test_overflow_neutralizes_mass_mention_syntax(self) -> None:
        ...
        from codex_crew.messaging.renderer import format_overflow
    ...
    def test_a_lone_pipe_is_left_alone(self) -> None:
        ...
        """
        from codex_crew.messaging.display_safety import canonicalize_display
...
class TestTelegramEnforcement:
    def test_steer_seal_near_limit_with_overflow_stays_under_transport_cap(self) -> None:
        ...
        from codex_crew.messaging.renderer import STEER_CONSUMED, TEXT_CHUNK, OutputEvent
        from codex_crew.telegram.client import TELEGRAM_CHUNK_LIMIT
        from codex_crew.telegram.renderer import TelegramRenderer
        from codex_crew.telegram.transport import TELEGRAM_CAPABILITIES
    ...
    def test_keyboard_caps_at_declared_and_overflow_is_visible(self) -> None:
        ...
        from codex_crew.messaging.renderer import DONE, TEXT_CHUNK, OutputEvent
        from codex_crew.telegram.renderer import TelegramRenderer
        from codex_crew.telegram.transport import TELEGRAM_CAPABILITIES
...
class TestKeptChoicesAreDisplayRedacted:
    ...
    def test_a_credential_in_a_kept_label_is_redacted(self) -> None:
        from codex_crew.messaging.renderer import apply_options_cap
...
class TestWebexEnforcement:
    def test_card_actions_cap_at_declared_and_overflow_is_visible(self) -> None:
        ...
        from codex_crew.messaging.renderer import DONE, TEXT_CHUNK, OutputEvent
        from codex_crew.webex.renderer import WebexRenderer
        from codex_crew.webex.transport import WEBEX_CAPABILITIES
