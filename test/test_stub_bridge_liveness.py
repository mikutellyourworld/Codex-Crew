...
class TestLivenessIsNegotiated:
    ...
    def test_default_is_off(self) -> None:
        ...
        from codex_crew.mcp_gateway.stub import run_bridge
    ...
    def test_gatewayd_advertises_the_capability(self) -> None:
        ...
        """
        from codex_crew.mcp_gateway.gatewayd import REGISTERED_CAPABILITIES
    ...
    def test_liveness_path_does_not_exec(self) -> None:
        ...
        """
        src = (_REPO_ROOT / "src/codex_crew/mcp_gateway/stub.py").read_text(encoding="utf-8")
