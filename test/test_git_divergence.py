"""The shared ahead/behind divergence counter (``codex_crew.git_divergence``).
...
from codex_crew import git_divergence
...
class TestNoHandRolledCopies:
    ...
    def test_no_new_hand_rolled_divergence_count(self) -> None:
        ...
        assert not offenders, (
            ...
            "helper. Route the counting through codex_crew.git_divergence "
