"""Tests for codex_crew.imessage.transport (IMessageTransport, Layer 1).
...
from codex_crew.imessage.client import IMessageInbound, parse_inbound
from codex_crew.imessage.transport import (
...
class TestAuthorize:
    ...
    def test_an_empty_allowlist_authorizes_nobody(self) -> None:
        ...
        with patch("codex_crew.imessage.transport.sel") as mock_sel:
...
class TestReceive:
    ...
    async def test_the_group_gate_runs_even_for_an_allowlisted_sender(self) -> None:
        ...
        with patch("codex_crew.imessage.transport.sel"):
            await transport.receive(_recorded("watch_message_group"))
        assert dispatched == []
