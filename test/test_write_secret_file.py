...
from codex_crew.dashboard.server import _write_secret_file
...
class TestWriteSecretFile:
    ...
    def test_os_open_fails_removes_file(self, tmp_path):
        ...
        with patch("codex_crew.dashboard.server.os.open", side_effect=OSError("disk full")):
    ...
    def test_unlink_failure_still_raises_original(self, tmp_path):
        ...
        with patch("codex_crew.dashboard.server.os.open", side_effect=OSError("fail")), \
