...
class TestChannelKeyPredicates:
    def test_recognizes_every_channel_namespace(self) -> None:
        for key in (
            ...
            "telegram:codexcrew:direct:U1",
            "whatsapp:codexcrew:direct:U1",
            "webex:codexcrew:direct:U1",
            "wecom:codexcrew:direct:U1",
            "teams:codexcrew:direct:U1",
            "weixin:codexcrew:direct:U1",
            "unified:codexcrew",
        ):
    ...
    def test_recognizes_the_persisted_filename_stem_form(self) -> None:
        ...
        assert is_channel_session_key("discord_codexcrew_direct_U1")
        assert is_channel_session_key("unified_codexcrew")
...
class TestEligibility:
    ...
    def test_slot_name_is_the_channel_key_folded_to_the_filename_charset(self) -> None:
        ...
        assert channel_slots.channel_slot_name("discord:codexcrew:direct:U1") == (
            "discord_codexcrew_direct_U1"
        )
...
class TestReconcilePass:
    ...
    def test_a_close_and_its_tombstone_check_agree_on_the_slot_key(
        ...
        session = _session("discord:codexcrew:direct:U1", modified=NOW - 60)
        _map_stems(dashboard_state, "discord:codexcrew:direct:U1")
