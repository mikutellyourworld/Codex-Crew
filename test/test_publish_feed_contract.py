...
_SUBS = {
    "VERSION": "1.2.3",
    "CHANNEL": "nightly",
    "DESKTOP_KEY": "desktop/nightly/1.2.3/CodexCrew.zip",
    "DMG_KEY": "desktop/nightly/1.2.3/CodexCrew.dmg",
    "ARTIFACT_KEY": "desktop/nightly/1.2.3/CodexCrew-x86_64.AppImage",
...
def test_linux_arch_resolution_matches_electron_updater_channel_file_rule() -> None:
    ...
    for arch, basename, feed_file, elf_machine in (
        ("x64", "CodexCrew-x86_64", "latest-linux.yml", "x86-64"),
        ("arm64", "CodexCrew-aarch64", "latest-linux-arm64.yml", "aarch64"),
    ):
