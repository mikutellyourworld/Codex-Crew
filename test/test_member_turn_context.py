...
``codex_crew.members.member_turn_context`` owns the "every member turn runs
...
class TestChokepointWiring:
    ...
    def test_build_message_delivery_routes_through_chokepoint(self):
        ...
        import codex_crew.context as context_mod
    ...
    def test_chat_runner_pending_flag_routes_through_chokepoint(self):
        ...
        import codex_crew.dashboard.chat_runner as chat_runner_mod
    ...
    def test_rules_handler_uses_canonical_alias(self):
        ...
        from codex_crew.dashboard.handlers import members as members_handler_mod
