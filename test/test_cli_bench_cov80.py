...
from codex_crew.cli_bench import (
    DEFAULT_OUT_DIR,
    _bench_dispatch,
    _load_corpus,
    _positive_int,
...
def parser() -> argparse.ArgumentParser:
    ...
    root = argparse.ArgumentParser(prog="codexcrew")
...
class TestDispatchRouting:
    def test_no_action_prints_usage_and_returns_two(
        ...
        assert "usage: codexcrew bench" in capsys.readouterr().out
    ...
    def test_list_prints_the_corpus_table(
        ...
        monkeypatch.setattr("codex_crew.eval.bench.datasets.describe", lambda: "zibble-table")
    ...
    def test_fetch_reports_the_cached_path(
        ...
        monkeypatch.setattr("codex_crew.eval.bench.datasets.ensure", lambda key: target)
...
class TestLoadCorpus:
    ...
    def test_a_locomo_spec_goes_through_the_locomo_adapter(
        ...
        from codex_crew.eval.bench import adapters, datasets
...
class TestBenchCmdCatchSites:
    def test_an_oserror_is_reported_rather_than_tracebacked(
        ...
        monkeypatch.setattr("codex_crew.cli_bench._bench_dispatch", _boom)
    ...
    def test_a_clean_dispatch_code_passes_straight_through(
        ...
        monkeypatch.setattr("codex_crew.cli_bench._bench_dispatch", lambda args: 0)
