...
These run in the standard pytest suite (NOT gated behind ``CODEXCREW_E2E``), so
they give coverage on ``codex_crew.testing.fake_acp_backend`` without spawning a
...
from codex_crew.testing import fake_acp_backend as fake
