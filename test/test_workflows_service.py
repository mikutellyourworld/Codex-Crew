...
import codex_crew.llm_helpers as llm_helpers
from codex_crew.acp.runtime import AcpRequestTimeout
from codex_crew.config import CodexCrewConfig
from codex_crew.session import SessionManager
from codex_crew.workflows.library import WorkflowDefinitionLibrary
...
def _patch_stream(monkeypatch, replies: list[str]) -> dict:
    ...
    import codex_crew.workflows.service as svc_mod
...
async def test_author_success_survives_teardown_failure(monkeypatch, caplog) -> None:
    ...
    with caplog.at_level(logging.WARNING, logger="codex_crew.workflows.service"):
