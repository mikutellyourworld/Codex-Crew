...
from codex_crew.dashboard.handlers import api_workspaces_create, api_workspaces_update
...
def cfg_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "codex_crew.config.loader.config_dir", lambda: cfg_dir
    )
    # Also patch the local import in handlers
    monkeypatch.setattr(
        "codex_crew.dashboard.handlers.config_dir", lambda: cfg_dir
    )
    return cfg_dir
