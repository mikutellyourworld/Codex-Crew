...
one wait budget: ``codex_crew.constants.COMPACT_WAIT_TIMEOUT_SECS``. A shorter
...
@pytest.mark.parametrize(
    "import_path",
    [
        "codex_crew.providers.acp.AcpProvider",
        "codex_crew.acp.client.AcpClient",
        "codex_crew.acp.session_handle.AcpSessionHandle",
...
def test_inner_status_wait_spends_the_remaining_shared_budget():
    ...
    from codex_crew.session import _compact_result_wait_secs
...
def test_post_failure_budget_is_one_constant_for_both_dispatch_paths():
    ...
    from codex_crew.acp import client, session_handle
