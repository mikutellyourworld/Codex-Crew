...
MARKER = "<!-- codexcrew-issue-summary -->"
...
def test_posts_one_comment_with_all_three_sections(runner: Runner) -> None:
    ...
    assert "#4001" in body
    assert runner.write_target == "POST repos/mikutellyourworld/Codex-Crew/issues/4100/comments"
...
def test_second_run_edits_the_existing_comment_instead_of_appending(runner: Runner) -> None:
    ...
    assert runner.write_target == "PATCH repos/mikutellyourworld/Codex-Crew/issues/comments/555"
