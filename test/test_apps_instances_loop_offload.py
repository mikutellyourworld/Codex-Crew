...
import codex_crew.apps.hooks_integration as hooks_mod
import codex_crew.apps.routes as routes_mod
import codex_crew.dashboard.handlers_instances as handlers_instances_mod
import codex_crew.instances.ssh_tunnel_manager as ssh_tunnel_manager_mod
from codex_crew.instances.ssh_tunnel_manager import SshTunnelManager, TunnelStatus
...
def test_list_apps_is_read_only_under_version_drift(
    ...
    from codex_crew.apps.manager import InstalledApp, _write_installed, apps_dir, list_apps
...
def test_no_direct_registry_write_in_async_frames() -> None:
    ...
    import codex_crew.instances.ssh_tunnel_manager as stm_mod
