...
import codex_crew.teams.gateway as teams_gateway
from codex_crew.dashboard.handlers.messaging import api_teams_config_get
...
class TestStatusEndpoint:
    ...
    async def test_status_reflects_state_and_config(self, monkeypatch) -> None:
        monkeypatch.setattr(
            "codex_crew.dashboard.handlers.messaging.is_direct_local_request",
            lambda req: True,
        )
        ...
        try:
            with unittest.mock.patch(
                ...
                "codex_crew.config.loader.CodexCrewConfig.load_credentials",
