...
from codex_crew.computer_use.keymap import (
    FLAG_ALTERNATE,
    FLAG_COMMAND,
    FLAG_SHIFT,
    KEY_ALIASES,
...
from codex_crew.computer_use.types import KeyParseError
...
class TestParseKeyRefuses:
    ...
    def test_a_spec_of_only_separators_still_names_the_plus_key(self) -> None:
        ...
        from codex_crew.computer_use.keymap import KEYCODES as _kc
