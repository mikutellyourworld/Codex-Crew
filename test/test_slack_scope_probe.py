...
from codex_crew.slack.client import RealSlackClient, SlackClientOps
from codex_crew.slack.scope_probe import (
    UNREADABLE_ERRORS,
...
class TestWarnUnreadableTrackedChannels:
    ...
    async def test_missing_scope_warns_and_notifies(self, caplog):
        ...
        with caplog.at_level("WARNING", logger="codex_crew.slack.scope_probe"):
