...
CODEXCREW_PROFILE = json.loads((PROFILES_DIR / "codexcrew.json").read_text(encoding="utf-8"))
PROFILE_MODELS = {r["name"]: r for r in CODEXCREW_PROFILE["reviewers"]}
...
FAKE_VALUES = {
    ...
    "github.repository": "mikutellyourworld/Codex-Crew",
...
def parity_repo(tmp_path):
    """A synthetic repo that resolve_profile.py recognises as Codex Crew.
