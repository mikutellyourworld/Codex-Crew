...
Rules, as a FAILING build instead of prose nobody enforces (research/06 Artifact 1):
  ...
  * The engine must NOT import ``codex_crew.dashboard.state`` internals directly —
...
WORKFLOWS_DIR = Path(__file__).resolve().parent.parent / "src" / "codex_crew" / "workflows"
