...
from codex_crew.dashboard.routes import agent_config as agent_config_routes
from codex_crew.dashboard.routes import agents as agents_routes
...
_KNOWN_UNGATED_ROUTES: frozenset[tuple[str, str]] = frozenset(
    {
        ...
        # --- Codex Crew config routes (core.py) ---
        # Application-level configuration routes that predated owner-gating.
        # They configure the Codex Crew application itself but were registered
        # before ownership semantics existed.
        ("PUT", "/api/config/codexcrew"),
        ("PATCH", "/api/config/codexcrew"),
