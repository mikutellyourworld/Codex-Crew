...
from codex_crew.apps.lifecycle import LifecycleDispatcher
from codex_crew.apps.manifest import app_name_error
...
class TestLifecycleHookOrdering:
    ...
    **Validates: Requirements 4.5**
    ...
    def test_startup_order_is_lexicographic(
        ...
        # against config_dir() == ~/.codexcrew unless CODEXCREW_HOME is isolated. Each
        ...
        monkeypatch.setenv("CODEXCREW_HOME", str(work_dir))
    ...
    **Validates: Requirements 7.4**
    ...
    async def test_shell_runs_before_python_on_enable(self) -> None:
        ...
        with (
            ...
            patch("codex_crew.apps.routes.enable_app", return_value=MagicMock(ok=True, to_dict=lambda: {"ok": True})),
            ...
            patch("codex_crew.apps.routes._run_lifecycle_script", side_effect=mock_shell),
            patch("codex_crew.apps.routes.on_app_enable", side_effect=mock_python),
...
class TestLifecycleHookTimeout:
    ...
    def test_gateway_cleanup_does_not_spend_shutdown_hook_budget(self) -> None:
        ...
        import codex_crew.apps.lifecycle as lifecycle_mod
    ...
    async def test_disable_reports_detached_startup_hook_that_did_not_stop(
        ...
        import codex_crew.apps.hooks_integration as integration
...
class TestGatewayShutdownBackendSweep:
    ...
    def test_spawned_backend_names_excludes_adopted_backends(
        ...
        import codex_crew.apps.backend as backend
...
class TestCacheShutdownForNeverLoadsOnTheEventLoop:
    ...
    async def test_loaded_module_is_resolved_in_memory_without_reimport(self, monkeypatch):
        ...
        import codex_crew.apps.lifecycle as lc
        import codex_crew.apps.module_loader as ml
