...
_BACKEND_GUARDS = (
    ...
    # src/codex_crew/apps/builtins was added to _BACKEND_ROOTS.
    "src/codex_crew/apps/builtins/design_critique/tests/test_manifest.py",
    "src/codex_crew/apps/builtins/crew_companion/tests/test_manifest.py",
    "src/codex_crew/apps/builtins/ops_mission_control/tests/test_routes.py",
)
...
def test_pure_backend_file_is_classified_single_surface(selector, tmp_path) -> None:
    ...
    pure.write_text("from codex_crew import config\n\n\ndef test_x():\n    assert config\n")
...
def test_frontend_escape_patterns_are_detected(selector, tmp_path) -> None:
    ...
    literal.write_text("import x from '../../../src/codex_crew/connections/registry.json'\n")
...
def test_backend_owned_config_references_are_cross_surface(selector, tmp_path) -> None:
    ...
    ``codex_crew`` marker on the referencing line:
...
def test_windows_filter_is_scoped_to_the_test_root(tmp_path, monkeypatch) -> None:
    ...
    app_suite = "src/codex_crew/apps/builtins/demo/tests/test_snapshot.py"
