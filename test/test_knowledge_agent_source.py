...
from codex_crew.knowledge import agent_source as agent_source_mod
from codex_crew.knowledge.agent_source import (
    AGENT_SOURCE_TYPE,
    AGENT_SOURCE_URI,
    add_agent_document,
    document_slug,
...
def test_removing_a_deduped_agent_document_releases_its_claim(tmp_path):
    ...
    from codex_crew.knowledge.agent_source import remove_document
    from codex_crew.knowledge.store import KnowledgeStore
