"""Tests for Teams' file POLICY layer (``codex_crew.teams.attachments``).
...
class TestQuoteReply:
    ...
    def test_an_oversized_body_is_skipped_rather_than_parsed(self) -> None:
        from codex_crew.teams.attachments import _MAX_REPLY_HTML_CHARS
    ...
    def test_the_break_pattern_is_linear_not_quadratic(self) -> None:
        ...
        from codex_crew.teams.attachments import _BREAK_RE
