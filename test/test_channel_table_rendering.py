...
from codex_crew.discord.renderer import DiscordRenderer, _transform_buries_refs
from codex_crew.discord.transport import DISCORD_CAPABILITIES
from codex_crew.messaging.driver import APPROVAL_AUTO, TurnDriver
from codex_crew.messaging.split import iter_fence_spans
from codex_crew.messaging.tables import (
    TABLE_POLICY_AUTO,
    TABLE_POLICY_NATIVE,
    TABLE_POLICY_OFF,
    display_width,
...
from codex_crew.webex.client import WEBEX_MAX_TEXT
...
class TestOutboundTableSafety:
    def test_cards_rescan_a_joined_authorization_header_and_bearer_value(self) -> None:
        from codex_crew.messaging.tables import TABLE_POLICY_CARDS
