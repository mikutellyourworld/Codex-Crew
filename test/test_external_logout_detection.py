...
from codex_crew import kiro_prerequisite as kp
from codex_crew.session import _MAX_CONCURRENT_COLD_STARTS as _MAX_COLD_STARTS_FOR_TEST
...
class _FakeProvider:
    ...
    def uses_kiro_identity_store(self) -> bool:
        from codex_crew.acp.types import ACP_BACKENDS_KIRO_IDENTITY_STORE
...
class TestProviderMembership:
    def test_kiro_backend_is_a_member(self) -> None:
        from codex_crew.session import _provider_uses_kiro_identity_store
