...
from codex_crew.quick_prompts import QUICK_PROMPTS, expand_quick_prompt
...
class TestDoesNotShadowRealCommands:
    ...
    def test_tokens_are_disjoint_from_every_channel_alias_set(self):
        ...
        for mod_name in (
            "codex_crew.telegram.commands",
            "codex_crew.discord.commands",
            "codex_crew.teams.commands",
            "codex_crew.imessage.commands",
        ):
