...
from codex_crew.whatsapp.group_gate import SILENCE_SENTINEL, GroupVerdict
from codex_crew.whatsapp.transport_dispatch import (
    REACTION_DONE,
    REACTION_FAILED,
    REACTION_WORKING,
    WhatsAppDispatcher,
...
class FakeCfg:
    ...
    def __init__(self) -> None:
        self.agent = SimpleNamespace(default_agent="codexcrew", approval_mode="auto")
...
def test_a_muted_unprompted_group_turn_starts_no_cooldown():
    ...
    import codex_crew.messaging.dispatch as dispatch_mod
...
def _captured_turn(monkeypatch, dispatcher, inbound):
    ...
    """
    import codex_crew.whatsapp.transport_dispatch as mod
...
def test_a_persisted_generation_seeds_the_counter():
    ...
    """
    d, _client, sessions, _transport = _make()
    bucket = "whatsapp:codexcrew:direct:" + _DM
...
def test_a_group_scope_seeds_from_its_forum_bucket():
    ...
    d, _client, sessions, _transport = _make()
    sessions.persisted_generations["whatsapp:codexcrew:forum:" + _GROUP] = 3
...
def test_the_operators_unified_bucket_is_the_one_seeded():
    ...
    d, _client, sessions, _transport = _make()
    d.cfg.messaging.dm_scope = "unified"
    sessions.persisted_generations["unified:codexcrew"] = 4
