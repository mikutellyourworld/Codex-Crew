...
from codex_crew.connections import (
...
def test_l0_baselines_due_for_re_recording_are_surfaced_without_failing():
    ...
    if aging:
        warnings.warn(
            ...
            f"{aging}. Run `python -m codex_crew.connections.l0_probe --record` "
...
def test_visible_provider_l0_baselines_have_not_aged_out():
    ...
    Failing here means running ``python -m codex_crew.connections.l0_probe
