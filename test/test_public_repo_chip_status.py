...
import codex_crew.dashboard.handlers.source_providers as source
from codex_crew.dashboard.state import _project_source_links
...
def _clear_caches():
    ...
    import codex_crew.dashboard.state as _state_mod
