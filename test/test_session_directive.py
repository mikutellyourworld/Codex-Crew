...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("codexcrew-core___monitor_start", "monitor_start"),
        ...
        ("mcp__codexcrew-core__monitor_start", "monitor_start"),
        ("mcp__codexcrew-core__set_project", "set_project"),
        ...
        ("mcp_codexcrew_core_monitor_start", ""),
        ("do_monitor_start", ""),
        ("evilmonitor_start", ""),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (sd.CORE_MCP_SERVER, "codexcrew-core___set_project", "set_project"),
        ...
        ("evil-mcp", "codexcrew-core___monitor_start", ""),
...
def test_subagent_isolation_intent():
    ...
    decode() honors a directive only when expected_tool — the name CodexCrew
    ...
    from the call->name mapping, which is CodexCrew's own record. This test
