...
class TestKnowledgeSearchDBMissing:
    @patch("codex_crew.mcp_core.config_dir")
...
class TestKnowledgeSearchResults:
    @patch("codex_crew.mcp_core.config_dir")
    @patch("codex_crew.mcp_core.HybridRetriever")
    @patch("codex_crew.mcp_core.KnowledgeStore")
    @patch("codex_crew.mcp_core.create_embedder_from_config")
...
class TestKnowledgeSearchToolDefinition:
    def test_tool_listed(self):
        from codex_crew.mcp_core import _list_tools
...
class TestKnowledgeSearchSourceFilter:
    ...
    @patch("codex_crew.mcp_core.config_dir")
    @patch("codex_crew.mcp_core.HybridRetriever")
    @patch("codex_crew.mcp_core._get_knowledge_search")
