...
UNC_FORM: list[tuple[str, bool]] = [
    ...
    (r"type \\server\share\a\..\b\..\.codex-crew\security_policy.json", True),
    (r"type \\server\share\.\.aws\credentials", True),
    (r"type \\server\.aws\credentials", True),
    (r"echo forged > \\server\share\.codex-crew\connections-tool-aliases.json", True),
    (r"type \\server\share\.codex-crew\%F%", True),
