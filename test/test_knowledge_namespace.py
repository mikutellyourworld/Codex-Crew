...
from codex_crew.dashboard.handlers.knowledge import add_source
...
async def test_add_source_folds_namespace_into_properties():
    ...
    with (
        patch(
            "codex_crew.dashboard.handlers.knowledge.is_sensitive_path",
            return_value=False,
        ),
        ...
        with patch(
            "codex_crew.dashboard.handlers.knowledge._store",
