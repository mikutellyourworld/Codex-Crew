...
from codex_crew.acp import _dispatch as acp_dispatch
from codex_crew.dashboard.handlers import artifacts as artifacts_handlers
from codex_crew.security import redact_credentials
from codex_crew.telegram import renderer as tg_renderer
...
_SCANNED_MODULES = [
    "src/codex_crew/channel.py",
    "src/codex_crew/dashboard/chat_runner.py",
    "src/codex_crew/acp/_dispatch.py",
    ...
    "src/codex_crew/acp/client.py",
    "src/codex_crew/dashboard/handlers/artifacts.py",
    "src/codex_crew/dashboard/handlers/discover.py",
    "src/codex_crew/mcp_tools/control.py",
    "src/codex_crew/mcp_tools/spawn.py",
    "src/codex_crew/vector_memory.py",
    "src/codex_crew/knowledge/agent_fetch.py",
    "src/codex_crew/slack/gateway.py",
    "src/codex_crew/telegram/renderer.py",
    "src/codex_crew/subagent_manager/continuation.py",
    "src/codex_crew/apps/builtins/auto_research/handlers.py",
]
