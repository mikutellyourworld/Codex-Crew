...
* :class:`codex_crew.artifacts.ArtifactStore` — ``create_image`` round-trip,
...
* :mod:`codex_crew.image_artifacts` — auto-registration of local markdown images
...
from codex_crew import image_artifacts
...
class TestAssetReadHardening:
    ...
    def test_asset_response_is_private_and_read_off_the_loop(
        ...
        """
        from codex_crew.dashboard.handlers import artifacts as handlers
