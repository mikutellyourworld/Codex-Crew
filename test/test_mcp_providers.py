...
from codex_crew.mcp_providers import official as official_mod
...
from codex_crew.mcp_providers.official import (
...
class TestRegistryFanOut:
    ...
    async def test_slow_provider_dropped_fast_provider_survives(self, monkeypatch):
        from codex_crew.mcp_providers import base as base_mod
