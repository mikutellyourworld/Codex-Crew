...
from codex_crew import identity_stores as ids
from codex_crew import kiro_prerequisite as kp
from codex_crew.dashboard.handlers import kiro_usage_api as usage_api
from codex_crew.identity_stores import Trust
from codex_crew.security import _SENSITIVE_HOME_DIRS
...
class TestReadersAgreeWithCanonicalTable:
    ...
    def test_state_dbs_match_the_projection(self, tmp_path: Path) -> None:
        from codex_crew import kiro_cli
