...
from codex_crew.trust_patterns import extract_base_command as _canonical_extract_base_command
from codex_crew.trust_patterns import extract_full_command as _canonical_extract_full_command
from codex_crew.trust_patterns import matches_trusted_pattern as _canonical_matches_trusted_pattern
...
def _make_app(state: DashboardState) -> web.Application:
    from codex_crew.dashboard.chat import api_chat_slot_approve
...
class TestGetPatternFromPending:
    def test_extracts_full_command(self):
        from codex_crew.dashboard.chat_handlers import _get_pattern_from_pending
        from codex_crew.dashboard.state import _ChatSlot
