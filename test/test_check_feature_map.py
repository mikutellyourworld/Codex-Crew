...
HANDLER = "src/codex_crew/dashboard/handlers/new_thing.py"
...
class TestTriggers:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                [], ["src/codex_crew/dashboard/handlers/old_thing.py"], 0, 0, id="handler-deleted"
            ),
...
class TestNonFeatures:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            "src/codex_crew/dashboard/handlers/__init__.py",
            "src/codex_crew/dashboard/handlers/_shared.py",
    ...
    def test_real_page_is_a_feature_file(self):
        ...
        assert gate.is_feature_file("src/codex_crew/dashboard/handlers/artifacts.py")
