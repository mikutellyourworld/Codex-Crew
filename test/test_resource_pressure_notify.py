...
:mod:`codex_crew.notifications.resource_pressure` against a real
...
from codex_crew.notifications import resource_pressure
from codex_crew.notifications.bus import SYSTEM_CHANNELS, NotificationBus
from codex_crew.notifications.resource_pressure import (
    CHANNEL,
...
class TestSliceOomNote:
    ...
    async def test_oom_report_reaches_the_bus(self, notes, monkeypatch) -> None:
        ...
        monkeypatch.setattr(
            ...
            lambda: "cgroup OOM kill inside codexcrew-agents.slice: 1 new kill(s); …",
        )
