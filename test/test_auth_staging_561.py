...
A stray file or dangling symlink at ``<home>/.codex-crew-auth-staging`` used to
...
from codex_crew.kiro_prerequisite import _AUTH_STAGING_RELATIVE, _ensure_auth_staging_parent
