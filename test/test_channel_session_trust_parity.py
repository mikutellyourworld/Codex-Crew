...
``/codexcrew yolo`` drive -- so an operator who arms it anywhere gets tool use on
...
from codex_crew.acp.types import EVENT_COMPLETE, EVENT_PERMISSION_REQUEST, AcpEvent
from codex_crew.hooks import TOOL_DENY
from codex_crew.messaging.renderer import Renderer, TransportCapabilities
...
def _build_webex(sessions: Any, ctx: Any) -> tuple[Any, str, Any, Any]:
    from codex_crew.webex import transport_dispatch as mod
...
def _build_wecom(sessions: Any, ctx: Any) -> tuple[Any, str, Any, Any]:
    from codex_crew.wecom import transport_dispatch as mod
...
def _build_weixin(sessions: Any, ctx: Any) -> tuple[Any, str, Any, Any]:
    ...
    from codex_crew.weixin import transport_dispatch as mod
...
def _build_imessage(sessions: Any, ctx: Any) -> tuple[Any, str, Any, Any]:
    from codex_crew.imessage import transport_dispatch as mod
    from codex_crew.imessage.client import IMessageInbound
...
def _build_teams(sessions: Any, ctx: Any) -> tuple[Any, str, Any, Any]:
    from codex_crew.teams import transport_dispatch as mod
    from codex_crew.teams.client import TeamsInbound
...
_APPROVAL_DEADLINE_SYMBOL = {
    "teams": "codex_crew.teams.approvals.APPROVAL_TIMEOUT_SECS",
    "webex": "codex_crew.messaging.approval.APPROVAL_TIMEOUT_S",
}
...
def test_the_grant_is_read_per_tool_not_snapshotted(
    ...
    """
    from codex_crew.messaging import dispatch as D
