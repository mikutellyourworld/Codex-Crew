...
class TestComputeJitterEveryJobs:
    ...
    @patch("codex_crew.cron.random.uniform", return_value=600.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=900.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=3600.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=5000.0)
...
class TestComputeJitterCronExpr:
    ...
    @patch("codex_crew.cron.random.uniform", return_value=700.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=500.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=800.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=4000.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=5500.0)
    ...
    @patch("codex_crew.cron.random.uniform", return_value=300.0)
...
class TestReaperJitterAllowance:
    ...
    async def test_job_within_timeout_plus_jitter_not_reaped(self):
        ...
        from codex_crew.cron import _JOB_TIMEOUT_SECS
