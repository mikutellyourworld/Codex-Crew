"""Tests for codex_crew.feishu.transport_dispatch (FeishuDispatcher)."""
...
from codex_crew.feishu.client import LarkInbound
from codex_crew.feishu.transport_dispatch import FeishuDispatcher
...
class TestTurn:
    ...
    async def test_persistence_carries_the_resolved_agent(self) -> None:
        ...
        d = _dispatcher(
            ...
            FakeClient(),
            conv_log=conv,
            cfg=_cfg(default_agent="codexcrew"),
    ...
    async def test_turn_honours_an_out_of_band_approval_grant(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr("codex_crew.feishu.transport_dispatch.drive_turn", _capture)
        ...
        import codex_crew.feishu.transport_dispatch as mod
