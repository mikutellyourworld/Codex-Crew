...
# per-identifier -- an unfamiliar identifier (e.g. io.github.mikutellyourworld.codexcrew.dmg) is
...
DMG_IDENTIFIER="${DMG_IDENTIFIER:-io.github.mikutellyourworld.codexcrew}"
