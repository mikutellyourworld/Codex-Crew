#!/usr/bin/env bash
# Sign a CodexCrew .app bundle via the enterprise signing service.
#
# Usage:
#   bash packaging/signing/sign.sh <app-path> <channel> <version>
#
# Example:
#   bash packaging/signing/sign.sh website/electron/dist/mac-arm64/CodexCrew.app nightly 0.2.0-nightly.20260708
#
...
# Space-free slug for bucket keys: the nightly bundle is "CodexCrew Nightly.app"
